...
| Order | Path | Purpose |
|---:|---|---|
| 1 | `../cosim_rebuild_plan_20260614.md` | Rebuild goal, captured user requirements, and preservation rules. |
...
| Parent `../` | Rebuild plan, migration manifest, research template, and audit notes. |
