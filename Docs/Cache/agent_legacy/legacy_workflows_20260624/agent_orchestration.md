...
> Legacy after 2026-06-24 single-thread reset. Do not load this for ordinary
> MoSim execution unless the user explicitly reopens multi-agent orchestration
> or asks for legacy CoAgent cleanup/audit.
