...
> Legacy after 2026-06-24 single-thread reset. Visible-department dispatch is
> not active MoSim workflow unless the user explicitly reopens multi-thread
> operation.
...
Status: legacy archived adapter snapshot, 2026-06-10 CST. Visible-department
dispatch is not active MoSim workflow unless explicitly reopened.
