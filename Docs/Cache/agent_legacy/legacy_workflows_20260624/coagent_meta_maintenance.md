...
> Legacy after 2026-06-24 single-thread reset. Do not run CoAgent
> meta-maintenance as active MoSim operating work unless the user explicitly
> asks for legacy cleanup/audit.
