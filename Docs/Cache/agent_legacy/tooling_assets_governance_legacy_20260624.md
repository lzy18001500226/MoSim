...
| Codex native hooks | `C:\Users\HP\.codex\hooks.json`, `Scripts/hooks/codex_native_hook.py`, `Scripts/hooks/preflight.py` | Hard lifecycle guardrails around session start, tool use, and completion checks. Hooks are not optional context assets. |
...
| Reference project adoption/rejection | `Docs/Index/external_learning_index.md` or `Docs/Index/reference_project_index.md` |
...
| Codex native hook or App capability change | `Scripts/hooks/README.md`, `Docs/Index/codex_app_session_research.md`, and this workflow |
