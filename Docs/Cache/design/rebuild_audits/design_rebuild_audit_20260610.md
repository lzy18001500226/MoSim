...
5. only then move the old file into `Docs/Cache/design/historical_snapshots/pre_rebuild_20260610/`
...
Docs/Cache/design/historical_snapshots/pre_rebuild_20260610/README.md
```

The first rebuild pass moved these pre-rebuild inputs into
`Docs/Cache/design/historical_snapshots/pre_rebuild_20260610/`:
