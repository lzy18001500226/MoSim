...
Status: archived historical design-note snapshot, 2026-06-11. User-reviewed
decisions from this snapshot have been migrated into current design docs where
still applicable; this file is not a current MoSim execution source.
