...
10. Any demo, login, activation, authorization, mixed, unavailable tooling, unknown blocking state, or GUI-error-report evidence from the patrol or current task is returned as `status=blocked`, not accepted as a completed MWORKS task.
