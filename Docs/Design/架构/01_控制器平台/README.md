...
| `Docs/Workflows/controller_evidence_closeout.md` | 当前 G1-G7 控制器证据与模型迁移工作流；当前 48 个活动条目与历史 67 条分层路线必须分开读取，其中包括 47 个 MWORKS Control Profile（46 条当前路线和 1 条计划 ESO Profile）及 `px4ctrl` 工程/部署基线；七族实测胜出者和七场景矩阵以主线看板为准 |
...
| `控制器证据矩阵.md` | 历史 67 条分层路线的证据状态；当前 46 条路线到 47 个 MWORKS Control Profile 的七族归属和报告口径以关系架构文档为准 |
