...
| `Docs/Workflows/controller_evidence_closeout.md` | 当前 G1-G7：49方案审计、D1-D3 三轮门、41 条内部图形探针、5 条正式整机最小闭环；六族冠军须先新增其正式根测试壳，才可进入七场景和特殊证据收敛 |
...
| `控制器证据矩阵.md` | 当前 49 条方案与历史 67 条分层路线的关系、控制层归属、输出边界和报告可声明范围 |
