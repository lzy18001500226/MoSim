...
| FAST-LIO semantics | `https://github.com/hku-mars/FAST_LIO`, local `References/Lab/FAST_LIO/config/mid360.yaml` | Livox path needs per-point timing and LiDAR/IMU synchronization; display-only point clouds are not localization evidence. |
