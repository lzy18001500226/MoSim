...
| Codex / OpenAI docs | official docs when needed; historical context: `Docs/Cache/research/codex_app_session_research_20260526.md` | skills, durable goals, config limits, Codex App / VSCode / WSL session boundaries, long-running agent behavior | unverified config keys, provider assumptions, live bidirectional session sync as a dependency | 2026-05-26 | Codex Config/tool behavior changes or agent runtime issue |
