...
The `Model Result Variable` column below is a candidate mapping derived from the embedded baseline package `Models/MoSimQuadrotorModel/Vehicle/package.mo`.
