...
| Start and stop the Gazebo flight runtime and QGC/UE ground station independently | `Docs/Workflows/qgc_ue_operator_startup.md`; use the repository-root launchers and keep Gazebo/PX4/MAVROS as runtime authority |
