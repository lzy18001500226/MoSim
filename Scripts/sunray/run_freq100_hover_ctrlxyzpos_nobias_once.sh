...
RESULT_DIR="/mnt/c/Users/HP/Desktop/MoSim/Results/sunray_ros1/sunray_ros1_freq100_hover_ctrlxyzpos_nobias_${STAMP}"
mkdir -p "${RESULT_DIR}"
...
export MISSION_NODE_ARGS="--position-hold-mode ctrlxyzpos --control-mode ctrltraj --steady-hover-eval-tail-s 8.0"
