#!/usr/bin/env python3
"""Compile and run the G9-A official PID C ABI consistency gate."""
...
def main() -> int:
    ...
    if args.result_dir:
        ...
        result_dir = project_root / "Results" / "g9" / "official_pid_attitude_thrust_v1" / f"g9a_c_abi_gate_{time.strftime('%Y%m%d_%H%M%S')}"
    ...
    source_files = [
        ...
        script_dir / "px4ctrl_g9a_core_c.h",
        script_dir / "px4ctrl_g9a_core_c.c",
        script_dir / "px4ctrl_g9a_c_abi_gate.cpp",
    ...
    c_obj = build_dir / "px4ctrl_g9a_core_c.o"
    cpp_obj = build_dir / "px4ctrl_core.o"
    gate_obj = build_dir / "px4ctrl_g9a_c_abi_gate.o"
    exe = build_dir / "px4ctrl_g9a_c_abi_gate"

    steps = [
        {
            "name": "compile_c_g9a_core",
            "cmd": [
                "gcc",
                "-std=c99",
                "-O2",
                ...
                "-pedantic",
                "-c",
                windows_path_to_wsl(script_dir / "px4ctrl_g9a_core_c.c"),
                "-o",
        ...
        },
        {
            ...
            "cmd": [
                ...
                "-pedantic",
                "-c",
                windows_path_to_wsl(script_dir / "px4ctrl_g9a_c_abi_gate.cpp"),
                "-I",
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g9a_official_pid_c_abi_manifest.v1",
        "status": "unknown",
        "goal": "G9-A-C-ABI",
        ...
        "steps": [],
        "claim_boundary": "This gate proves only official PID C++ core versus pure C ABI equivalence. It is not MWORKS generated-code or Gazebo runtime evidence.",
    }
