#!/usr/bin/env python3
"""Compile and run the G9-C DFBC Basic static controller gate."""
...
def main() -> int:
    ...
    if args.result_dir:
        ...
        result_dir = project_root / "Results" / "g9" / "dfbc_basic_attitude_thrust_v1" / f"g9c_static_gate_{time.strftime('%Y%m%d_%H%M%S')}"
    ...
    source_files = [
        ...
        script_dir / "px4ctrl_g9c_dfbc_basic_gate.cpp",
        ...
        project_root / "References" / "Lab" / "EGO-Planner-v2" / "swarm-playground" / "tracking_ws" / "src" / "uav_simulator" / "so3_control" / "src" / "SO3Control.cpp",
    ...
    exe = build_dir / "px4ctrl_g9c_dfbc_basic_gate"
    compile_cmd = [
        "g++",
        "-std=c++11",
        "-O2",
        ...
        windows_path_to_wsl(script_dir / "px4ctrl_g9c_dfbc_basic_gate.cpp"),
        "-I",
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g9c_dfbc_basic_static_gate_manifest.v1",
        "status": "unknown",
        "goal": "G9-C",
        "controller_profile": "dfbc_basic_attitude_thrust_v1",
        "project_root": str(project_root),
        "result_dir": str(result_dir),
        "compile_command": compile_cmd,
        "claim_boundary": "Static C++ dfbc_basic ATTITUDE_THRUST backend gate only. No jerk/snap full DFBC, runtime, or MWORKS GUI is started.",
    }
