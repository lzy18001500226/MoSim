...
MosimPx4ctrlG9ACParams to_c_params(const CoreParams &params)
{
    MosimPx4ctrlG9ACParams out;
    ...
    out.ki_x = params.ki[0];
    out.ki_y = params.ki[1];
    out.ki_z = params.ki[2];
    out.integral_limit_x = params.integral_limit[0];
    out.integral_limit_y = params.integral_limit[1];
    out.integral_limit_z = params.integral_limit[2];
...
MosimPx4ctrlG9ACInput to_c_input(const ControllerInput &input)
{
    MosimPx4ctrlG9ACInput out{};
    out.dt = input.dt;
...
ControllerOutput from_c_output(const MosimPx4ctrlG9ACOutput &input)
{
...
int main()
{
    ...
    const MosimPx4ctrlG9ACParams c_params = to_c_params(params);
    MosimPx4ctrlG9ACState c_state;
    mosim_px4ctrl_g9a_c_reset(&c_params, &c_state);
    ...
    for (const auto &c : cases)
    {
        ...
        const MosimPx4ctrlG9ACInput c_input = to_c_input(c.input);
        MosimPx4ctrlG9ACOutput c_output;
        mosim_px4ctrl_g9a_c_step(&c_params, &c_state, &c_input, &c_output);
        ...
        const bool failed =
            ...
            cpp.saturated != c_core.saturated ||
    ...
    std::cout << "{\n";
    std::cout << "  \"schema\": \"mosim.px4ctrl_g9a_c_abi_gate.v1\",\n";
