#!/usr/bin/env python3
"""Compile and run the G10-B/D/E minimal enhancement static gate."""
...
def main() -> int:
    ...
    if args.result_dir:
        ...
        result_dir = project_root / "Results" / "g10" / "min_enhancements_v1" / f"g10bde_static_gate_{time.strftime('%Y%m%d_%H%M%S')}"
    ...
    source_files = [
        ...
        script_dir / "px4ctrl_g10bde_min_enhancement_gate.cpp",
    ...
    exe = build_dir / "px4ctrl_g10bde_min_enhancement_gate"
    compile_cmd = [
        "g++",
        "-std=c++11",
        "-O2",
        ...
        windows_path_to_wsl(script_dir / "px4ctrl_g10bde_min_enhancement_gate.cpp"),
        "-I",
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g10bde_min_enhancement_static_gate_manifest.v1",
        "status": "unknown",
        "goal": "G10-BDE",
        "controller_profiles": ["l1_awff", "safety_filter", "fault_allocation"],
        "project_root": str(project_root),
        "result_dir": str(result_dir),
        "compile_command": compile_cmd,
        "claim_boundary": "Static G10-B/D/E minimal enhancement gate only. No ROS, Gazebo, PX4, MAVROS, RViz, MWORKS GUI, runtime fault injection, motor-level allocation, or PX4-native deployment is started.",
    }
