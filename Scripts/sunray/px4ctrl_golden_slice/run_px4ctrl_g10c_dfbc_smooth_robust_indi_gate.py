#!/usr/bin/env python3
"""Compile and run the G10-C DFBC smooth robust plus INDI static controller gate."""
...
def main() -> int:
    ...
    if args.result_dir:
        ...
        result_dir = project_root / "Results" / "g10" / "dfbc_smooth_robust_indi_v1" / f"g10c_static_gate_{time.strftime('%Y%m%d_%H%M%S')}"
    ...
    source_files = [
        ...
        script_dir / "px4ctrl_g10c_dfbc_smooth_robust_indi_gate.cpp",
        Path(__file__).resolve(),
        project_root / "Config" / "profiles" / "catalog.json",
        project_root / "Config" / "profiles" / "experiments" / "g10c_dfbc_smooth_robust_no_indi_figure8_v1.json",
        project_root / "Config" / "profiles" / "experiments" / "g10c_dfbc_smooth_robust_indi_figure8_v1.json",
    ...
    exe = build_dir / "px4ctrl_g10c_dfbc_smooth_robust_indi_gate"
    compile_cmd = [
        "g++",
        "-std=c++11",
        "-O2",
        ...
        windows_path_to_wsl(script_dir / "px4ctrl_g10c_dfbc_smooth_robust_indi_gate.cpp"),
        "-I",
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g10c_dfbc_smooth_robust_indi_static_gate_manifest.v1",
        "status": "unknown",
        "goal": "G10-C",
        "controller_profile": "dfbc_smooth_robust_attitude_thrust_v1",
        "augmentation_profile": "pid_indi_v1",
        "runtime_core_profile": "dfbc_smooth_robust_indi",
        "project_root": str(project_root),
        "result_dir": str(result_dir),
        "compile_command": compile_cmd,
        "claim_boundary": "Static DFBC smooth robust plus INDI core gate only. No ROS, Gazebo, PX4, MAVROS, RViz, MWORKS GUI, runtime ablation, body-rate publish switch, or PX4-native deployment is started.",
    }
