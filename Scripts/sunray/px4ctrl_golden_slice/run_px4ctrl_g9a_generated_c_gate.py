#!/usr/bin/env python3
"""Compile and run G9-A official PID against MWORKS generated C Step()."""
...
def main() -> int:
    ...
    parser.add_argument(
        "--code-dir",
        default=(
            "Results/g9/official_pid_attitude_thrust_v1/"
            "g9a_mworks_codegen_20260630_183814/"
            "g9a_official_pid_cfunction_codegen_strict/"
            "G9A_OfficialPID_CFunction_Sysblock"
        ),
    )
    ...
    if args.result_dir:
        ...
        result_dir = (
            ...
            / "Results"
            / "g9"
            / "official_pid_attitude_thrust_v1"
            / f"g9a_generated_c_gate_{time.strftime('%Y%m%d_%H%M%S')}"
        )
    ...
    required = [
        code_dir / "G9A_OfficialPID_CFunction_Sysblock.c",
        code_dir / "G9A_OfficialPID_CFunction_Sysblock_data.c",
        code_dir / "G9A_OfficialPID_CFunction_Sysblock_private.h",
        code_dir / "G9A_OfficialPID_CFunction_Sysblock.h",
        ...
        script_dir / "px4ctrl_g9a_generated_c_gate.cpp",
    ]
    missing = [str(path) for path in required if not path.exists()]
    if missing:
        result_dir.mkdir(parents=True, exist_ok=True)
        manifest = {
            "schema": "mosim.g9a_mworks_generated_c_manifest.v1",
            "status": "blocked",
            "missing": missing,
    ...
    gate_obj = build_dir / "px4ctrl_g9a_generated_c_gate.o"
    exe = build_dir / "px4ctrl_g9a_generated_c_gate"
    ...
    steps = [
        {
            ...
            "cmd": [
                ...
                "-pedantic",
                "-c",
                windows_path_to_wsl(code_dir / "G9A_OfficialPID_CFunction_Sysblock.c"),
                "-I",
        ...
        },
        {
            ...
            "cmd": [
                ...
                "-pedantic",
                "-c",
                windows_path_to_wsl(code_dir / "G9A_OfficialPID_CFunction_Sysblock_data.c"),
                "-I",
                windows_path_to_wsl(code_dir),
                "-o",
        ...
        },
        {
            ...
            "cmd": [
                ...
                "-pedantic",
                "-c",
                windows_path_to_wsl(script_dir / "px4ctrl_g9a_generated_c_gate.cpp"),
                "-I",
                windows_path_to_wsl(script_dir),
                "-I",
                windows_path_to_wsl(code_dir),
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g9a_mworks_generated_c_manifest.v1",
        "status": "unknown",
        "goal": "G9-A-MWORKS-GENERATED-C",
        "controller_profile": "official_pid_attitude_thrust_v1",
        "project_root": str(project_root),
        "code_dir": str(code_dir),
        "result_dir": str(result_dir),
        "steps": [],
        "claim_boundary": "Offline generated-code equivalence only. No ROS, Gazebo, RViz, or flight runtime is executed.",
    }
