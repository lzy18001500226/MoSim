#!/usr/bin/env python3
"""Compile and run the G10-A DFBC DOB/ESO static augmentation gate."""
...
def main() -> int:
    ...
    if args.result_dir:
        ...
        result_dir = project_root / "Results" / "g10" / "dfbc_dob_eso_v1" / f"g10a_static_gate_{time.strftime('%Y%m%d_%H%M%S')}"
    ...
    source_files = [
        ...
        script_dir / "px4ctrl_g10a_dfbc_dob_eso_gate.cpp",
        Path(__file__).resolve(),
        project_root / "Config" / "profiles" / "catalog.json",
        project_root / "Config" / "profiles" / "experiments" / "g10a_dfbc_smooth_robust_no_dob_figure8_v1.json",
        project_root / "Config" / "profiles" / "experiments" / "g10a_dfbc_smooth_robust_dob_figure8_v1.json",
    ...
    exe = build_dir / "px4ctrl_g10a_dfbc_dob_eso_gate"
    compile_cmd = [
        "g++",
        "-std=c++11",
        "-O2",
        ...
        windows_path_to_wsl(script_dir / "px4ctrl_g10a_dfbc_dob_eso_gate.cpp"),
        "-I",
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g10a_dfbc_dob_eso_static_gate_manifest.v1",
        "status": "unknown",
        "goal": "G10-A",
        "controller_profile": "dfbc_smooth_robust_attitude_thrust_v1",
        "augmentation_profile": "dfbc_dob_eso_v1",
        "ablation_profile": "dfbc_dob_eso_disabled_v1",
        "runtime_core_profile_enabled": "dfbc_smooth_robust_dob",
        "runtime_core_profile_disabled": "dfbc_smooth_robust",
        "project_root": str(project_root),
        "result_dir": str(result_dir),
        "compile_command": compile_cmd,
        "claim_boundary": "Static G10-A DOB/ESO augmentation gate only. No ROS, Gazebo, PX4, MAVROS, RViz, MWORKS GUI, runtime ablation, or PX4-native deployment is started.",
    }
