#!/usr/bin/env python3
"""Compile and run the G9.5 high-order DFBC static controller gate."""
...
def main() -> int:
    ...
    if args.result_dir:
        ...
        result_dir = project_root / "Results" / "g9" / "dfbc_high_order_attitude_thrust_v1" / f"g95_static_gate_{time.strftime('%Y%m%d_%H%M%S')}"
    ...
    source_files = [
        ...
        script_dir / "px4ctrl_g95_dfbc_high_order_gate.cpp",
        ...
        project_root / "Docs" / "Design" / "架构" / "01_控制器平台" / "统一控制接口.md",
        project_root / "Docs" / "Paper" / "A Comparative Study of Nonlinear MPC and Differential-Flatness-Based Control for Quadrotor Agile Flight.pdf",
    ...
    exe = build_dir / "px4ctrl_g95_dfbc_high_order_gate"
    compile_cmd = [
        "g++",
        "-std=c++11",
        "-O2",
        ...
        windows_path_to_wsl(script_dir / "px4ctrl_g95_dfbc_high_order_gate.cpp"),
        "-I",
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g95_dfbc_high_order_static_gate_manifest.v1",
        "status": "unknown",
        "goal": "G9.5",
        "controller_profile": "dfbc_high_order_attitude_thrust_v1",
        "runtime_core_profile": "dfbc_high_order",
        "project_root": str(project_root),
        "result_dir": str(result_dir),
        "compile_command": compile_cmd,
        "claim_boundary": "Static high-order DFBC core gate only. No ROS, Gazebo, PX4, MAVROS, RViz, MWORKS GUI, body-rate publish switch, or PX4-native deployment is started.",
    }
