#!/usr/bin/env python3
"""Compile and run the G9-E PID-INDI static controller gate."""
...
def main() -> int:
    ...
    if args.result_dir:
        ...
        result_dir = project_root / "Results" / "g9" / "pid_indi_v1" / f"g9e_static_gate_{time.strftime('%Y%m%d_%H%M%S')}"
    ...
    source_files = [
        ...
        script_dir / "px4ctrl_g9e_pid_indi_gate.cpp",
        Path(__file__).resolve(),
        project_root / "Docs" / "Design" / "架构" / "01_控制器平台" / "controllers" / "PID-INDI.md",
        project_root / "Docs" / "Design" / "架构" / "01_控制器平台" / "modules" / "INDI.md",
        project_root / "Docs" / "Design" / "架构" / "01_控制器平台" / "单机控制器实现.md",
        project_root / "Docs" / "Design" / "架构" / "03_测试调参与证据" / "调参与参数优化.md",
        ...
        project_root / "Scripts" / "sunray" / "run_px4ctrl_ego_single_gate.sh",
        project_root / "Scripts" / "sunray" / "run_px4ctrl_ego_swarm_gate.sh",
    ]
    source_hashes = {
    ...
    exe = build_dir / "px4ctrl_g9e_pid_indi_gate"
    compile_cmd = [
        "g++",
        "-std=c++11",
        "-O2",
        ...
        windows_path_to_wsl(script_dir / "px4ctrl_g9e_pid_indi_gate.cpp"),
        "-I",
    ...
    manifest: dict[str, object] = {
        "schema": "mosim.g9e_pid_indi_static_gate_manifest.v1",
        "status": "unknown",
        "goal": "G9-E",
        "controller_profile": "official_pid_attitude_thrust_v1",
        "augmentation_profile": "pid_indi_v1",
        "runtime_core_profile": "pid_indi",
        "project_root": str(project_root),
        "result_dir": str(result_dir),
        "compile_command": compile_cmd,
        "claim_boundary": "Static PID plus bounded INDI acceleration-increment ATTITUDE_THRUST backend gate only. No body-rate/rotor-level INDI, runtime, or MWORKS GUI is started.",
    }
