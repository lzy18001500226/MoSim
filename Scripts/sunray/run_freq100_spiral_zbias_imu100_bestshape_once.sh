...
RESULT_DIR="/mnt/c/Users/HP/Desktop/MoSim/Results/sunray_ros1/sunray_ros1_freq100_spiral_zbias_imu100_bestshape_${STAMP}"
mkdir -p "${RESULT_DIR}"
...
export PX4_MAVLINK_STREAM_NAMES="HIGHRES_IMU ATTITUDE ATTITUDE_QUATERNION LOCAL_POSITION_NED"
export MAVROS_SET_STREAM_GROUPS="raw_sensors position extra1"
export MAVROS_SET_MESSAGE_IDS="105:HIGHRES_IMU 30:ATTITUDE 31:ATTITUDE_QUATERNION 32:LOCAL_POSITION_NED"
export MAVROS_SET_MESSAGE_INTERVALS=true
export MAVROS_PATCH_RATE_LIMITS=true
