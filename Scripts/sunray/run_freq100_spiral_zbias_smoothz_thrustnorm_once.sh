...
RESULT_DIR="/mnt/c/Users/HP/Desktop/MoSim/Results/sunray_ros1/sunray_ros1_freq100_spiral_zbias_smoothz_thrustnorm_${STAMP}"
mkdir -p "${RESULT_DIR}"
...
export SUNRAY_CTRL_THRUST_NORM_COMPENSATION=true
