...
RESULT_DIR="/mnt/c/Users/HP/Desktop/MoSim/Results/sunray_ros1/sunray_ros1_freq100_spiral_zbias_thetaramp_bestshape_${STAMP}"
mkdir -p "${RESULT_DIR}"
