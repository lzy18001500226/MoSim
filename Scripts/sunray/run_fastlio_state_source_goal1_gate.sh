...
cat > "${RESULT_DIR}/RUN_MANIFEST.json" <<EOF
{
  ...
  "claim_boundary": "FAST-LIO raw/aligned odometry, Gazebo truth-aligned Z through the alignment adapter, and UAV base axes only; no arming, no setpoint publication, no controller mission.",
  ...
  "z_source_first_version": "gazebo_truth_aligned_z",
  "gazebo_truth_alignment_input_allowed": true,
