...
RESULT_DIR="/mnt/c/Users/HP/Desktop/MoSim/Results/sunray_ros1/sunray_ros1_freq100_hover_ctrlxyzpos_zbias_imu100_${STAMP}"
mkdir -p "${RESULT_DIR}"
...
export TIME_TF_AUDIT_DURATION_S=70
