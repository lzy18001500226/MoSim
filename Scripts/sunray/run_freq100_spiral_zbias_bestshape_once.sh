...
RESULT_DIR="/mnt/c/Users/HP/Desktop/MoSim/Results/sunray_ros1/sunray_ros1_freq100_spiral_zbias_bestshape_${STAMP}"
mkdir -p "${RESULT_DIR}"

export PROJECT_ROOT=/mnt/c/Users/HP/Desktop/MoSim
export SUNRAY_PX4_DIR=/opt/mosim_work/sunray_px4
export RESULT_DIR
