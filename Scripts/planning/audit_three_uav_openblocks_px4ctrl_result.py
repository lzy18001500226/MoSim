#!/usr/bin/env python3
"""Audit the exported three-UAV OpenBlocks PX4CTRL MWORKS result."""
...
def audit(raw_path: Path, planning_path: Path) -> dict[str, Any]:
    ...
    metrics: dict[str, Any] = {
        "schema": "mosim.mworks.three_uav_open_blocks_px4ctrl.metrics.v1",
        "source": "MWORKS_MCP",
    ...
    metrics["claim_boundary"] = (
        "Three MWORKS whole-aircraft PX4CTRL loops track frozen OpenBlocks references. "
        "This is not online replanning, plant-coupled wall-collision acceptance, unknown-environment exploration, "
        "or Gazebo/PX4/ROS runtime evidence."
    )
    return metrics
