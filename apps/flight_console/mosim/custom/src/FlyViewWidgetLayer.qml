...
Item {
    ...
    property bool   showNativeMapScale:      true
    ...
    MapScale {
        ...
        buttonsOnLeft:      true
        visible:            showNativeMapScale && !ScreenTools.isTinyScreen && QGroundControl.corePlugin.options.flyView.showMapScale && !isViewer3DOpen && mapControl.pipState.state === mapControl.pipState.fullState
