...
model Sunray150ActuatorCommandMapper
  ...
  Real signed_visual_rotor_speed_command[4](each unit = "rad/s")
    "Signed visual rotor speed command for Sunray150RflyStyleRotorDynamics.motor_command";
...
end Sunray150ActuatorCommandMapper;
