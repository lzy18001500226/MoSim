...
- 4. `MoSimQuadrotorModel.Dynamics.WrapperSurface` (formal_dynamics_alias)
- 5. `MoSimQuadrotorModel.Dynamics.ActuatorMappedWrapperSurface` (formal_dynamics_alias)
- 6. `MoSimQuadrotorModel.Dynamics.OptionalDampingGyroLayer` (formal_dynamics_alias)
- 7. `MoSimQuadrotorModel.Dynamics.PhysicalWrenchAdapter` (formal_dynamics_alias)
- 8. `MoSimQuadrotorModel.Dynamics.HoverSmoke` (formal_dynamics_alias)
- 9. `MoSimQuadrotorModel.Dynamics.YawStepSmoke` (formal_dynamics_alias)
- 10. `MoSimQuadrotorModel.Dynamics.WrapperHoverSmoke` (formal_dynamics_alias)
- 11. `MoSimQuadrotorModel.Dynamics.WrapperYawStepSmoke` (formal_dynamics_alias)
- 12. `MoSimQuadrotorModel.Dynamics.PhysicalWrenchHoverSmoke` (formal_dynamics_alias)
- 13. `MoSimQuadrotorModel.Dynamics.PhysicalWrenchYawStepSmoke` (formal_dynamics_alias)
...
- 3. `MoSimQuadrotorModel.Dynamics.WrapperHoverSmoke` after all checks pass; probe 8 variables
- 4. `MoSimQuadrotorModel.Dynamics.WrapperYawStepSmoke` after all checks pass; probe 8 variables
- 5. `MoSimQuadrotorModel.Dynamics.PhysicalWrenchHoverSmoke` after all checks pass; probe 9 variables
- 6. `MoSimQuadrotorModel.Dynamics.PhysicalWrenchYawStepSmoke` after all checks pass; probe 9 variables
