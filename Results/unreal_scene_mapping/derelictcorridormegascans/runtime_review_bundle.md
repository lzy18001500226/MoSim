...
- runtime_degraded: `missing_ros1_commands:roscore,roslaunch,rostopic,rosnode,rosparam,rviz`, `missing_catkin_build_tool`, `fast_lio_ros1_package_not_visible:fast_lio`, `missing_ros1_rviz_catkin_runtime`, `ros1_fastlio_compat_runtime_unavailable`
...
- `rviz_mapping_window`: `RVIZ_PROFILE=split Scripts/UE5/open_mapping_rviz_ros2.sh derelictcorridormegascans`
- `rviz_planning_grid_window`: `RVIZ_PROFILE=planning_grid Scripts/UE5/open_mapping_rviz_ros2.sh derelictcorridormegascans`
- `rviz_fastlio_pointcloud_window`: `RVIZ_PROFILE=fastlio_pointcloud Scripts/UE5/open_mapping_rviz_ros2.sh derelictcorridormegascans`
- `fastlio_rviz_runtime`: `Scripts/UE5/run_fastlio_rviz_replay_ros2.sh derelictcorridormegascans`
