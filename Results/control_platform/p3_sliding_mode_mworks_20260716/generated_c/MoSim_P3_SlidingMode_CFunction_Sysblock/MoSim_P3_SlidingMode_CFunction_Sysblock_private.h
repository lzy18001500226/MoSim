 ...
 *
 * 文件名称: MoSim_P3_SlidingMode_CFunction_Sysblock_private.h
...
struct ion_sysblockExtY
{
  ...
  MwbDouble sliding_surface_x_out;
  MwbDouble sliding_surface_y_out;
  MwbDouble sliding_surface_z_out;
  MwbDouble auxiliary_state_x_out;
  MwbDouble auxiliary_state_y_out;
  MwbDouble auxiliary_state_z_out;
  MwbDouble effective_reaching_gain_x_out;
  MwbDouble effective_reaching_gain_y_out;
  MwbDouble effective_reaching_gain_z_out;
