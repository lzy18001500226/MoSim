...
- Controller matrix: `{'accepted': 27, 'executed_blocked': 33, 'not_run': 7}`
...
| `REQ-CTRL-01..79` | Controller-family coverage | `partial` | `Results/control_platform/classic_controller_closeout_20260717/CLASSIC_CONTROLLER_FINAL_MATRIX.json` | 67 rows are visible: 27 accepted, 33 executed-blocked, 7 not-run; only accepted rows may be presented as selectable Gazebo controllers. |
