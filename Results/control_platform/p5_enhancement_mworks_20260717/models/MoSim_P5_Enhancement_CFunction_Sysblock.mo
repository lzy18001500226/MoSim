...
:false,"overflow":false}},"data_type":{"real_as_float":false},"experiment":{"task_and_sample":{"muti_task_mode":false,"whether_to_use_prefix":false}},"hardware_platform":{"largest_atomic_size":{"floating_point":"64","integer":"32"}},"identifier":{"max_length":32,"style":{"function":"camelCase","local_variable":"camelCase","macro":"camelCase","mem_var":"camelCase","type":"camelCase"}},"interface":{"function_name":{"initialize":"Init","step":"Step"}},"is_expand":{"is_expand":false},"optimization":{"array_loop_threshold":5,"logical_operator":"logical"}}, Sim_seting = {"sim_seting":{"output":"C:\\Users\\HP\\Desktop\\MoSim\\Results\\control_platform\\p5_enhancement_mworks_20260717\\generated_c"}})),Icon(coordinateSystem(preserveAspectRatio=false)),experiment(DoublePrecision=true,Algorithm=Euler,IntegratorStep=0.01,Interval=0.01,StartTime=0,StopTime=0.03,StoreEventValue=0),Diagram(coordinateSystem(extent={{-340,-620},{340,280}},grid={2,2})));
  ...
  SysplorerEmbeddedCoder.Port.Inport measured_acceleration_x_in 
  ...
  SysplorerEmbeddedCoder.Port.Inport measured_acceleration_y_in 
  ...
  SysplorerEmbeddedCoder.Port.Inport measured_acceleration_z_in 
  ...
  SysplorerEmbeddedCoder.Port.Inport trajectory_phase_bin_in 
  ...
  SysplorerEmbeddedCoder.Port.Inport repeat_complete_in 
  ...
  SysplorerEmbeddedCoder.Port.Outport nominal_acceleration_x_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport nominal_acceleration_y_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport nominal_acceleration_z_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport compensation_x_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport compensation_y_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport compensation_z_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport observer_state_x_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport observer_state_y_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport observer_state_z_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport effective_gain_scale_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport status_code_out 
    annotation (Placement(transformation(origin={300,-20},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
...
,instance="reference_velocity_z"),label(text="reference_acceleration_x",instance="reference_acceleration_x"),label(text="reference_acceleration_y",instance="reference_acceleration_y"),label(text="reference_acceleration_z",instance="reference_acceleration_z"),label(text="reference_yaw",instance="reference_yaw"),label(text="trajectory_phase_bin",instance="trajectory_phase_bin"),label(text="repeat_complete",instance="repeat_complete"),label(text="mass_kg",instance="mass_kg"),label(text="gravity_mps2",instance="gravity_mps2"),label(text="hover_percentage",instance="hover_percentage"),label(text="max_tilt_rad",instance="max_tilt_rad"),label(text="min_collective_thrust_n",instance="min_collective_thrust_n"),label(text="max_collective_thrust_n",instance="max_collective_thrust_n"),label(text="enable",instance="enable"),label(text="reset",instance="reset"),label(text="desired_attitude_w",instance="desired_attitude_w"),label(text="desired_attitude_x",instance="desired_attitude_x"),label(text="desired_attitude_y",instance="desired_attitude_y"),label(text="desired_attitude_z",instance="desired_attitude_z"),label(text="normalized_thrust",instance="normalized_thrust"),label(text="collective_thrust_n",instance="collective_thrust_n"),label(text="desired_acceleration_x",instance="desired_acceleration_x"),label(text="desired_acceleration_y",instance="desired_acceleration_y"),label(text="desired_acceleration_z",instance="desired_acceleration_z"),label(text="nominal_acceleration_x",instance="nominal_acceleration_x"),label(text="nominal_acceleration_y",instance="nominal_acceleration_y"),label(text="nominal_acceleration_z",instance="nominal_acceleration_z"),label(text="compensation_x",instance="compensation_x"),label(text="compensation_y",instance="compensation_y"),label(text="compensation_z",instance="compensation_z"),label(text="observer_state_x",instance="observer_state_x"),label(text="observer_state_y",instance="observer_state_y"),label(text="observer_state_z",instance="observer_state_z"
    ...
    function func_CFunction
      ...
      input SysplorerEmbeddedCoder.Types.Auto measured_acceleration_x annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      input SysplorerEmbeddedCoder.Types.Auto measured_acceleration_y annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      input SysplorerEmbeddedCoder.Types.Auto measured_acceleration_z annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      ...
      input SysplorerEmbeddedCoder.Types.Auto trajectory_phase_bin annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      input SysplorerEmbeddedCoder.Types.Auto repeat_complete annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      ...
      output SysplorerEmbeddedCoder.Types.Auto nominal_acceleration_x annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto nominal_acceleration_y annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto nominal_acceleration_z annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto compensation_x annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto compensation_y annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto compensation_z annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto observer_state_x annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto observer_state_y annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto observer_state_z annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto effective_gain_scale annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
...
");
    ...
    SysplorerEmbeddedCoder.Port.Inport velocity_z 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Inport measured_acceleration_x 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Inport measured_acceleration_y 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Inport measured_acceleration_z 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    ...
    SysplorerEmbeddedCoder.Port.Inport reference_yaw 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Inport trajectory_phase_bin 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Inport repeat_complete 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    ...
    SysplorerEmbeddedCoder.Port.Outport desired_acceleration_z 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport nominal_acceleration_x 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport nominal_acceleration_y 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport nominal_acceleration_z 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport compensation_x 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport compensation_y 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport compensation_z 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport observer_state_x 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport observer_state_y 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport observer_state_z 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
    SysplorerEmbeddedCoder.Port.Outport effective_gain_scale 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
...
equation
  ...
  connect(measured_acceleration_x_in, cFunction.measured_acceleration_x) annotation(Line(origin={0,0},points={{-250,202},{-50,202}},color={0,0,0}));
  connect(measured_acceleration_y_in, cFunction.measured_acceleration_y) annotation(Line(origin={0,0},points={{-250,196},{-50,196}},color={0,0,0}));
  connect(measured_acceleration_z_in, cFunction.measured_acceleration_z) annotation(Line(origin={0,0},points={{-250,190},{-50,190}},color={0,0,0}));
  connect(reference_position_x_in, cFunction.reference_position_x) annotation(Line(origin={0,0},points={{-250,184},{-50,184}},color={0,0,0}));
  connect(reference_position_y_in, cFunction.reference_position_y) annotation(Line(origin={0,0},points={{-250,178},{-50,178}},color={0,0,0}));
  connect(reference_position_z_in, cFunction.reference_position_z) annotation(Line(origin={0,0},points={{-250,172},{-50,172}},color={0,0,0}));
  connect(reference_velocity_x_in, cFunction.reference_velocity_x) annotation(Line(origin={0,0},points={{-250,166},{-50,166}},color={0,0,0}));
  connect(reference_velocity_y_in, cFunction.reference_velocity_y) annotation(Line(origin={0,0},points={{-250,160},{-50,160}},color={0,0,0}));
  connect(reference_velocity_z_in, cFunction.reference_velocity_z) annotation(Line(origin={0,0},points={{-250,154},{-50,154}},color={0,0,0}));
  connect(reference_acceleration_x_in, cFunction.reference_acceleration_x) annotation(Line(origin={0,0},points={{-250,148},{-50,148}},color={0,0,0}));
  connect(reference_acceleration_y_in, cFunction.reference_acceleration_y) annotation(Line(origin={0,0},points={{-250,142},{-50,142}},color={0,0,0}));
  connect(reference_acceleration_z_in, cFunction.reference_acceleration_z) annotation(Line(origin={0,0},points={{-250,136},{-50,136}},color={0,0,0}));
  connect(reference_yaw_in, cFunction.reference_yaw) annotation(Line(origin={0,0},points={{-250,130},{-50,130}},color={0,0,0}));
  connect(trajectory_phase_bin_in, cFunction.trajectory_phase_bin) annotation(Line(origin={0,0},points={{-250,124},{-50,124}},color={0,0,0}));
  connect(repeat_complete_in, cFunction.repeat_complete) annotation(Line(origin={0,0},points={{-250,118},{-50,118}},color={0,0,0}));
  connect(mass_kg_in, cFunction.mass_kg) annotation(Line(origin={0,0},points={{-250,112},{-50,112}},color={0,0,0}));
  connect(gravity_mps2_in, cFunction.gravity_mps2) annotation(Line(origin={0,0},points={{-250,106},{-50,106}},color={0,0,0}));
  connect(hover_percentage_in, cFunction.hover_percentage) annotation(Line(origin={0,0},points={{-250,100},{-50,100}},color={0,0,0}));
  connect(max_tilt_rad_in, cFunction.max_tilt_rad) annotation(Line(origin={0,0},points={{-250,94},{-50,94}},color={0,0,0}));
  connect(min_collective_thrust_n_in, cFunction.min_collective_thrust_n) annotation(Line(origin={0,0},points={{-250,88},{-50,88}},color={0,0,0}));
  connect(max_collective_thrust_n_in, cFunction.max_collective_thrust_n) annotation(Line(origin={0,0},points={{-250,82},{-50,82}},color={0,0,0}));
  connect(enable_in, cFunction.enable) annotation(Line(origin={0,0},points={{-250,76},{-50,76}},color={0,0,0}));
  connect(reset_in, cFunction.reset) annotation(Line(origin={0,0},points={{-250,70},{-50,70}},color={0,0,0}));
  ...
  connect(cFunction.nominal_acceleration_x, nominal_acceleration_x_out) annotation(Line(origin={0,0},points={{50,97},{250,97}},color={0,0,0}));
  connect(cFunction.nominal_acceleration_y, nominal_acceleration_y_out) annotation(Line(origin={0,0},points={{50,90},{250,90}},color={0,0,0}));
  connect(cFunction.nominal_acceleration_z, nominal_acceleration_z_out) annotation(Line(origin={0,0},points={{50,83},{250,83}},color={0,0,0}));
  connect(cFunction.compensation_x, compensation_x_out) annotation(Line(origin={0,0},points={{50,76},{250,76}},color={0,0,0}));
  connect(cFunction.compensation_y, compensation_y_out) annotation(Line(origin={0,0},points={{50,69},{250,69}},color={0,0,0}));
  connect(cFunction.compensation_z, compensation_z_out) annotation(Line(origin={0,0},points={{50,62},{250,62}},color={0,0,0}));
  connect(cFunction.observer_state_x, observer_state_x_out) annotation(Line(origin={0,0},points={{50,55},{250,55}},color={0,0,0}));
  connect(cFunction.observer_state_y, observer_state_y_out) annotation(Line(origin={0,0},points={{50,48},{250,48}},color={0,0,0}));
  connect(cFunction.observer_state_z, observer_state_z_out) annotation(Line(origin={0,0},points={{50,41},{250,41}},color={0,0,0}));
  connect(cFunction.effective_gain_scale, effective_gain_scale_out) annotation(Line(origin={0,0},points={{50,34},{250,34}},color={0,0,0}));
  connect(cFunction.saturated, saturated_out) annotation(Line(origin={0,0},points={{50,27},{250,27}},color={0,0,0}));
  connect(cFunction.status_code, status_code_out) annotation(Line(origin={0,0},points={{50,20},{250,20}},color={0,0,0}));
end MoSim_P5_Enhancement_CFunction_Sysblock;