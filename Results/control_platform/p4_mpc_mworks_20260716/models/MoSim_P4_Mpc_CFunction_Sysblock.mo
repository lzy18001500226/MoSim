...
equation
  ...
  connect(cFunction.unconstrained_acceleration_x, unconstrained_acceleration_x_out) annotation(Line(origin={0,0},points={{50,97},{250,97}},color={0,0,0}));
  connect(cFunction.unconstrained_acceleration_y, unconstrained_acceleration_y_out) annotation(Line(origin={0,0},points={{50,90},{250,90}},color={0,0,0}));
  connect(cFunction.unconstrained_acceleration_z, unconstrained_acceleration_z_out) annotation(Line(origin={0,0},points={{50,83},{250,83}},color={0,0,0}));
  connect(cFunction.auxiliary_x, auxiliary_x_out) annotation(Line(origin={0,0},points={{50,76},{250,76}},color={0,0,0}));
  connect(cFunction.auxiliary_y, auxiliary_y_out) annotation(Line(origin={0,0},points={{50,69},{250,69}},color={0,0,0}));
  connect(cFunction.auxiliary_z, auxiliary_z_out) annotation(Line(origin={0,0},points={{50,62},{250,62}},color={0,0,0}));
  connect(cFunction.solver_cost, solver_cost_out) annotation(Line(origin={0,0},points={{50,55},{250,55}},color={0,0,0}));
  connect(cFunction.solver_iterations, solver_iterations_out) annotation(Line(origin={0,0},points={{50,48},{250,48}},color={0,0,0}));
...
end MoSim_P4_Mpc_CFunction_Sysblock;