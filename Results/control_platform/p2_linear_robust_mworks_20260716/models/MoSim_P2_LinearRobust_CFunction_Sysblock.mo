...
:false,"whether_to_use_prefix":false}},"hardware_platform":{"largest_atomic_size":{"floating_point":"64","integer":"32"}},"identifier":{"max_length":32,"style":{"function":"camelCase","local_variable":"camelCase","macro":"camelCase","mem_var":"camelCase","type":"camelCase"}},"interface":{"function_name":{"initialize":"Init","step":"Step"}},"is_expand":{"is_expand":false},"optimization":{"array_loop_threshold":5,"logical_operator":"logical"}}, Sim_seting = {"sim_seting":{"output":"C:\\Users\\HP\\Desktop\\MoSim\\Results\\control_platform\\p2_linear_robust_mworks_20260716\\generated_c"}})),Icon(coordinateSystem(preserveAspectRatio=false)),experiment(DoublePrecision=true,Algorithm=Euler,IntegratorStep=0.01,Interval=0.01,StartTime=0,StopTime=0.03,StoreEventValue=0),Diagram(coordinateSystem(extent={{-340,-620},{340,280}},grid={2,2})));
  ...
  SysplorerEmbeddedCoder.Port.Outport estimated_position_x_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport estimated_position_y_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport estimated_position_z_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport estimated_velocity_x_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport estimated_velocity_y_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport estimated_velocity_z_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport adaptive_disturbance_x_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport adaptive_disturbance_y_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport adaptive_disturbance_z_out 
  ...
  SysplorerEmbeddedCoder.Port.Outport storage_function_out 
  ...
  block CFunction
    ...
    function func_CFunction
      ...
      output SysplorerEmbeddedCoder.Types.Auto estimated_position_x annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto estimated_position_y annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto estimated_position_z annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto estimated_velocity_x annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto estimated_velocity_y annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto estimated_velocity_z annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto adaptive_disturbance_x annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto adaptive_disturbance_y annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto adaptive_disturbance_z annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
      output SysplorerEmbeddedCoder.Types.Auto storage_function annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)));
    ...
    external "C" MosimLinearRobustStepScalar(controller_id,dt,position_x,position_y,position_z,velocity_x,velocity_y,velocity_z,reference_position_x,reference_position_y,reference_position_z,reference_velocity_x,reference_velocity_y,reference_velocity_z,reference_acceleration_x,reference_acceleration_y,reference_acceleration_z,reference_yaw,mass_kg,gravity_mps2,hover_percentage,max_tilt_rad,min_collective_thrust_n,max_collective_thrust_n,enable,reset,desired_attitude_w,desired_attitude_x,desired_attitude_y,desired_attitude_z,normalized_thrust,collective_thrust_n,desired_acceleration_x,desired_acceleration_y,desired_acceleration_z,estimated_position_x,estimated_position_y,estimated_position_z,estimated_velocity_x,estimated_velocity_y,estimated_velocity_z,adaptive_disturbance_x,adaptive_disturbance_y,adaptive_disturbance_z,storage_function,saturated,status_code) 
      annotation (Include="enum MosimLinearRobustControllerId {
...
");
    ...
    SysplorerEmbeddedCoder.Port.Outport status_code 
      annotation(__MWORKS(BlockSystem(Type(inherit=InheritType.none,ref="double"),Dimension(dimensionType=DimensionType.none)=1)),Placement(transformation(origin={0,0},extent={{-10,-10},{10,10}})));
  equation
    (desired_attitude_w, desired_attitude_x, desired_attitude_y, desired_attitude_z, normalized_thrust, collective_thrust_n, desired_acceleration_x, desired_acceleration_y, desired_acceleration_z, estimated_position_x, estimated_position_y, estimated_position_z, estimated_velocity_x, estimated_velocity_y, estimated_velocity_z, adaptive_disturbance_x, adaptive_disturbance_y, adaptive_disturbance_z, storage_function, saturated, status_code) = func_CFunction(controller_id, dt, position_x, position_y, position_z, velocity_x, velocity_y, velocity_z, reference_position_x, reference_position_y, reference_position_z, reference_velocity_x, reference_velocity_y, reference_velocity_z, reference_acceleration_x, reference_acceleration_y, reference_acceleration_z, reference_yaw, mass_kg, gravity_mps2, hover_percentage, max_tilt_rad, min_collective_thrust_n, max_collective_thrust_n, enable, reset);
  end CFunction;
...
equation
  ...
  connect(cFunction.estimated_position_x, estimated_position_x_out) annotation(Line(origin={0,0},points={{50,97},{250,97}},color={0,0,0}));
  connect(cFunction.estimated_position_y, estimated_position_y_out) annotation(Line(origin={0,0},points={{50,90},{250,90}},color={0,0,0}));
  connect(cFunction.estimated_position_z, estimated_position_z_out) annotation(Line(origin={0,0},points={{50,83},{250,83}},color={0,0,0}));
  connect(cFunction.estimated_velocity_x, estimated_velocity_x_out) annotation(Line(origin={0,0},points={{50,76},{250,76}},color={0,0,0}));
  connect(cFunction.estimated_velocity_y, estimated_velocity_y_out) annotation(Line(origin={0,0},points={{50,69},{250,69}},color={0,0,0}));
  connect(cFunction.estimated_velocity_z, estimated_velocity_z_out) annotation(Line(origin={0,0},points={{50,62},{250,62}},color={0,0,0}));
  connect(cFunction.adaptive_disturbance_x, adaptive_disturbance_x_out) annotation(Line(origin={0,0},points={{50,55},{250,55}},color={0,0,0}));
  connect(cFunction.adaptive_disturbance_y, adaptive_disturbance_y_out) annotation(Line(origin={0,0},points={{50,48},{250,48}},color={0,0,0}));
  connect(cFunction.adaptive_disturbance_z, adaptive_disturbance_z_out) annotation(Line(origin={0,0},points={{50,41},{250,41}},color={0,0,0}));
  connect(cFunction.storage_function, storage_function_out) annotation(Line(origin={0,0},points={{50,34},{250,34}},color={0,0,0}));
...
end MoSim_P2_LinearRobust_CFunction_Sysblock;