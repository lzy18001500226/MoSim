within ;
model SevenScenarioAB_Px4Ctrl_MotorEfficiencyFault
  "Ephemeral evidence harness for px4ctrl/motor_efficiency_fault"
...
end SevenScenarioAB_Px4Ctrl_MotorEfficiencyFault;
