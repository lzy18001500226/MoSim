within ;
model SevenScenarioAB_OfficialPid_Spiral
  "Ephemeral evidence harness for official_pid/spiral"

  extends MoSimQuadrotorModel.Experiment.Runners.Formal.OfficialPidFormalRunner(
    redeclare model Trajectory = MoSimQuadrotorModel.Guidance.Trajectories.SpiralAscent(radius_m = 1.5, angular_rate_rad_s = 0.29999999999999999, climb_rate_m_s = 0.14999999999999999),
    gust_force = {0, 0, 0},
    gust_start_s = 0,
    gust_duration_s = 0,
    mass_scale = 1,
...
end SevenScenarioAB_OfficialPid_Spiral;
