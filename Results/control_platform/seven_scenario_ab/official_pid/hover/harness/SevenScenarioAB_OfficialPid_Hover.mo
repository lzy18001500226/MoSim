within ;
model SevenScenarioAB_OfficialPid_Hover
  "Ephemeral evidence harness for official_pid/hover"

  extends MoSimQuadrotorModel.Experiment.Runners.Formal.OfficialPidFormalRunner(
    redeclare model Trajectory = MoSimQuadrotorModel.Guidance.Trajectories.HoverHold(target_altitude_m = 2, takeoff_duration_s = 5, hold_duration_s = 30),
    gust_force = {0, 0, 0},
    gust_start_s = 0,
    gust_duration_s = 0,
    mass_scale = 1,
...
end SevenScenarioAB_OfficialPid_Hover;
