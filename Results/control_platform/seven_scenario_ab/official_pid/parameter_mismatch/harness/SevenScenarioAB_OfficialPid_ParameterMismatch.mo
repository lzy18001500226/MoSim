within ;
model SevenScenarioAB_OfficialPid_ParameterMismatch
  "Ephemeral evidence harness for official_pid/parameter_mismatch"
...
end SevenScenarioAB_OfficialPid_ParameterMismatch;
