within ;
model SevenScenarioAB_OfficialPid_MotorEfficiencyFault
  "Ephemeral evidence harness for official_pid/motor_efficiency_fault"

  extends MoSimQuadrotorModel.Experiment.Runners.Formal.OfficialPidFormalRunner(
    redeclare model Trajectory = MoSimQuadrotorModel.Guidance.Trajectories.MotorFault(fault_start_s = 15, fault_rotor_index = 1, fault_rotor_effectiveness = 0.5),
    gust_force = {0, 0, 0},
    gust_start_s = 0,
    gust_duration_s = 0,
    mass_scale = 1,
...
end SevenScenarioAB_OfficialPid_MotorEfficiencyFault;
