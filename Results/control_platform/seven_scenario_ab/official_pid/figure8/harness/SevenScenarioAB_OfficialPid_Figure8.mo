within ;
model SevenScenarioAB_OfficialPid_Figure8
  "Ephemeral evidence harness for official_pid/figure8"

  extends MoSimQuadrotorModel.Experiment.Runners.Formal.OfficialPidFormalRunner(
    redeclare model Trajectory = MoSimQuadrotorModel.Guidance.Trajectories.Figure8(altitude_m = 2, takeoff_duration_s = 5, x_amplitude_m = 2, y_amplitude_m = 1, angular_rate_rad_s = 0.34999999999999998),
    gust_force = {0, 0, 0},
    gust_start_s = 0,
    gust_duration_s = 0,
    mass_scale = 1,
...
end SevenScenarioAB_OfficialPid_Figure8;
