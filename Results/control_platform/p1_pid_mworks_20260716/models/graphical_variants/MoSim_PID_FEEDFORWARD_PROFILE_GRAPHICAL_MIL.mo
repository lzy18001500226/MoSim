model MoSim_PID_FEEDFORWARD_PROFILE_GRAPHICAL_MIL "Exact fixed-input graphical MIL for feedforward_profile"
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain pid_feedforward(k=0.5)
...
equation
  ...
  connect(pid_gain_limit.y, scheduled_gain)
    annotation(Line(origin = {0.0, 0.0}, points = {{0, 0}, {0, 0}}));
  end MoSim_PID_FEEDFORWARD_PROFILE_GRAPHICAL_MIL;