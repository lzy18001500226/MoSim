model MoSim_PID_ANTI_WINDUP_MIL
  ...
  SysplorerEmbeddedCoder.Sources.Constant controller_id_source(k=5.0) annotation(Placement(transformation(origin={{-210,130}},extent={{-8,-8},{8,8}})));
  SysplorerEmbeddedCoder.Sources.Constant setpoint_source(k=2.0) annotation(Placement(transformation(origin={{-210,106}},extent={{-8,-8},{8,8}})));
