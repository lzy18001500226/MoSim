model MoSim_PID_FEEDFORWARD_PROFILE_MIL
  ...
  SysplorerEmbeddedCoder.Sources.Constant controller_id_source(k=6.0) annotation(Placement(transformation(origin={{-210,130}},extent={{-8,-8},{8,8}})));
...
end MoSim_PID_FEEDFORWARD_PROFILE_MIL;
