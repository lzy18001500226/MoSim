model MoSim_PID_CASCADE_PID_MIL
  ...
  SysplorerEmbeddedCoder.Sources.Constant setpoint_source(k=0.8) annotation(Placement(transformation(origin={{-210,106}},extent={{-8,-8},{8,8}})));
  ...
  SysplorerEmbeddedCoder.Sources.Constant dt_source(k=0.02) annotation(Placement(transformation(origin={{-210,-62}},extent={{-8,-8},{8,8}})));
