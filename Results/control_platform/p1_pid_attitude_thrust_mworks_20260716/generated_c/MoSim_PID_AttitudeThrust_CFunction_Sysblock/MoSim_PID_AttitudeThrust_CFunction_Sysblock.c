...
unction_sysblockGbIn.reference_yaw_in, unction_sysblockGbIn.schedule_x_in, unction_sysblockGbIn.schedule_y_in, unction_sysblockGbIn.schedule_z_in,
unction_sysblockGbIn.fuzzy_error_x_in, unction_sysblockGbIn.fuzzy_error_y_in, unction_sysblockGbIn.fuzzy_error_z_in, unction_sysblockGbIn.neural_residual_x_in,
unction_sysblockGbIn.neural_residual_y_in, unction_sysblockGbIn.neural_residual_z_in, unction_sysblockGbIn.enable_in, unction_sysblockGbIn.reset_in,
&(function_sysblockGbOut.desired_attitude_w_out), &(function_sysblockGbOut.desired_attitude_x_out), &(function_sysblockGbOut.desired_attitude_y_out),
&(function_sysblockGbOut.desired_attitude_z_out), &(function_sysblockGbOut.desired_collective_thrust_n_out), &(function_sysblockGbOut.desired_acceleration_x_out),
&(function_sysblockGbOut.desired_acceleration_y_out), &(function_sysblockGbOut.desired_acceleration_z_out), &(function_sysblockGbOut.position_error_x_out),
&(function_sysblockGbOut.position_error_y_out), &(function_sysblockGbOut.position_error_z_out), &(function_sysblockGbOut.velocity_error_x_out),
&(function_sysblockGbOut.velocity_error_y_out), &(function_sysblockGbOut.velocity_error_z_out), &(function_sysblockGbOut.scheduled_gain_x_out),
&(function_sysblockGbOut.scheduled_gain_y_out), &(function_sysblockGbOut.scheduled_gain_z_out), &(function_sysblockGbOut.saturated_out),
&(function_sysblockGbOut.status_code_out), &(function_sysblockGbOut.algorithm_id_out_out));
  }
