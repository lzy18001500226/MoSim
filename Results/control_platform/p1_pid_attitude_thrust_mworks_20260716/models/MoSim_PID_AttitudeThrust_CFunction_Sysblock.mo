...
equation
  ...
  connect(schedule_x_in, cFunction.schedule_x) annotation(Line(origin={0,0},points={{-250,100},{-50,100}},color={0,0,0}));
  connect(schedule_y_in, cFunction.schedule_y) annotation(Line(origin={0,0},points={{-250,94},{-50,94}},color={0,0,0}));
  connect(schedule_z_in, cFunction.schedule_z) annotation(Line(origin={0,0},points={{-250,88},{-50,88}},color={0,0,0}));
  connect(fuzzy_error_x_in, cFunction.fuzzy_error_x) annotation(Line(origin={0,0},points={{-250,82},{-50,82}},color={0,0,0}));
  connect(fuzzy_error_y_in, cFunction.fuzzy_error_y) annotation(Line(origin={0,0},points={{-250,76},{-50,76}},color={0,0,0}));
  connect(fuzzy_error_z_in, cFunction.fuzzy_error_z) annotation(Line(origin={0,0},points={{-250,70},{-50,70}},color={0,0,0}));
  connect(neural_residual_x_in, cFunction.neural_residual_x) annotation(Line(origin={0,0},points={{-250,64},{-50,64}},color={0,0,0}));
  connect(neural_residual_y_in, cFunction.neural_residual_y) annotation(Line(origin={0,0},points={{-250,58},{-50,58}},color={0,0,0}));
  connect(neural_residual_z_in, cFunction.neural_residual_z) annotation(Line(origin={0,0},points={{-250,52},{-50,52}},color={0,0,0}));
  connect(enable_in, cFunction.enable) annotation(Line(origin={0,0},points={{-250,46},{-50,46}},color={0,0,0}));
  connect(reset_in, cFunction.reset) annotation(Line(origin={0,0},points={{-250,40},{-50,40}},color={0,0,0}));
