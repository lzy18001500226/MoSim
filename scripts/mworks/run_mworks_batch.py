...
def scenario_command(scenario_path: Path, args: argparse.Namespace) -> list[str]:
    command = [sys.executable, "scripts/mworks/run_mworks_scenario.py", str(scenario_path)]
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "scenarios",
        nargs="*",
        default=["config/scenarios/official/*.yaml"],
        help="Scenario YAML paths or glob patterns. Default: config/scenarios/official/*.yaml",
    )
