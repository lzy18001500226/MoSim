...
OFFICIAL_FULL_RESULT_EXPECTATIONS = {
    "results/official/example1_step/raw/official_example1_pid_baseline.csv": 50.0,
    "results/official/example2_helix/raw/official_example2_pid_baseline.csv": 50.0,
    "results/official/example3_figure8/raw/official_example3_pid_baseline.csv": 120.0,
    "results/official/example1_step/raw/official_example1_improved_pid.csv": 50.0,
    "results/official/example2_helix/raw/official_example2_improved_pid.csv": 50.0,
    "results/official/example3_figure8/raw/official_example3_improved_pid.csv": 120.0,
}
...
MWORKS_MCP_IMPROVED_OUTPUTS = [
    ...
    "results/official/example1_step/logs/sysplorer_example1_improved_pid_full_20260509.jsonl",
    "results/official/example2_helix/logs/sysplorer_example2_improved_pid_full_20260509.jsonl",
    "results/official/example3_figure8/logs/sysplorer_example3_improved_pid_full_20260509.jsonl",
    "results/official/example1_step/raw/official_example1_improved_pid.csv",
    "results/official/example2_helix/raw/official_example2_improved_pid.csv",
    "results/official/example3_figure8/raw/official_example3_improved_pid.csv",
    "results/official/example1_step/metrics/official_example1_improved_pid.json",
    "results/official/example1_step/metrics/official_example1_improved_pid.csv",
    "results/official/example2_helix/metrics/official_example2_improved_pid.json",
    "results/official/example2_helix/metrics/official_example2_improved_pid.csv",
    "results/official/example3_figure8/metrics/official_example3_improved_pid.json",
    "results/official/example3_figure8/metrics/official_example3_improved_pid.csv",
