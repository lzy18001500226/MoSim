# UE-MCP Individual Contributor License Agreement ("Agreement")

Thank you for your interest in contributing to UE-MCP (the "Project"), maintained by David Bingham ("We" or "Us"). In order to clarify the intellectual property license granted with Contributions from any person or entity, We must have a Contributor License Agreement ("CLA") on file that has been signed by each Contributor, indicating agreement to the license terms below. This license is for your protection as a Contributor as well as the protection of Us and the Project's users; it does not change your rights to use your own Contributions for any other purpose.
...
You expressly acknowledge and agree that We may relicense Your Contributions under any license of Our choosing, including but not limited to the Business Source License 1.1 (with the Apache License 2.0 as the Change License), its Change License, and one or more proprietary commercial licenses, and that We may offer the Project (including Your Contributions) under a dual-licensing model.
...
This Agreement shall be governed by and construed in accordance with the laws applicable to Us, without regard to its conflict of laws principles.
