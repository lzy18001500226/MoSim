package QuadrotorControllerBlocks
  ...
  package AWFFPidBlocks
    ...
    model PositionOuterLoop
      "AWFF 位置外环 Sysblock"
      extends QuadrotorControllerBlocks.AWFF_PositionOuterLoop_Sysblock;
    end PositionOuterLoop;
    model AttitudeInnerLoop
      "AWFF 姿态内环 Sysblock"
      extends QuadrotorControllerBlocks.AWFF_AttitudeInnerLoop_Sysblock;
    end AttitudeInnerLoop;
    model MotorMixer
      "四旋翼电机混控 Sysblock"
      extends QuadrotorControllerBlocks.AWFF_MotorMixer_Sysblock;
    end MotorMixer;
    model FullControllerGraphical
      "AWFF 分层完整图形控制器"
      extends QuadrotorControllerBlocks.AWFF_FullController_Sysblock;
    end FullControllerGraphical;
    model FullControllerEquation
      "AWFF 完整控制器方程桥接"
      extends QuadrotorControllerBlocks.AWFF_FullControllerEquation_Sysblock;
  ...
  package InnovationControllers
    ...
    model INDIEquation
      "INDI-like 组合控制器方程入口"
      extends QuadrotorControllerBlocks.AWFF_INDIControllerEquation_Sysblock;
    end INDIEquation;
    model L1ResidualEquation
      "L1-inspired 残差补偿控制器入口"
      extends QuadrotorControllerBlocks.AWFF_L1ResidualControllerEquation_Sysblock;
  ...
  package FaultAllocationControllers
    ...
    model FaultCompensationEquation
      "已知故障补偿方程入口"
      extends QuadrotorControllerBlocks.AWFF_FaultCompensationControllerEquation_Sysblock;
    end FaultCompensationEquation;
    model L1FaultAllocationEquation
      "L1 已知故障分配入口"
      extends QuadrotorControllerBlocks.AWFF_L1FaultAllocationControllerEquation_Sysblock;
    end L1FaultAllocationEquation;
    model L1OnlineFaultAllocationEquation
      "L1 在线故障分配入口"
      extends QuadrotorControllerBlocks.AWFF_L1OnlineFaultAllocationControllerEquation_Sysblock;
    end L1OnlineFaultAllocationEquation;
    model L1MultiFaultIsolationEquation
      "L1 多故障隔离入口"
      extends QuadrotorControllerBlocks.AWFF_L1MultiFaultIsolationControllerEquation_Sysblock;
    end L1MultiFaultIsolationEquation;
    model LinearMPCOnlineFaultAllocation
      "线性 MPC 在线故障分配入口"
      extends QuadrotorControllerBlocks.AWFF_LinearMPCOnlineFaultAllocationController_Sysblock;
  ...
  package DemosAndSIL
    ...
    model PIDDemo
      "AWFF PID 高度环演示入口"
      extends QuadrotorControllerBlocks.AWFF_PID_Sysblock_Demo;
    end PIDDemo;
