...
model PlanningNavigationDisplay
  ...
  parameter String static_map_mesh_uri =
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_obstacle_columns_0p2_h2p8_3p5.stl";
  ...
  parameter String static_terrain_band_mesh_uri[5] = {
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_terrain_band_1_ground_0p2.stl",
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_terrain_band_2_ground_0p2.stl",
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_terrain_band_3_ground_0p2.stl",
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_terrain_band_4_ground_0p2.stl",
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_terrain_band_5_ground_0p2.stl"};
  parameter String static_obstacle_mesh_uri =
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_obstacle_columns_0p2_h2p8_3p5.stl";
  parameter String static_grid_mesh_uri =
    "modelica://MoSimQuadrotorModel/Environment/Maps/Resources/Visualization/map_open_blocks_static_terrain_grid_2m_patch0p2.stl";
...
protected
  ...
  parameter Integer ground_pillar_count =
    if render_terrain_blocks then terrain_render_x_count * terrain_render_y_count else 1
    "Keep one invisible placeholder when global terrain is disabled; do not expand a full-map visualizer array.";
...
equation
  ...
  for i in 1:max_wall_groups loop
    ...
    wall_arm1_near[i] = i <= wall_group_count and highlight_local_costmap and 
      wall_arm1_distance_to_uav[i] > local_costmap_radius_m and 
      wall_arm1_distance_to_uav[i] <= local_costmap_fade_radius_m and not wall_arm1_occluded[i];
    wall_arm2_near[i] = i <= wall_group_count and highlight_local_costmap and 
      wall_arm2_distance_to_uav[i] > local_costmap_radius_m and 
      wall_arm2_distance_to_uav[i] <= local_costmap_fade_radius_m and not wall_arm2_occluded[i];
    wall_arm1_display_radius[i] = if wall_arm1_sensed[i] then local_costmap_radius_m else 
      if wall_arm1_near[i] then local_costmap_fade_radius_m else 0.0;
    wall_arm2_display_radius[i] = if wall_arm2_sensed[i] then local_costmap_radius_m else 
      if wall_arm2_near[i] then local_costmap_fade_radius_m else 0.0;
