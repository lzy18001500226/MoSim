...
model FormationTriangleFigure8LinearMPCSysblockClosedLoop
  ...
  MoSimQuadrotorModel.Vehicle.Mechanics.QuadChassis quadChassisFollower1(
  ...
  MoSimQuadrotorModel.Vehicle.Mechanics.QuadChassis quadChassisFollower2(
  ...
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower1Actuator1(dcpm(wMechanical(start = hover_motor_speed_cmd)));
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower1Actuator2(dcpm(wMechanical(start = -hover_motor_speed_cmd)));
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower1Actuator3(dcpm(wMechanical(start = hover_motor_speed_cmd)));
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower1Actuator4(dcpm(wMechanical(start = -hover_motor_speed_cmd)));
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower2Actuator1(dcpm(wMechanical(start = hover_motor_speed_cmd)));
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower2Actuator2(dcpm(wMechanical(start = -hover_motor_speed_cmd)));
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower2Actuator3(dcpm(wMechanical(start = hover_motor_speed_cmd)));
  MoSimQuadrotorModel.Vehicle.Electricals.Actuator follower2Actuator4(dcpm(wMechanical(start = -hover_motor_speed_cmd)));

  MoSimQuadrotorModel.Vehicle.Sensors.Sensors sensors1_1;
  MoSimQuadrotorModel.Vehicle.Sensors.Sensors follower1Sensors;
  MoSimQuadrotorModel.Vehicle.Sensors.Sensors follower2Sensors;
  ...
  MoSimQuadrotorModel.Control.Implementations.Sysblocks.AWFF_LinearMPCOuterLoopControllerEquation_Sysblock follower1Controller(
    mpc_acc_limit_xy = 2.7,
    mpc_terminal_gain_xy = 0.12);
  MoSimQuadrotorModel.Control.Implementations.Sysblocks.AWFF_LinearMPCOuterLoopControllerEquation_Sysblock follower2Controller(
    mpc_acc_limit_xy = 2.7,
    mpc_terminal_gain_xy = 0.12);
