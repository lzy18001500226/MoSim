within MoSimQuadrotorModel.Visualization.Scenarios;
model Sunray150UEDerelictLinearMPCSysblockSmoke
  "Sunray150 UE accepted scene smoke reference for derelictcorridormegascans; control interface only"
  ...
  PlannedQuinticReference planningReference(
    n_segments = 44,
    p_x = {
      87.54, 87.54, 87.54, 87.54, 87.54, 87.54,
      87.54, 87.54, 87.54, 87.54, 87.54, 87.54,
      87.54, 87.54, 87.54, 87.54, 87.54, 87.54,
      87.54, 87.19, 86.84, 86.49, 86.49, 86.14,
      86.14, 86.14, 86.14, 86.14, 86.14, 86.14,
      86.14, 86.14, 86.14, 86.14, 86.14, 86.14,
      86.14, 85.79, 85.44, 85.09, 84.74, 84.39,
      84.04, 83.69, 83.34, 83.34, 83.34, 83.34,
      83.34, 83.34, 83.34, 83.34, 83.34, 83.34,
      83.34, 83.34, 83.34, 83.34, 83.34, 83.34,
      83.34, 83.34, 83.34, 83.34, 83.34, 83.34,
      83.34, 83.34, 83.34, 83.34, 83.34, 83.34,
      83.34, 83.34, 83.34, 83.34, 83.34, 83.34,
      ...
      83.34},
    p_y = {
      22.34046, 22.69046, 23.04046, 23.39046, 23.74046, 24.09046,
      24.44046, 24.79046, 25.14046, 25.49046, 25.84046, 26.19046,
      26.54046, 26.89046, 27.24046, 27.59046, 27.94046, 28.29046,
      28.64046, 28.99046, 29.34046, 29.69046, 30.04046, 30.39046,
      30.74046, 31.09046, 31.44046, 31.79046, 32.14046, 32.49046,
      32.84046, 33.19046, 33.54046, 33.89046, 34.24046, 34.59046,
      34.94046, 34.94046, 34.94046, 34.94046, 34.94046, 34.94046,
      34.94046, 34.94046, 34.94046, 34.94046, 34.94046, 34.94046,
      34.94046, 34.94046, 34.94046, 34.94046, 34.94046, 34.94046,
      34.94046, 34.94046, 34.94046, 34.94046, 34.94046, 34.94046,
      34.94046, 34.94046, 34.94046, 34.94046, 34.94046, 34.94046,
  ...
  MoSimQuadrotorModel.Vehicle.Mechanics.QuadChassis quadChassisTest17_1(
    body(color = {135, 206, 235}, r_0(start = {87.54, 22.34046, 2.2}, fixed = {true, true, true})));
...
equation
  ...
  annotation(experiment(Algorithm = Dassl, StartTime = 0, StopTime = 39.6, Tolerance = 0.0001, Interval = 0.05));
