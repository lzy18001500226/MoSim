...
model Sunray150UEFactoryTraceTableLinearMPCSysblockSmoke
  "Trace-table-driven Sunray150 UE Factory smoke wrapper consuming ROS2 adapter setpoint trace; smoke evidence only"
...
equation
  ...
  annotation(experiment(Algorithm = Dassl, StartTime = 0, StopTime = 9.943895527, Tolerance = 0.0001, Interval = 0.05));
