...
model FactoryTraceIso14ConstantAttitudeInputSmoke
  "Attitude intermediary 14: position feedback plus nonzero constant roll attitude input, no AngleMea dependency"
  ...
  Modelica.Blocks.Sources.Constant constant_roll(k = 0.05);
...
equation
  ...
  connect(constant_roll.y, controller3_2.roll_mea);
