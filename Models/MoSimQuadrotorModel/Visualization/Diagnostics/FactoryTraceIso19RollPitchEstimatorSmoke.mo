...
model FactoryTraceIso19RollPitchEstimatorSmoke
  "Pitch decoupling 19: project-owned first-order roll+pitch attitude extraction before controller inputs"
  ...
  MoSimQuadrotorModel.Vehicle.Mechanics.QuadChassis quadChassisTest19_1(
...
equation
  connect(actuator1_1.flange_a, quadChassisTest19_1.flange_a);
  connect(actuator1_2.flange_a, quadChassisTest19_1.flange_a1);
  connect(actuator1_3.flange_a, quadChassisTest19_1.flange_a2);
  connect(actuator1_4.flange_a, quadChassisTest19_1.flange_a3);
  connect(quadChassisTest19_1.frame_a, sensors1_1.frame_a);
  ...
  connect(planningReference.yaw_ref, controller3_2.yaw_mea);
