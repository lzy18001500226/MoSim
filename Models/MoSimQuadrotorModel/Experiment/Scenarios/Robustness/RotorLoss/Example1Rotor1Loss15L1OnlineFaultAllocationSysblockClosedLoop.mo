within MoSimQuadrotorModel.Experiment.Scenarios.Robustness.RotorLoss;
model Example1Rotor1Loss15L1OnlineFaultAllocationSysblockClosedLoop
  "Example1 rotor 1 lift efficiency 85% with L1 residual and online efficiency-estimated allocation compensation"
  ...
  MoSimQuadrotorModel.Vehicle.Mechanics.QuadChassis quadChassisTest17_1(gain2(k = 0.0007266293));
  ...
  MoSimQuadrotorModel.Control.Implementations.Sysblocks.AWFF_L1OnlineFaultAllocationControllerEquation_Sysblock controller3_2;
