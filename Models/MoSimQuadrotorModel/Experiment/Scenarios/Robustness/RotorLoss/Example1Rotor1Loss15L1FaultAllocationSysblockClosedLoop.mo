...
model Example1Rotor1Loss15L1FaultAllocationSysblockClosedLoop
  "Example1 rotor 1 lift efficiency 85% with L1 residual and known-efficiency allocation compensation"
  ...
  MoSimQuadrotorModel.Control.Implementations.Sysblocks.AWFF_L1FaultAllocationControllerEquation_Sysblock controller3_2;
