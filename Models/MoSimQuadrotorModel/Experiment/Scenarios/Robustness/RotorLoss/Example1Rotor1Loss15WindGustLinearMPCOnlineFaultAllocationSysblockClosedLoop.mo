...
model Example1Rotor1Loss15WindGustLinearMPCOnlineFaultAllocationSysblockClosedLoop
  "Example1 rotor 1 lift efficiency 85% plus lateral gust with LinearMPC and online fault allocation"
  ...
  AWFF_LinearMPCOnlineFaultAllocationController_Sysblock controller3_2;
