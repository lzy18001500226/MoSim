...
model Example1Rotor1Loss15L1MultiFaultIsolationSysblockClosedLoop
  "Example1 rotor 1 lift efficiency 85% with four-rotor online fault isolation and allocation"
  ...
  MoSimQuadrotorModel.Control.Implementations.Sysblocks.AWFF_L1MultiFaultIsolationControllerEquation_Sysblock controller3_2;
