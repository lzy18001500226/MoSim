...
model Example1Rotor2Loss15WindGustL1MultiFaultIsolationSysblockClosedLoop
  "Example1 rotor 2 lift efficiency 85% plus lateral gust with L1 multi-fault isolation controller"
  ...
  MoSimQuadrotorModel.Vehicle.Mechanics.QuadChassis quadChassisTest17_1(gain3(k = 0.0007266293));
