...
model Example1Rotor1Loss15WindGustAWFFFaultCompensationSysblockClosedLoop
  "Example1 rotor 1 lift efficiency 85% plus lateral gust with AWFF fault compensation Sysblock controller"
  ...
  AWFF_FaultCompensationControllerEquation_Sysblock controller3_2;
