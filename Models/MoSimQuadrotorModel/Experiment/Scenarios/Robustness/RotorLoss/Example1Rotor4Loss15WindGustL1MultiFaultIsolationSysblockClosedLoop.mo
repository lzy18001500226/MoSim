...
model Example1Rotor4Loss15WindGustL1MultiFaultIsolationSysblockClosedLoop
  "Example1 rotor 4 lift efficiency 85% plus lateral gust with L1 multi-fault isolation controller"
  ...
  MoSimQuadrotorModel.Vehicle.Mechanics.QuadChassis quadChassisTest17_1(gain5(k = 0.0007266293));
  ...
  AWFF_L1MultiFaultIsolationControllerEquation_Sysblock controller3_2;
