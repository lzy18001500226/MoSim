...
model FormalBodyRateThrustRunnerBase
  "Reusable 100 Hz formal whole-aircraft runner for BODY_RATE_THRUST adapters"

  replaceable model Controller =
      MoSimQuadrotorModel.Control.Adapters.DfbcHighOrderBodyRateAdapter
...
end FormalBodyRateThrustRunnerBase;
