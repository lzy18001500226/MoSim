...
model TrainedNeuralResidualFormalRunner
  "Formal whole-aircraft minimum-closure runner for trained neural residual"

  parameter Real controller_sample_period_s = 0.01
    "Sampled controller-input boundary required for the C-function loop";
  MoSimQuadrotorModel.Control.Adapters.TrainedNeuralResidualAttitudeThrustAdapter controller
...
end TrainedNeuralResidualFormalRunner;
