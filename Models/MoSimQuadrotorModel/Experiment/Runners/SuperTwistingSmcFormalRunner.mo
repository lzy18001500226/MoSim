...
model SuperTwistingSmcFormalRunner
  "Formal whole-aircraft minimum-closure runner for Super-Twisting SMC"

  parameter Real controller_sample_period_s = 0.01
    "Sampled controller-input boundary required for the C-function loop";
  MoSimQuadrotorModel.Control.Adapters.SuperTwistingSmcAttitudeThrustAdapter controller
...
end SuperTwistingSmcFormalRunner;
