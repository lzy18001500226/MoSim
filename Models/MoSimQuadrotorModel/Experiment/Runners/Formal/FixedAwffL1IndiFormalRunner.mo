...
model FixedAwffL1IndiFormalRunner
  "Formal whole-aircraft runner for the fixed AWFF L1 INDI chain"

  extends MoSimQuadrotorModel.Experiment.Templates.IntegratedChains.FixedAwffL1Indi;
...
end FixedAwffL1IndiFormalRunner;
