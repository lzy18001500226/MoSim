...
model Px4CtrlEquationBridgeFormalRunner
  "Report-compatible EquationBridge formal baseline"

  parameter Real controller_sample_period_s = 0.01;
  MoSimQuadrotorModel.Control.Adapters.Px4CtrlEquationBridgeReportBaselineAdapter controller;
  MoSimQuadrotorModel.Control.Allocation.OfflineAttitudeRateReportBaselineAllocator offline_inner_allocator;
...
end Px4CtrlEquationBridgeFormalRunner;