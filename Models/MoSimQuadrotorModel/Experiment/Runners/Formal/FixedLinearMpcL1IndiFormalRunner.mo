...
model FixedLinearMpcL1IndiFormalRunner
  "Formal whole-aircraft runner for the fixed linear MPC L1 INDI chain"

  extends MoSimQuadrotorModel.Experiment.Templates.IntegratedChains.FixedLinearMpcL1Indi;
...
end FixedLinearMpcL1IndiFormalRunner;
