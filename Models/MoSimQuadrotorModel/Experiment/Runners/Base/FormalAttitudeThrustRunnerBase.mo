...
model FormalAttitudeThrustRunnerBase
  "Reusable formal whole-aircraft runner for ATTITUDE_THRUST adapters"

  replaceable model Controller =
      MoSimQuadrotorModel.Control.Baselines.OfflineAttitudeThrustController
...
end FormalAttitudeThrustRunnerBase;
