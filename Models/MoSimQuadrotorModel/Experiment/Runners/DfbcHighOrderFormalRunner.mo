...
model DfbcHighOrderFormalRunner
  "Formal whole-aircraft minimum-closure runner for high-order DFBC"

  parameter Real controller_sample_period_s = 0.01
    "Sampled controller-input boundary required for the formal loop";
  MoSimQuadrotorModel.Control.Adapters.DfbcHighOrderAttitudeThrustAdapter controller
