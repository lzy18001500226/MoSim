...
model Sunray150CompleteSystemGraphical_Sysblock
  ...
  equation
    ...
    annotation (
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}), graphics = {
        ...
        Bitmap(origin = {0, 8}, extent = {{-96, -62}, {96, 62}}, fileName = "modelica://MoSimQuadrotorModel/Vehicle/Resources/Images/Battery.png"),
  ...
  equation
    ...
    annotation (
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}), graphics = {
        ...
        Bitmap(origin = {0, 8}, extent = {{-96, -62}, {96, 62}}, fileName = "modelica://MoSimQuadrotorModel/Vehicle/Resources/Images/ESC.png"),
  ...
  model MotorDriveModule
    ...
    Modelica.Mechanics.Rotational.Interfaces.Flange_b flange
      annotation (Placement(transformation(origin = {110, 45}, extent = {{-5, -5}, {5, 5}})));
    MoSimQuadrotorModel.Vehicle.Electricals.Actuator actuator(dcpm(wMechanical(start = initial_speed)));
  ...
  equation
    ...
    annotation (
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}), graphics = {
        ...
        Bitmap(origin = {0, 14}, extent = {{-96, -55}, {96, 55}}, fileName = "modelica://MoSimQuadrotorModel/Vehicle/Resources/Images/motor.png"),
