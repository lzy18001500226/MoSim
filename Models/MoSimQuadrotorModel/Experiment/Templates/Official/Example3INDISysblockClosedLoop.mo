...
model Example3INDISysblockClosedLoop
  "Example3 plant with project AWFF + L1-inspired outer loop and INDI-like attitude Sysblock controller"
  ...
  MoSimQuadrotorModel.Guidance.Trajectories.EightPath climbePath;
