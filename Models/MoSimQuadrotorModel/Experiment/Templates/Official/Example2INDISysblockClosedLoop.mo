within MoSimQuadrotorModel.Experiment.Templates.Official;
model Example2INDISysblockClosedLoop
  "Example2 plant with project AWFF + L1-inspired outer loop and INDI-like attitude Sysblock controller"
  ...
  MoSimQuadrotorModel.Guidance.Trajectories.CirclePath climbePath(ramp(height=20), sine(f=0.05), cosine(f=0.05, startTime=10, phase=0));
  ...
  AWFF_INDIControllerEquation_Sysblock controller3_2;
