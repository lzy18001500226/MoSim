...
model BacksteppingBaselineGraphicalRunner
  "backstepping_baseline graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.ClassicRobust.BacksteppingBaseline.BacksteppingBaselineCore core 
