...
model H2StateFeedbackGraphicalRunner
  "h2_state_feedback graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.ClassicRobust.H2StateFeedback.H2StateFeedbackCore core 
