...
model HinfHoverWrenchGraphicalRunner
  "hinf_hover_wrench graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.ClassicRobust.HinfHoverWrench.HinfHoverWrenchCore core 
...
equation
  connect(core.adapted_roll_rad_out, output_adapter.roll_ref) annotation(Line(points={{15,230},{40,230},{40,222},{58,222}}, color={55,80,115}));
  connect(core.adapted_pitch_rad_out, output_adapter.pitch_ref) annotation(Line(points={{15,202},{40,202},{40,194},{58,194}}, color={55,80,115}));
  connect(core.adapted_yaw_rad_out, output_adapter.yaw_ref) annotation(Line(points={{15,174},{40,174},{40,166},{58,166}}, color={55,80,115}));
