...
model NdiGraphicalRunner
  "ndi graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.ClassicRobust.Ndi.NdiCore core 
