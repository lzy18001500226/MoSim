...
model LqiBaselineGraphicalRunner
  "lqi_baseline graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.ClassicRobust.LqiBaseline.LqiBaselineCore core 
