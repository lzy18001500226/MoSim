...
model PolePlacementLuenbergerGraphicalRunner
  "pole_placement_luenberger graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.ClassicRobust.PolePlacementLuenberger.PolePlacementLuenbergerCore core 
