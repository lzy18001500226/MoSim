...
model AdaptiveBacksteppingGraphicalRunner
  "adaptive_backstepping graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.ClassicRobust.AdaptiveBackstepping.AdaptiveBacksteppingCore core 
...
equation
  connect(core.command, output_adapter.command) annotation(Line(points={{15,230},{40,230},{40,222},{58,222}}, color={55,80,115}));
