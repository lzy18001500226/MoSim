...
equation
  connect(reference.position_command[1], controller.x_error) annotation(Line(points={{-300,240}}, color={0,0,127}));
  connect(reference.position_command[2], controller.y_error) annotation(Line(points={{-300,226}}, color={0,0,127}));
  connect(reference.position_command[3], controller.z_error) annotation(Line(points={{-300,212}}, color={0,0,127}));
  connect(reference.velocity_command[3], controller.z_ref_rate) annotation(Line(points={{-300,198}}, color={0,0,127}));
  ...
  connect(reference.velocity_command[1], controller.yaw_ref) annotation(Line(points={{-300,142}}, color={0,0,127}));
