...
equation
  connect(reference.position_command[1], core.x_error) annotation(Line(points={{-300,240}}, color={0,0,127}));
  connect(reference.position_command[2], core.y_error) annotation(Line(points={{-300,226}}, color={0,0,127}));
  connect(reference.position_command[3], core.z_error) annotation(Line(points={{-300,212}}, color={0,0,127}));
  connect(reference.velocity_command[3], core.z_ref_rate) annotation(Line(points={{-300,198}}, color={0,0,127}));
  ...
  connect(reference.velocity_command[1], core.yaw_ref) annotation(Line(points={{-300,142}}, color={0,0,127}));
