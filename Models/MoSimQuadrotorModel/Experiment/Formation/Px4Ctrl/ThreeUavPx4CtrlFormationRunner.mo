...
model ThreeUavPx4CtrlFormationRunner
  "Three-UAV triangle figure-eight formation with pairwise ECBF safety filter,
   each vehicle driven by an independent Px4Ctrl baseline controller chain"
  ...
  parameter Real trajectory_start_s(unit = "s") = 5.0;
  ...
  // ── Formation reference (virtual-structure triangle on figure-eight) ──────────
  MoSimQuadrotorModel.Guidance.Formation.TriangleFigure8Reference formation_ref(
    altitude_m            = altitude_m,
    x_amplitude_m         = x_amplitude_m,
    y_amplitude_m         = y_amplitude_m,
...
color={0,0,127}));
  ...
  // formation_ref right-side ports: global x=-582.5, y=[188.264,172.664,157.064,141.464,125.864,110.264,94.664,84.264,73.864]
  // ecbf_filter left-side ports:   global x=-687.5, y=[-6.084,-34.589,-63.095,-91.600,-120.106,-148.611,-177.117,-205.622,-234.127]
  connect(formation_ref.uav1_position_command,     ecbf_filter.nominal_position_1) 
    annotation(Line(origin={0,0},
points={{-725.75,8.1694},{-705,8.1694},{-705,-6.0834},{-687.5,-6.0834}},
color={0,0,127}));
  connect(formation_ref.uav1_velocity_command,     ecbf_filter.nominal_velocity_1) 
    annotation(Line(origin={0,0},
points={{-725.75,-26.0373},{-705.375,-26.0373},{-705.375,-34.589},{-687.5,-34.589}},
color={0,0,127}));
  connect(formation_ref.uav1_acceleration_command, ecbf_filter.nominal_acceleration_1) 
    annotation(Line(origin={0,0},
points={{-725.75,-60.244},{-705.375,-60.244},{-705.375,-63.0946},{-687.5,-63.0946}},
color={0,0,127}));
  connect(formation_ref.uav2_position_command,     ecbf_filter.nominal_position_2) 
    annotation(Line(origin={0,0},
points={{-725.75,-94.45076},{-705.375,-94.45076},{-705.375,-91.6002},{-687.5,-91.6002}},
color={0,0,127}));
  connect(formation_ref.uav2_velocity_command,     ecbf_filter.nominal_velocity_2) 
    annotation(Line(origin={0,0},
points={{-725.75,-128.65748},{-705,-128.65748},{-705,-120.106},{-687.5,-120.106}},
color={0,0,127}));
  connect(formation_ref.uav2_acceleration_command, ecbf_filter.nominal_acceleration_2) 
    annotation(Line(origin={0,0},
points={{-725.75,-162.864},{-705,-162.864},{-705,-148.6114},{-687.5,-148.6114}},
color={0,0,127}));
  connect(formation_ref.uav3_position_command,     ecbf_filter.nominal_position_3) 
    annotation(Line(origin={0,0},
points={{-725.75,-197.07092},{-705,-197.07092},{-705,-177.117},{-687.5,-177.117}},
color={0,0,127}));
  connect(formation_ref.uav3_velocity_command,     ecbf_filter.nominal_velocity_3) 
    annotation(Line(origin={0,0},
points={{-725.75,-219.8754},{-705,-219.875},{-705,-205.623},{-687.5,-205.623}},
color={0,0,127}));
  connect(formation_ref.uav3_acceleration_command, ecbf_filter.nominal_acceleration_3) 
    annotation(Line(origin={0,0},
...
end ThreeUavPx4CtrlFormationRunner;