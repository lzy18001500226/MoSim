within MoSimQuadrotorModel.Experiment.SingleUav.GeometricFlatness;
model DfbcSmoothRobustBodyrateGraphicalRunner
  "dfbc_smooth_robust_bodyrate graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.GeometricFlatness.DfbcSmoothRobustBodyrate.DfbcSmoothRobustBodyrateCore core 
...
equation
  connect(plant.position[1], core.position_x) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,240},{-145,240}}, color={0,100,150}));
  connect(plant.position[2], core.position_y) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,226},{-145,226}}, color={0,100,150}));
  connect(plant.position[3], core.position_z) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,212},{-145,212}}, color={0,100,150}));
  connect(plant.VelMea[1], core.velocity_x) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,198},{-145,198}}, color={0,100,150}));
  connect(plant.VelMea[2], core.velocity_y) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,184},{-145,184}}, color={0,100,150}));
  connect(plant.VelMea[3], core.velocity_z) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,170},{-145,170}}, color={0,100,150}));
  connect(reference.position_command[1], core.reference_position_x) annotation(Line(points={{-300,156}}, color={0,0,127}));
  connect(reference.position_command[2], core.reference_position_y) annotation(Line(points={{-300,142}}, color={0,0,127}));
  connect(reference.position_command[3], core.reference_position_z) annotation(Line(points={{-300,240}}, color={0,0,127}));
  connect(reference.velocity_command[1], core.reference_velocity_x) annotation(Line(points={{-300,226}}, color={0,0,127}));
  connect(reference.velocity_command[2], core.reference_velocity_y) annotation(Line(points={{-300,212}}, color={0,0,127}));
  connect(reference.velocity_command[3], core.reference_velocity_z) annotation(Line(points={{-300,198}}, color={0,0,127}));
  connect(reference.acceleration_command[1], core.reference_acceleration_x) annotation(Line(points={{-300,184}}, color={0,0,127}));
  connect(reference.acceleration_command[2], core.reference_acceleration_y) annotation(Line(points={{-300,170}}, color={0,0,127}));
  connect(reference.acceleration_command[3], core.reference_acceleration_z) annotation(Line(points={{-300,156}}, color={0,0,127}));
  connect(plant.BodyRateMea[1], core.body_rate_x) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,142},{-145,142}}, color={0,100,150}));
  connect(plant.BodyRateMea[2], core.body_rate_y) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,240},{-145,240}}, color={0,100,150}));
  connect(plant.BodyRateMea[3], core.body_rate_z) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,226},{-145,226}}, color={0,100,150}));
  connect(dt.y, core.dt) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,212},{-145,212}}, color={0,100,150}));
  connect(enable.y, core.enable) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,198},{-145,198}}, color={0,100,150}));
  connect(core.desired_acceleration_x_out, output_adapter.acceleration_x) annotation(Line(points={{15,230},{40,230},{40,222},{58,222}}, color={55,80,115}));
  connect(core.desired_acceleration_y_out, output_adapter.acceleration_y) annotation(Line(points={{15,202},{40,202},{40,194},{58,194}}, color={55,80,115}));
  connect(core.desired_acceleration_z_out, output_adapter.acceleration_z) annotation(Line(points={{15,174},{40,174},{40,166},{58,166}}, color={55,80,115}));
