...
model TerminalSmcGraphicalRunner
  "terminal_smc graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.SlidingMode.TerminalSmc.TerminalSmcCore core 
