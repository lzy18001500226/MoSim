...
model RlGainSchedulerGraphicalRunner
  "rl_gain_scheduler graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.Learning.RlGainScheduler.RlGainSchedulerCore core 
