...
equation
  ...
  connect(reference.position_command[1], controller_core.x_error)
    annotation(Line(points={{-330,240},{-300,240},{-300,240},{-145,240}}, color={0,0,127}));
  connect(reference.position_command[2], controller_core.y_error)
    annotation(Line(points={{-330,226},{-300,226},{-300,226},{-145,226}}, color={0,0,127}));
  connect(reference.position_command[3], controller_core.z_error)
    annotation(Line(points={{-330,212},{-300,212},{-300,212},{-145,212}}, color={0,0,127}));
  connect(reference.velocity_command[3], controller_core.z_ref_rate)
    annotation(Line(points={{-330,198},{-300,198},{-300,198},{-145,198}}, color={0,0,127}));
  ...
  connect(reference.velocity_command[1], controller_core.yaw_ref)
    annotation(Line(points={{-330,142},{-300,142},{-300,142},{-145,142}}, color={0,0,127}));
