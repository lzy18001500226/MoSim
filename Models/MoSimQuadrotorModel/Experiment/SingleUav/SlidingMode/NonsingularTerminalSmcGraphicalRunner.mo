...
model NonsingularTerminalSmcGraphicalRunner
  "nonsingular_terminal_smc graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.SlidingMode.NonsingularTerminalSmc.NonsingularTerminalSmcCore core 
...
equation
  ...
  connect(zero.y, output_adapter.collective_thrust) annotation(Line(points={{-100,188},{0,188},{0,178},{100,178}}, color={0,0,127}));
