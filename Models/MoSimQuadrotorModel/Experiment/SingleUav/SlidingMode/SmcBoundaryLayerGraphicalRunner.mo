within MoSimQuadrotorModel.Experiment.SingleUav.SlidingMode;
model SmcBoundaryLayerGraphicalRunner
  "smc_boundary_layer graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.SlidingMode.SmcBoundaryLayer.SmcBoundaryLayerCore core 
  ...
  Modelica.Blocks.Math.Add position_error 
    annotation(Placement(transformation(origin = {-360, -90}, extent = {{-24, -18}, {24, 18}})));

  Modelica.Blocks.Math.Add velocity_error 
...
equation
  connect(reference.position_command[1], position_error.u1) annotation(Line(points={{-100,242},{0,242},{0,232},{100,232}}, color={0,0,127}));
  connect(plant.position[1], position_error.u2) annotation(Line(points={{-100,224},{0,224},{0,214},{100,214}}, color={0,0,127}));
  connect(reference.velocity_command[1], velocity_error.u1) annotation(Line(points={{-100,206},{0,206},{0,196},{100,196}}, color={0,0,127}));
  connect(plant.VelMea[1], velocity_error.u2) annotation(Line(points={{-100,188},{0,188},{0,178},{100,178}}, color={0,0,127}));
  connect(position_error.y, core.position_error_in) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,184},{-145,184}}, color={0,100,150}));
  connect(velocity_error.y, core.velocity_error_in) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,170},{-145,170}}, color={0,100,150}));
  connect(zero.y, core.auxiliary_in) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,156},{-145,156}}, color={0,100,150}));
  connect(core.command, output_adapter.command) annotation(Line(points={{15,146},{40,146},{40,138},{58,138}}, color={55,80,115}));
