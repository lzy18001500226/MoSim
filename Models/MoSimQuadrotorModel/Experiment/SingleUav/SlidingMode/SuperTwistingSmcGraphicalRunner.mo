...
model SuperTwistingSmcGraphicalRunner
  "super_twisting_smc graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.SlidingMode.SuperTwistingSmc.SuperTwistingSmcCore core 
