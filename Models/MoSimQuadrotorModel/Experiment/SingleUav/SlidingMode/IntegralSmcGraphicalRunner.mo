...
model IntegralSmcGraphicalRunner
  "integral_smc graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.SlidingMode.IntegralSmc.IntegralSmcCore core 
