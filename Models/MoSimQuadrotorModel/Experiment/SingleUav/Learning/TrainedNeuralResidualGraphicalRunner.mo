within MoSimQuadrotorModel.Experiment.SingleUav.Learning;
model TrainedNeuralResidualGraphicalRunner
  "trained_neural_residual graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.Learning.TrainedNeuralResidual.TrainedNeuralResidualCore core 
...
equation
  connect(core.normalized_thrust, output_adapter.collective_thrust) annotation(Line(points={{15,230},{40,230},{40,222},{58,222}}, color={55,80,115}));
  connect(zero.y, output_adapter.roll_ref) annotation(Line(points={{-100,224},{0,224},{0,214},{100,214}}, color={0,0,127}));
  connect(zero.y, output_adapter.pitch_ref) annotation(Line(points={{-100,206},{0,206},{0,196},{100,196}}, color={0,0,127}));
  connect(zero.y, output_adapter.yaw_ref) annotation(Line(points={{-100,188},{0,188},{0,178},{100,178}}, color={0,0,127}));
