...
model LinearMpcL1IndiGraphicalRunner
  "linear_mpc_l1_indi graphical Sysblock runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.IntegratedChains.LinearMpcL1Indi.LinearMpcL1IndiGraphicalController controller 
...
equation
  ...
  connect(position_error_x.y, controller.x_error) annotation(Line(points={{-218,300},{-200,300},{-200,184},{-145,184}}, color={0,0,127}));
  ...
  connect(position_error_y.y, controller.y_error) annotation(Line(points={{-158,300},{-150,300},{-150,170},{-145,170}}, color={0,0,127}));
  ...
  connect(position_error_z.y, controller.z_error) annotation(Line(points={{-98,300},{-90,300},{-90,156},{-145,156}}, color={0,0,127}));
  connect(reference.velocity_command[3], controller.z_ref_rate) annotation(Line(points={{-300,198},{-230,198},{-230,142},{-145,142}}, color={0,0,127}));
  connect(plant.attitude[1], controller.roll_mea) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,184},{-145,184}}, color={0,100,150}));
  connect(plant.attitude[2], controller.pitch_mea) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,170},{-145,170}}, color={0,100,150}));
  connect(plant.attitude[3], controller.yaw_mea) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,156},{-145,156}}, color={0,100,150}));
  connect(reference.velocity_command[1], controller.yaw_ref) annotation(Line(points={{-300,142},{-220,142},{-220,128},{-145,128}}, color={0,0,127}));
  connect(controller.y, output_adapter.moment_command[1]) annotation(Line(points={{15,230},{40,230},{40,222},{58,222}}, color={55,80,115}));
  connect(controller.y1, output_adapter.moment_command[2]) annotation(Line(points={{15,202},{40,202},{40,194},{58,194}}, color={55,80,115}));
  connect(controller.y2, output_adapter.moment_command[3]) annotation(Line(points={{15,174},{40,174},{40,166},{58,166}}, color={55,80,115}));
  connect(controller.y3, output_adapter.moment_command[4]) annotation(Line(points={{15,146},{40,146},{40,138},{58,138}}, color={55,80,115}));
