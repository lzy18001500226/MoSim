...
model AwffL1ResidualGraphicalRunner
  "awff_l1_residual graphical Sysblock runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.IntegratedChains.AwffL1Residual.AwffL1ResidualGraphicalController controller 
