...
model QpNmpcL1IndiCbfGraphicalRunner
  "qp_nmpc_l1_indi_cbf graphical Sysblock runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.IntegratedChains.QpNmpcL1IndiCbf.QpNmpcL1IndiCbfCore core 
    annotation(Placement(transformation(origin = {-65, 185}, extent = {{-80, -65}, {80, 65}})), __MWORKS(SECInstance = true));
  MoSimQuadrotorModel.Experiment.Adapters.GraphicalMomentRotorDirect output_adapter 
...
equation
  connect(reference.position_command[1], position_error_x.u[1]) annotation(Line(points={{-300,240},{-270,240},{-270,300},{-242,300}}, color={0,0,127}));
  connect(flight_controller.position_est[1], position_error_x.u[2]) annotation(Line(points={{-45,25},{-20,25},{-20,330},{-260,330},{-260,300},{-242,300}}, color={100,70,20}));
  connect(position_error_x.y, core.x_error) annotation(Line(points={{-218,300},{-200,300},{-200,184},{-145,184}}, color={0,0,127}));
  connect(reference.position_command[2], position_error_y.u[1]) annotation(Line(points={{-300,226},{-270,226},{-270,280},{-182,280}}, color={0,0,127}));
  connect(flight_controller.position_est[2], position_error_y.u[2]) annotation(Line(points={{-45,25},{-10,25},{-10,340},{-200,340},{-200,320},{-170,320},{-170,312}}, color={100,70,20}));
  connect(position_error_y.y, core.y_error) annotation(Line(points={{-158,300},{-150,300},{-150,170},{-145,170}}, color={0,0,127}));
  connect(reference.position_command[3], position_error_z.u[1]) annotation(Line(points={{-300,212},{-280,212},{-280,260},{-122,260},{-122,288}}, color={0,0,127}));
  connect(flight_controller.position_est[3], position_error_z.u[2]) annotation(Line(points={{-45,25},{0,25},{0,350},{-140,350},{-140,320},{-110,320},{-110,312}}, color={100,70,20}));
  connect(position_error_z.y, core.z_error) annotation(Line(points={{-98,300},{-90,300},{-90,156},{-145,156}}, color={0,0,127}));
  connect(reference.velocity_command[3], core.z_ref_rate) annotation(Line(points={{-300,198},{-230,198},{-230,142},{-145,142}}, color={0,0,127}));
  connect(plant.attitude[1], core.roll_mea) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,184},{-145,184}}, color={0,100,150}));
  connect(plant.attitude[2], core.pitch_mea) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,170},{-145,170}}, color={0,100,150}));
  connect(plant.attitude[3], core.yaw_mea) annotation(Line(points={{777,191},{820,191},{820,-100},{-220,-100},{-220,156},{-145,156}}, color={0,100,150}));
  connect(reference.velocity_command[1], core.yaw_ref) annotation(Line(points={{-300,142},{-220,142},{-220,128},{-145,128}}, color={0,0,127}));
  connect(elapsed_time_source.y, core.elapsed_time) annotation(Line(points={{-454,-300},{-410,-300},{-410,-220},{-350,-220}}, color={0,0,127}));
  connect(core.y, output_adapter.moment_command[1]) annotation(Line(points={{15,230},{40,230},{40,222},{58,222}}, color={55,80,115}));
  connect(core.y1, output_adapter.moment_command[2]) annotation(Line(points={{15,202},{40,202},{40,194},{58,194}}, color={55,80,115}));
  connect(core.y2, output_adapter.moment_command[3]) annotation(Line(points={{15,174},{40,174},{40,166},{58,166}}, color={55,80,115}));
  connect(core.y3, output_adapter.moment_command[4]) annotation(Line(points={{15,146},{40,146},{40,138},{58,138}}, color={55,80,115}));
