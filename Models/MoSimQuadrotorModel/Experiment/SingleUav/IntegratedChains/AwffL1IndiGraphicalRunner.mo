...
model AwffL1IndiGraphicalRunner
  "awff_l1_indi graphical Sysblock runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.IntegratedChains.AwffL1Indi.AwffL1IndiGraphicalController controller 
