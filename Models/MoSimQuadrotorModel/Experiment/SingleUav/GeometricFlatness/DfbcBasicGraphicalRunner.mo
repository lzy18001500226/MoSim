...
model DfbcBasicGraphicalRunner
  "dfbc_basic graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.GeometricFlatness.DfbcBasic.DfbcBasicCore core 
