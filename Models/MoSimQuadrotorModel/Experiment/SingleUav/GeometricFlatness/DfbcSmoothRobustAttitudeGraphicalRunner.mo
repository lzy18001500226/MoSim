...
model DfbcSmoothRobustAttitudeGraphicalRunner
  "dfbc_smooth_robust_attitude graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.GeometricFlatness.DfbcSmoothRobustAttitude.DfbcSmoothRobustAttitudeCore core 
...
equation
  ...
  connect(zero.y, output_adapter.yaw_ref) annotation(Line(points={{-100,62},{0,62},{0,52},{100,52}}, color={0,0,127}));
