...
model DfbcHighOrderBodyrateGraphicalRunner
  "dfbc_high_order_bodyrate graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.GeometricFlatness.DfbcHighOrderBodyrate.DfbcHighOrderBodyrateCore core 
