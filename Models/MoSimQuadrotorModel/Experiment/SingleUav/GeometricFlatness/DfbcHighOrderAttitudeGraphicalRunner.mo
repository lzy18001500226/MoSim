...
model DfbcHighOrderAttitudeGraphicalRunner
  "dfbc_high_order_attitude graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.GeometricFlatness.DfbcHighOrderAttitude.DfbcHighOrderAttitudeCore core 
