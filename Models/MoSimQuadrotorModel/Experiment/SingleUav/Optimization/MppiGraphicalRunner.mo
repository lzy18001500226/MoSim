...
model MppiGraphicalRunner
  "mppi graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.Optimization.Mppi.MppiCore core 
