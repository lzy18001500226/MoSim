...
model ExplicitGainScheduledMpcGraphicalRunner
  "explicit_gain_scheduled_mpc graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.Optimization.ExplicitGainScheduledMpc.ExplicitGainScheduledMpcCore core 
...
equation
  connect(core.desired_acceleration_z, output_adapter.command) annotation(Line(points={{15,230},{40,230},{40,222},{58,222}}, color={55,80,115}));
