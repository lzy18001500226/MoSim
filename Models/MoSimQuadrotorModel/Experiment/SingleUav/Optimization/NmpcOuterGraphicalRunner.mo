within MoSimQuadrotorModel.Experiment.SingleUav.Optimization;
model NmpcOuterGraphicalRunner
  "nmpc_outer graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.Optimization.NmpcOuter.NmpcOuterCore core 
...
equation
  ...
  connect(core.command, output_adapter.command) annotation(Line(points={{15,174},{40,174},{40,166},{58,166}}, color={55,80,115}));
