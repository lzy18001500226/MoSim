...
model AdaptiveMpcGraphicalRunner
  "adaptive_mpc graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.Optimization.AdaptiveMpc.AdaptiveMpcCore core 
