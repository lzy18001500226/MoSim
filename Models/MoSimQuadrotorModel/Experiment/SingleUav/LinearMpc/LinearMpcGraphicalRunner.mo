within MoSimQuadrotorModel.Experiment.SingleUav.LinearMpc;
model LinearMpcGraphicalRunner
  "linear_mpc graphical Sysblock review runner with the common aircraft template"
  ...
  MoSimQuadrotorModel.Control.Optimization.LinearMpc.LinearMpcCore core 
