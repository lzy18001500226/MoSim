...
model Example1Rotor1Loss15L1OnlineFaultAllocationSysblockClosedLoop
  ...
  MoSimQuadrotorModel.Plant.PathPlanning.ClimbPath climbePath(gain(k = 1));
  MoSimQuadrotorModel.Plant.Mechanics.QuadChassis quadChassisTest17_1(gain2(k = 0.0007266293));
  ...
  MoSimQuadrotorModel.Controllers.Sysblocks.AWFF_L1OnlineFaultAllocationControllerEquation_Sysblock controller3_2;
