within MoSimQuadrotorModel.Control.PidFamily.GainScheduledPid;
model GainScheduledPidCore "Exact fixed-input graphical MIL for gain_scheduled_pid"
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain pid_schedule_term(k=0.4) 
