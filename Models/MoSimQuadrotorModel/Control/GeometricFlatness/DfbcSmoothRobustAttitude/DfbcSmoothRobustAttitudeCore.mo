within MoSimQuadrotorModel.Control.GeometricFlatness.DfbcSmoothRobustAttitude;
model DfbcSmoothRobustAttitudeCore "Direct graphical smooth-robust DFBC with attitude/thrust adapter"
...
equation
  ...
  connect(smooth_robust_acceleration_limit_y.y, attitude_roll_from_lateral_acceleration.u) 
    annotation(Line(points = {{620, -9}, {620, 55}, {745, 55}, {745, 119}}, color = {0, 0, 127}));
  connect(smooth_robust_acceleration_limit_x.y, attitude_pitch_from_lateral_acceleration.u) 
    annotation(Line(points = {{620, 254}, {620, 170}, {745, 170}, {745, 86}}, color = {0, 0, 127}));
  connect(attitude_roll_from_lateral_acceleration.y, attitude_roll_tilt_limit.u) 
    annotation(Line(points = {{759, 130}, {841, 130}}, color = {0, 0, 127}));
  connect(attitude_pitch_from_lateral_acceleration.y, attitude_pitch_tilt_limit.u) 
    annotation(Line(points = {{759, 75}, {841, 75}}, color = {0, 0, 127}));
  ...
  connect(attitude_roll_tilt_limit.y, enable_desired_roll_rad.u1) 
    annotation(Line(points = {{855, 119}, {855, -63.5}, {1185, -63.5}, {1185, -246}}, color = {0, 0, 127}));
  ...
  connect(attitude_pitch_tilt_limit.y, enable_desired_pitch_rad.u1) 
    annotation(Line(points = {{855, 64}, {855, -110.5}, {1185, -110.5}, {1185, -285}}, color = {0, 0, 127}));
  ...
  connect(normalized_thrust_limit.y, enable_normalized_thrust.u1) 
    annotation(Line(points = {{1075, -166}, {1075, -245}, {1185, -245}, {1185, -324}}, color = {0, 0, 127}));
...
end DfbcSmoothRobustAttitudeCore;