within MoSimQuadrotorModel.Control.GeometricFlatness.DfbcHighOrderAttitude;
model DfbcHighOrderAttitudeCore "Direct graphical high-order DFBC with attitude/thrust adapter"
...
equation
  ...
  connect(high_order_acceleration_limit_y.y, attitude_roll_from_lateral_acceleration.u) 
    annotation(Line(points = {{424, -25}, {577.5, -25}, {577.5, 130}, {731, 130}}, color = {0, 0, 127}));
  connect(high_order_acceleration_limit_x.y, attitude_pitch_from_lateral_acceleration.u) 
    annotation(Line(points = {{424, 260}, {577.5, 260}, {577.5, 75}, {731, 75}}, color = {0, 0, 127}));
