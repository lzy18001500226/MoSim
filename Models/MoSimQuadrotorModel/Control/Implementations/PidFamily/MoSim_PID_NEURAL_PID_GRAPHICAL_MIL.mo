...
model MoSim_PID_NEURAL_PID_GRAPHICAL_MIL "Exact fixed-input graphical MIL for neural_pid"
  ...
  SysplorerEmbeddedCoder.Discontinuities.Saturation pid_neural_limit(upLimit=0.25,lowLimit=-0.25)
    annotation (Placement(transformation(origin = {-330, 335}, extent = {{-14, -11}, {14, 11}})));
  SysplorerEmbeddedCoder.MathOperation.Gain pid_neural_term(k=0.2)
...
end MoSim_PID_NEURAL_PID_GRAPHICAL_MIL;
