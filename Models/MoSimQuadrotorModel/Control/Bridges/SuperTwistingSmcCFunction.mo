...
model SuperTwistingSmcCFunction
  ...
  SysplorerEmbeddedCoder.Port.Outport desired_attitude_x_out
    annotation (Placement(transformation(origin={500,268.42},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport desired_attitude_y_out
    annotation (Placement(transformation(origin={500,236.84},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport desired_attitude_z_out
    annotation (Placement(transformation(origin={500,205.26},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport normalized_thrust_out
    annotation (Placement(transformation(origin={500,173.68},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport collective_thrust_n_out
    annotation (Placement(transformation(origin={500,142.11},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport desired_acceleration_x_out
    annotation (Placement(transformation(origin={500,110.53},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport desired_acceleration_y_out
    annotation (Placement(transformation(origin={500,78.95},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport desired_acceleration_z_out
    annotation (Placement(transformation(origin={500,47.37},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
  SysplorerEmbeddedCoder.Port.Outport sliding_surface_x_out
    annotation (Placement(transformation(origin={500,15.79},extent={{-8,-8},{8,8}})),__MWORKS(BlockSystem(Type(ref="double"),Dimension=1,SampleTime(group="D1")=0.01)));
...
equation
  ...
  connect(cFunction.desired_attitude_x, desired_attitude_x_out) annotation(Line(points={{80,268.42},{492,268.42}},color={0,0,127}));
  connect(cFunction.desired_attitude_y, desired_attitude_y_out) annotation(Line(points={{80,236.84},{492,236.84}},color={0,0,127}));
  connect(cFunction.desired_attitude_z, desired_attitude_z_out) annotation(Line(points={{80,205.26},{492,205.26}},color={0,0,127}));
  connect(cFunction.normalized_thrust, normalized_thrust_out) annotation(Line(points={{80,173.68},{492,173.68}},color={0,0,127}));
  connect(cFunction.collective_thrust_n, collective_thrust_n_out) annotation(Line(points={{80,142.11},{492,142.11}},color={0,0,127}));
  connect(cFunction.desired_acceleration_x, desired_acceleration_x_out) annotation(Line(points={{80,110.53},{492,110.53}},color={0,0,127}));
  connect(cFunction.desired_acceleration_y, desired_acceleration_y_out) annotation(Line(points={{80,78.95},{492,78.95}},color={0,0,127}));
  connect(cFunction.desired_acceleration_z, desired_acceleration_z_out) annotation(Line(points={{80,47.37},{492,47.37}},color={0,0,127}));
  connect(cFunction.sliding_surface_x, sliding_surface_x_out) annotation(Line(points={{80,15.79},{492,15.79}},color={0,0,127}));
  connect(cFunction.sliding_surface_y, sliding_surface_y_out) annotation(Line(points={{80,-15.79},{492,-15.79}},color={0,0,127}));
  connect(cFunction.sliding_surface_z, sliding_surface_z_out) annotation(Line(points={{80,-47.37},{492,-47.37}},color={0,0,127}));
  connect(cFunction.auxiliary_state_x, auxiliary_state_x_out) annotation(Line(points={{80,-78.95},{492,-78.95}},color={0,0,127}));
  connect(cFunction.auxiliary_state_y, auxiliary_state_y_out) annotation(Line(points={{80,-110.53},{492,-110.53}},color={0,0,127}));
  connect(cFunction.auxiliary_state_z, auxiliary_state_z_out) annotation(Line(points={{80,-142.11},{492,-142.11}},color={0,0,127}));
  connect(cFunction.effective_reaching_gain_x, effective_reaching_gain_x_out) annotation(Line(points={{80,-173.68},{492,-173.68}},color={0,0,127}));
  connect(cFunction.effective_reaching_gain_y, effective_reaching_gain_y_out) annotation(Line(points={{80,-205.26},{492,-205.26}},color={0,0,127}));
  connect(cFunction.effective_reaching_gain_z, effective_reaching_gain_z_out) annotation(Line(points={{80,-236.84},{492,-236.84}},color={0,0,127}));
  connect(cFunction.saturated, saturated_out) annotation(Line(points={{80,-268.42},{492,-268.42}},color={0,0,127}));
  connect(cFunction.status_code, status_code_out) annotation(Line(points={{80,-300.00},{492,-300.00}},color={0,0,127}));
end SuperTwistingSmcCFunction;
