within MoSimQuadrotorModel.Control.SlidingMode.TerminalSmc;
model TerminalSmcCore "P3 native graphical sliding-mode controller core: terminal_smc"
  ...
  SysplorerEmbeddedCoder.Sources.Constant position_error_power_x_exponent(k=0.72) 
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain terminal_shape_gain_x(k=1.2)
    "P3 distinguishing state or nonlinear surface for terminal_smc" annotation (Placement(transformation(origin = {-170, 405}, extent = {{-13, -10}, {13, 10}})));
  ...
  SysplorerEmbeddedCoder.Sources.Constant position_error_power_y_exponent(k=0.72) 
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain terminal_shape_gain_y(k=1.2) 
  ...
  SysplorerEmbeddedCoder.Sources.Constant position_error_power_z_exponent(k=0.78) 
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain terminal_shape_gain_z(k=1.4) 
...
equation
  ...
  connect(velocity_error_x.y, terminal_sliding_surface_x.u1) 
    annotation(Line(points = {{-517, 210}, {-307.5, 210}, {-307.5, 360}, {-98, 360}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_y.y, terminal_sliding_surface_y.u1) 
    annotation(Line(points = {{-517, -100}, {-307.5, -100}, {-307.5, 50}, {-98, 50}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_z.y, terminal_sliding_surface_z.u1) 
    annotation(Line(points = {{-517, -410}, {-307.5, -410}, {-307.5, -260}, {-98, -260}}, color = {0, 0, 127}));
