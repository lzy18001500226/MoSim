within MoSimQuadrotorModel.Control.Optimization.RobustMpc;
model RobustMpcCore "P4 native graphical fixed-budget MPC controller core: robust_mpc"
  ...
  connect(velocity_error_x.y, robust_horizon_velocity_x.u) 
    annotation(Line(points = {{-733, 263}, {-625.5, 263}, {-625.5, 470}, {-518, 470}}, color = {0, 0, 127}));
  connect(position_error_x.y, robust_surface_x.u1) 
    annotation(Line(points = {{-733, 373}, {-566, 373}, {-566, 448}, {-399, 448}}, color = {0, 0, 127}));
  connect(robust_horizon_velocity_x.y, robust_surface_x.u2) 
    annotation(Line(points = {{-492, 470}, {-445.5, 470}, {-445.5, 448}, {-399, 448}}, color = {0, 0, 127}));
  connect(robust_surface_x.y, robust_surface_scale_x.u) 
    annotation(Line(points = {{-373, 448}, {-360.5, 448}, {-360.5, 470}, {-348, 470}}, color = {0, 0, 127}));
  connect(robust_surface_scale_x.y, robust_tanh_x.u1) 
    annotation(Line(points = {{-322, 470}, {-263, 470}}, color = {0, 0, 127}));
  connect(robust_tanh_x.y1, robust_bound_term_x.u) 
    annotation(Line(points = {{-237, 470}, {-178, 470}}, color = {0, 0, 127}));
  ...
  connect(robust_bound_term_x.y, robust_solution_x.u2) 
    annotation(Line(points = {{-165, 460}, {-165, 394}, {-46, 394}, {-46, 328}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_y.y, robust_horizon_velocity_y.u) 
    annotation(Line(points = {{-733, -167}, {-625.5, -167}, {-625.5, 40}, {-518, 40}}, color = {0, 0, 127}));
  connect(position_error_y.y, robust_surface_y.u1) 
    annotation(Line(points = {{-733, -57}, {-566, -57}, {-566, 18}, {-399, 18}}, color = {0, 0, 127}));
  connect(robust_horizon_velocity_y.y, robust_surface_y.u2) 
    annotation(Line(points = {{-492, 40}, {-445.5, 40}, {-445.5, 18}, {-399, 18}}, color = {0, 0, 127}));
  connect(robust_surface_y.y, robust_surface_scale_y.u) 
    annotation(Line(points = {{-373, 18}, {-360.5, 18}, {-360.5, 40}, {-348, 40}}, color = {0, 0, 127}));
  connect(robust_surface_scale_y.y, robust_tanh_y.u1) 
    annotation(Line(points = {{-322, 40}, {-263, 40}}, color = {0, 0, 127}));
  connect(robust_tanh_y.y1, robust_bound_term_y.u) 
    annotation(Line(points = {{-237, 40}, {-178, 40}}, color = {0, 0, 127}));
  ...
  connect(robust_bound_term_y.y, robust_solution_y.u2) 
    annotation(Line(points = {{-165, 30}, {-165, -36}, {-46, -36}, {-46, -102}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_z.y, robust_horizon_velocity_z.u) 
    annotation(Line(points = {{-733, -597}, {-625.5, -597}, {-625.5, -390}, {-518, -390}}, color = {0, 0, 127}));
  connect(position_error_z.y, robust_surface_z.u1) 
    annotation(Line(points = {{-733, -487}, {-566, -487}, {-566, -412}, {-399, -412}}, color = {0, 0, 127}));
  connect(robust_horizon_velocity_z.y, robust_surface_z.u2) 
    annotation(Line(points = {{-492, -390}, {-445.5, -390}, {-445.5, -412}, {-399, -412}}, color = {0, 0, 127}));
  connect(robust_surface_z.y, robust_surface_scale_z.u) 
    annotation(Line(points = {{-373, -412}, {-360.5, -412}, {-360.5, -390}, {-348, -390}}, color = {0, 0, 127}));
  connect(robust_surface_scale_z.y, robust_tanh_z.u1) 
    annotation(Line(points = {{-322, -390}, {-263, -390}}, color = {0, 0, 127}));
  connect(robust_tanh_z.y1, robust_bound_term_z.u) 
    annotation(Line(points = {{-237, -390}, {-178, -390}}, color = {0, 0, 127}));
  ...
  connect(robust_bound_term_z.y, robust_solution_z.u2) 
    annotation(Line(points = {{-165, -400}, {-165, -466}, {-46, -466}, {-46, -532}}, color = {0, 0, 127}));
