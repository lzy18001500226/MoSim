within MoSimQuadrotorModel.Control.Optimization.ExplicitGainScheduledMpc;
model ExplicitGainScheduledMpcCore "P4 native graphical fixed-budget MPC controller core: explicit_gain_scheduled_mpc"
  ...
  SysplorerEmbeddedCoder.MathOperation.Abs schedule_abs_error_x 
    annotation (Placement(transformation(origin = {-420, 490}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain schedule_normalized_error_x(k=1.3333333333333333) 
    annotation (Placement(transformation(origin = {-335, 490}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.Discontinuities.Saturation schedule_limit_x(lowLimit=0.0,upLimit=1.0)
    "P4 distinguishing native graphical path for explicit_gain_scheduled_mpc" annotation (Placement(transformation(origin = {-250, 490}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain scheduled_position_term_x(k=0.35) 
    annotation (Placement(transformation(origin = {-250, 445}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain scheduled_velocity_term_x(k=0.18) 
    annotation (Placement(transformation(origin = {-250, 405}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum scheduled_feedback_x(inputs="++") 
    annotation (Placement(transformation(origin = {-131, 403}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product scheduled_correction_x(inputs="**") 
    annotation (Placement(transformation(origin = {-80, 425}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum scheduled_solution_x(inputs="++") 
    annotation (Placement(transformation(origin = {39, 318}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_x_h_ev(k=0.25) 
    annotation (Placement(transformation(origin = {985, 240}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_x_half_h2_acc(k=0.03125) 
    annotation (Placement(transformation(origin = {985, 195}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_x_predicted_position_error_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1104, 208}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_x_predicted_position_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1138, 186}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_x_h_acc(k=0.25) 
    annotation (Placement(transformation(origin = {985, 140}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_x_predicted_velocity_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1104, 118}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_x_position_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, 230}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_x_velocity_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, 175}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_x_acceleration_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, 120}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_x_position_cost(k=1.0) 
    annotation (Placement(transformation(origin = {1240, 230}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_x_velocity_cost(k=0.08) 
    annotation (Placement(transformation(origin = {1240, 175}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_x_control_cost(k=0.002) 
    annotation (Placement(transformation(origin = {1240, 120}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_x_stage_cost_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1359, 153}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_x_stage_cost(inputs="++") 
  ...
  SysplorerEmbeddedCoder.MathOperation.Abs schedule_abs_error_y 
    annotation (Placement(transformation(origin = {-420, 60}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain schedule_normalized_error_y(k=1.3333333333333333) 
    annotation (Placement(transformation(origin = {-335, 60}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.Discontinuities.Saturation schedule_limit_y(lowLimit=0.0,upLimit=1.0) 
    annotation (Placement(transformation(origin = {-250, 60}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain scheduled_position_term_y(k=0.35) 
    annotation (Placement(transformation(origin = {-250, 15}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain scheduled_velocity_term_y(k=0.18) 
    annotation (Placement(transformation(origin = {-250, -25}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum scheduled_feedback_y(inputs="++") 
    annotation (Placement(transformation(origin = {-131, -27}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product scheduled_correction_y(inputs="**") 
    annotation (Placement(transformation(origin = {-80, -5}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum scheduled_solution_y(inputs="++") 
    annotation (Placement(transformation(origin = {39, -112}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_y_h_ev(k=0.25) 
    annotation (Placement(transformation(origin = {985, -190}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_y_half_h2_acc(k=0.03125) 
    annotation (Placement(transformation(origin = {985, -235}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_y_predicted_position_error_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1104, -222}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_y_predicted_position_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1138, -244}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_y_h_acc(k=0.25) 
    annotation (Placement(transformation(origin = {985, -290}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_y_predicted_velocity_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1104, -312}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_y_position_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -200}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_y_velocity_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -255}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_y_acceleration_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -310}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_y_position_cost(k=1.0) 
    annotation (Placement(transformation(origin = {1240, -200}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_y_velocity_cost(k=0.08) 
    annotation (Placement(transformation(origin = {1240, -255}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_y_control_cost(k=0.002) 
    annotation (Placement(transformation(origin = {1240, -310}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_y_stage_cost_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1359, -277}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_y_stage_cost(inputs="++") 
  ...
  SysplorerEmbeddedCoder.MathOperation.Abs schedule_abs_error_z 
    annotation (Placement(transformation(origin = {-420, -370}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain schedule_normalized_error_z(k=1.3333333333333333) 
    annotation (Placement(transformation(origin = {-335, -370}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.Discontinuities.Saturation schedule_limit_z(lowLimit=0.0,upLimit=1.0) 
    annotation (Placement(transformation(origin = {-250, -370}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain scheduled_position_term_z(k=0.45) 
    annotation (Placement(transformation(origin = {-250, -415}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain scheduled_velocity_term_z(k=0.25) 
    annotation (Placement(transformation(origin = {-250, -455}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum scheduled_feedback_z(inputs="++") 
    annotation (Placement(transformation(origin = {-131, -457}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product scheduled_correction_z(inputs="**") 
    annotation (Placement(transformation(origin = {-80, -435}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum scheduled_solution_z(inputs="++") 
    annotation (Placement(transformation(origin = {39, -542}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_z_h_ev(k=0.25) 
    annotation (Placement(transformation(origin = {985, -620}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_z_half_h2_acc(k=0.03125) 
    annotation (Placement(transformation(origin = {985, -665}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_z_predicted_position_error_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1104, -652}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_z_predicted_position_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1138, -674}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_z_h_acc(k=0.25) 
    annotation (Placement(transformation(origin = {985, -720}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_z_predicted_velocity_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1104, -742}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_z_position_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -630}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_z_velocity_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -685}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_explicit_gain_scheduled_mpc_z_acceleration_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -740}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_z_position_cost(k=1.2) 
    annotation (Placement(transformation(origin = {1240, -630}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_z_velocity_cost(k=0.1) 
    annotation (Placement(transformation(origin = {1240, -685}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_explicit_gain_scheduled_mpc_z_control_cost(k=0.003) 
    annotation (Placement(transformation(origin = {1240, -740}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_z_stage_cost_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1359, -707}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_explicit_gain_scheduled_mpc_z_stage_cost(inputs="++") 
...
equation
  ...
  connect(position_error_x.y, schedule_abs_error_x.u) 
    annotation(Line(points = {{-733, 373}, {-583, 373}, {-583, 490}, {-433, 490}}, color = {0, 0, 127}));
  connect(schedule_abs_error_x.y, schedule_normalized_error_x.u) 
    annotation(Line(points = {{-407, 490}, {-348, 490}}, color = {0, 0, 127}));
  connect(schedule_normalized_error_x.y, schedule_limit_x.u) 
    annotation(Line(points = {{-322, 490}, {-263, 490}}, color = {0, 0, 127}));
  connect(position_error_x.y, scheduled_position_term_x.u) 
    annotation(Line(points = {{-733, 373}, {-498, 373}, {-498, 445}, {-263, 445}}, color = {0, 0, 127}));
  connect(velocity_error_x.y, scheduled_velocity_term_x.u) 
    annotation(Line(points = {{-733, 263}, {-498, 263}, {-498, 405}, {-263, 405}}, color = {0, 0, 127}));
  connect(scheduled_position_term_x.y, scheduled_feedback_x.u1) 
    annotation(Line(points = {{-237, 445}, {-190.5, 445}, {-190.5, 403}, {-144, 403}}, color = {0, 0, 127}));
  connect(scheduled_velocity_term_x.y, scheduled_feedback_x.u2) 
    annotation(Line(points = {{-237, 405}, {-190.5, 405}, {-190.5, 403}, {-144, 403}}, color = {0, 0, 127}));
  connect(schedule_limit_x.y, scheduled_correction_x.u1) 
    annotation(Line(points = {{-237, 490}, {-165, 490}, {-165, 425}, {-93, 425}}, color = {0, 0, 127}));
  connect(scheduled_feedback_x.y, scheduled_correction_x.u2) 
    annotation(Line(points = {{-118, 403}, {-105.5, 403}, {-105.5, 425}, {-93, 425}}, color = {0, 0, 127}));
  connect(linear_solution_x.y, scheduled_solution_x.u1) 
    annotation(Line(points = {{-519, 296}, {-246.5, 296}, {-246.5, 318}, {26, 318}}, color = {0, 0, 127}));
  connect(scheduled_correction_x.y, scheduled_solution_x.u2) 
    annotation(Line(points = {{-67, 425}, {-20.5, 425}, {-20.5, 318}, {26, 318}}, color = {0, 0, 127}));
  connect(scheduled_solution_x.y, unconstrained_command_x.u1) 
    annotation(Line(points = {{52, 318}, {1006, 318}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_x.y, final_explicit_gain_scheduled_mpc_x_h_ev.u) 
    annotation(Line(points = {{-733, 263}, {119.5, 263}, {119.5, 240}, {972, 240}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_explicit_gain_scheduled_mpc_x_half_h2_acc.u) 
    annotation(Line(points = {{1312, 340}, {1155, 340}, {1155, 195}, {998, 195}}, color = {0, 0, 127}));
  connect(position_error_x.y, final_explicit_gain_scheduled_mpc_x_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, 373}, {179, 373}, {179, 208}, {1091, 208}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_h_ev.y, final_explicit_gain_scheduled_mpc_x_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, 240}, {1044.5, 240}, {1044.5, 208}, {1091, 208}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_predicted_position_error_stage1.y, final_explicit_gain_scheduled_mpc_x_predicted_position_error.u1) 
    annotation(Line(points = {{1117, 208}, {1121, 208}, {1121, 186}, {1125, 186}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_half_h2_acc.y, final_explicit_gain_scheduled_mpc_x_predicted_position_error.u2) 
    annotation(Line(points = {{998, 195}, {1061.5, 195}, {1061.5, 186}, {1125, 186}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_explicit_gain_scheduled_mpc_x_h_acc.u) 
    annotation(Line(points = {{1312, 340}, {1155, 340}, {1155, 140}, {998, 140}}, color = {0, 0, 127}));
  connect(velocity_error_x.y, final_explicit_gain_scheduled_mpc_x_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, 263}, {179, 263}, {179, 118}, {1091, 118}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_h_acc.y, final_explicit_gain_scheduled_mpc_x_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, 140}, {1044.5, 140}, {1044.5, 118}, {1091, 118}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_predicted_position_error.y, final_explicit_gain_scheduled_mpc_x_position_error_squared.u1) 
    annotation(Line(points = {{1138, 196}, {1138, 208}, {1155, 208}, {1155, 220}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_predicted_position_error.y, final_explicit_gain_scheduled_mpc_x_position_error_squared.u2) 
    annotation(Line(points = {{1138, 196}, {1138, 208}, {1155, 208}, {1155, 220}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_predicted_velocity_error.y, final_explicit_gain_scheduled_mpc_x_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, 128}, {1104, 146.5}, {1155, 146.5}, {1155, 165}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_predicted_velocity_error.y, final_explicit_gain_scheduled_mpc_x_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, 128}, {1104, 146.5}, {1155, 146.5}, {1155, 165}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_explicit_gain_scheduled_mpc_x_acceleration_squared.u1) 
    annotation(Line(points = {{1325, 330}, {1325, 230}, {1155, 230}, {1155, 130}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_explicit_gain_scheduled_mpc_x_acceleration_squared.u2) 
    annotation(Line(points = {{1325, 330}, {1325, 230}, {1155, 230}, {1155, 130}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_position_error_squared.y, final_explicit_gain_scheduled_mpc_x_position_cost.u) 
    annotation(Line(points = {{1168, 230}, {1227, 230}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_velocity_error_squared.y, final_explicit_gain_scheduled_mpc_x_velocity_cost.u) 
    annotation(Line(points = {{1168, 175}, {1227, 175}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_acceleration_squared.y, final_explicit_gain_scheduled_mpc_x_control_cost.u) 
    annotation(Line(points = {{1168, 120}, {1227, 120}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_position_cost.y, final_explicit_gain_scheduled_mpc_x_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, 230}, {1299.5, 230}, {1299.5, 153}, {1346, 153}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_velocity_cost.y, final_explicit_gain_scheduled_mpc_x_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, 175}, {1299.5, 175}, {1299.5, 153}, {1346, 153}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_stage_cost_stage1.y, final_explicit_gain_scheduled_mpc_x_stage_cost.u1) 
    annotation(Line(points = {{1372, 153}, {1376, 153}, {1376, 131}, {1380, 131}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_control_cost.y, final_explicit_gain_scheduled_mpc_x_stage_cost.u2) 
  ...
  connect(position_error_y.y, schedule_abs_error_y.u) 
    annotation(Line(points = {{-733, -57}, {-583, -57}, {-583, 60}, {-433, 60}}, color = {0, 0, 127}));
  connect(schedule_abs_error_y.y, schedule_normalized_error_y.u) 
    annotation(Line(points = {{-407, 60}, {-348, 60}}, color = {0, 0, 127}));
  connect(schedule_normalized_error_y.y, schedule_limit_y.u) 
    annotation(Line(points = {{-322, 60}, {-263, 60}}, color = {0, 0, 127}));
  connect(position_error_y.y, scheduled_position_term_y.u) 
    annotation(Line(points = {{-733, -57}, {-498, -57}, {-498, 15}, {-263, 15}}, color = {0, 0, 127}));
  connect(velocity_error_y.y, scheduled_velocity_term_y.u) 
    annotation(Line(points = {{-733, -167}, {-498, -167}, {-498, -25}, {-263, -25}}, color = {0, 0, 127}));
  connect(scheduled_position_term_y.y, scheduled_feedback_y.u1) 
    annotation(Line(points = {{-237, 15}, {-190.5, 15}, {-190.5, -27}, {-144, -27}}, color = {0, 0, 127}));
  connect(scheduled_velocity_term_y.y, scheduled_feedback_y.u2) 
    annotation(Line(points = {{-237, -25}, {-190.5, -25}, {-190.5, -27}, {-144, -27}}, color = {0, 0, 127}));
  connect(schedule_limit_y.y, scheduled_correction_y.u1) 
    annotation(Line(points = {{-237, 60}, {-165, 60}, {-165, -5}, {-93, -5}}, color = {0, 0, 127}));
  connect(scheduled_feedback_y.y, scheduled_correction_y.u2) 
    annotation(Line(points = {{-118, -27}, {-105.5, -27}, {-105.5, -5}, {-93, -5}}, color = {0, 0, 127}));
  connect(linear_solution_y.y, scheduled_solution_y.u1) 
    annotation(Line(points = {{-519, -134}, {-246.5, -134}, {-246.5, -112}, {26, -112}}, color = {0, 0, 127}));
  connect(scheduled_correction_y.y, scheduled_solution_y.u2) 
    annotation(Line(points = {{-67, -5}, {-20.5, -5}, {-20.5, -112}, {26, -112}}, color = {0, 0, 127}));
  connect(scheduled_solution_y.y, unconstrained_command_y.u1) 
    annotation(Line(points = {{52, -112}, {1006, -112}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_y.y, final_explicit_gain_scheduled_mpc_y_h_ev.u) 
    annotation(Line(points = {{-733, -167}, {119.5, -167}, {119.5, -190}, {972, -190}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_explicit_gain_scheduled_mpc_y_half_h2_acc.u) 
    annotation(Line(points = {{1312, -90}, {1155, -90}, {1155, -235}, {998, -235}}, color = {0, 0, 127}));
  connect(position_error_y.y, final_explicit_gain_scheduled_mpc_y_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, -57}, {179, -57}, {179, -222}, {1091, -222}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_h_ev.y, final_explicit_gain_scheduled_mpc_y_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, -190}, {1044.5, -190}, {1044.5, -222}, {1091, -222}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_predicted_position_error_stage1.y, final_explicit_gain_scheduled_mpc_y_predicted_position_error.u1) 
    annotation(Line(points = {{1117, -222}, {1121, -222}, {1121, -244}, {1125, -244}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_half_h2_acc.y, final_explicit_gain_scheduled_mpc_y_predicted_position_error.u2) 
    annotation(Line(points = {{998, -235}, {1061.5, -235}, {1061.5, -244}, {1125, -244}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_explicit_gain_scheduled_mpc_y_h_acc.u) 
    annotation(Line(points = {{1312, -90}, {1155, -90}, {1155, -290}, {998, -290}}, color = {0, 0, 127}));
  connect(velocity_error_y.y, final_explicit_gain_scheduled_mpc_y_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, -167}, {179, -167}, {179, -312}, {1091, -312}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_h_acc.y, final_explicit_gain_scheduled_mpc_y_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, -290}, {1044.5, -290}, {1044.5, -312}, {1091, -312}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_predicted_position_error.y, final_explicit_gain_scheduled_mpc_y_position_error_squared.u1) 
    annotation(Line(points = {{1138, -234}, {1138, -222}, {1155, -222}, {1155, -210}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_predicted_position_error.y, final_explicit_gain_scheduled_mpc_y_position_error_squared.u2) 
    annotation(Line(points = {{1138, -234}, {1138, -222}, {1155, -222}, {1155, -210}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_predicted_velocity_error.y, final_explicit_gain_scheduled_mpc_y_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, -302}, {1104, -283.5}, {1155, -283.5}, {1155, -265}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_predicted_velocity_error.y, final_explicit_gain_scheduled_mpc_y_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, -302}, {1104, -283.5}, {1155, -283.5}, {1155, -265}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_explicit_gain_scheduled_mpc_y_acceleration_squared.u1) 
    annotation(Line(points = {{1325, -100}, {1325, -200}, {1155, -200}, {1155, -300}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_explicit_gain_scheduled_mpc_y_acceleration_squared.u2) 
    annotation(Line(points = {{1325, -100}, {1325, -200}, {1155, -200}, {1155, -300}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_position_error_squared.y, final_explicit_gain_scheduled_mpc_y_position_cost.u) 
    annotation(Line(points = {{1168, -200}, {1227, -200}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_velocity_error_squared.y, final_explicit_gain_scheduled_mpc_y_velocity_cost.u) 
    annotation(Line(points = {{1168, -255}, {1227, -255}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_acceleration_squared.y, final_explicit_gain_scheduled_mpc_y_control_cost.u) 
    annotation(Line(points = {{1168, -310}, {1227, -310}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_position_cost.y, final_explicit_gain_scheduled_mpc_y_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, -200}, {1299.5, -200}, {1299.5, -277}, {1346, -277}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_velocity_cost.y, final_explicit_gain_scheduled_mpc_y_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, -255}, {1299.5, -255}, {1299.5, -277}, {1346, -277}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_stage_cost_stage1.y, final_explicit_gain_scheduled_mpc_y_stage_cost.u1) 
    annotation(Line(points = {{1372, -277}, {1376, -277}, {1376, -299}, {1380, -299}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_control_cost.y, final_explicit_gain_scheduled_mpc_y_stage_cost.u2) 
  ...
  connect(position_error_z.y, schedule_abs_error_z.u) 
    annotation(Line(points = {{-733, -487}, {-583, -487}, {-583, -370}, {-433, -370}}, color = {0, 0, 127}));
  connect(schedule_abs_error_z.y, schedule_normalized_error_z.u) 
    annotation(Line(points = {{-407, -370}, {-348, -370}}, color = {0, 0, 127}));
  connect(schedule_normalized_error_z.y, schedule_limit_z.u) 
    annotation(Line(points = {{-322, -370}, {-263, -370}}, color = {0, 0, 127}));
  connect(position_error_z.y, scheduled_position_term_z.u) 
    annotation(Line(points = {{-733, -487}, {-498, -487}, {-498, -415}, {-263, -415}}, color = {0, 0, 127}));
  connect(velocity_error_z.y, scheduled_velocity_term_z.u) 
    annotation(Line(points = {{-733, -597}, {-498, -597}, {-498, -455}, {-263, -455}}, color = {0, 0, 127}));
  connect(scheduled_position_term_z.y, scheduled_feedback_z.u1) 
    annotation(Line(points = {{-237, -415}, {-190.5, -415}, {-190.5, -457}, {-144, -457}}, color = {0, 0, 127}));
  connect(scheduled_velocity_term_z.y, scheduled_feedback_z.u2) 
    annotation(Line(points = {{-237, -455}, {-190.5, -455}, {-190.5, -457}, {-144, -457}}, color = {0, 0, 127}));
  connect(schedule_limit_z.y, scheduled_correction_z.u1) 
    annotation(Line(points = {{-237, -370}, {-165, -370}, {-165, -435}, {-93, -435}}, color = {0, 0, 127}));
  connect(scheduled_feedback_z.y, scheduled_correction_z.u2) 
    annotation(Line(points = {{-118, -457}, {-105.5, -457}, {-105.5, -435}, {-93, -435}}, color = {0, 0, 127}));
  connect(linear_solution_z.y, scheduled_solution_z.u1) 
    annotation(Line(points = {{-519, -564}, {-246.5, -564}, {-246.5, -542}, {26, -542}}, color = {0, 0, 127}));
  connect(scheduled_correction_z.y, scheduled_solution_z.u2) 
    annotation(Line(points = {{-67, -435}, {-20.5, -435}, {-20.5, -542}, {26, -542}}, color = {0, 0, 127}));
  connect(scheduled_solution_z.y, unconstrained_command_z.u1) 
    annotation(Line(points = {{52, -542}, {1006, -542}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_z.y, final_explicit_gain_scheduled_mpc_z_h_ev.u) 
    annotation(Line(points = {{-733, -597}, {119.5, -597}, {119.5, -620}, {972, -620}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_explicit_gain_scheduled_mpc_z_half_h2_acc.u) 
    annotation(Line(points = {{1312, -520}, {1155, -520}, {1155, -665}, {998, -665}}, color = {0, 0, 127}));
  connect(position_error_z.y, final_explicit_gain_scheduled_mpc_z_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, -487}, {179, -487}, {179, -652}, {1091, -652}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_h_ev.y, final_explicit_gain_scheduled_mpc_z_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, -620}, {1044.5, -620}, {1044.5, -652}, {1091, -652}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_predicted_position_error_stage1.y, final_explicit_gain_scheduled_mpc_z_predicted_position_error.u1) 
    annotation(Line(points = {{1117, -652}, {1121, -652}, {1121, -674}, {1125, -674}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_half_h2_acc.y, final_explicit_gain_scheduled_mpc_z_predicted_position_error.u2) 
    annotation(Line(points = {{998, -665}, {1061.5, -665}, {1061.5, -674}, {1125, -674}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_explicit_gain_scheduled_mpc_z_h_acc.u) 
    annotation(Line(points = {{1312, -520}, {1155, -520}, {1155, -720}, {998, -720}}, color = {0, 0, 127}));
  connect(velocity_error_z.y, final_explicit_gain_scheduled_mpc_z_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, -597}, {179, -597}, {179, -742}, {1091, -742}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_h_acc.y, final_explicit_gain_scheduled_mpc_z_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, -720}, {1044.5, -720}, {1044.5, -742}, {1091, -742}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_predicted_position_error.y, final_explicit_gain_scheduled_mpc_z_position_error_squared.u1) 
    annotation(Line(points = {{1138, -664}, {1138, -652}, {1155, -652}, {1155, -640}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_predicted_position_error.y, final_explicit_gain_scheduled_mpc_z_position_error_squared.u2) 
    annotation(Line(points = {{1138, -664}, {1138, -652}, {1155, -652}, {1155, -640}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_predicted_velocity_error.y, final_explicit_gain_scheduled_mpc_z_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, -732}, {1104, -713.5}, {1155, -713.5}, {1155, -695}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_predicted_velocity_error.y, final_explicit_gain_scheduled_mpc_z_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, -732}, {1104, -713.5}, {1155, -713.5}, {1155, -695}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_explicit_gain_scheduled_mpc_z_acceleration_squared.u1) 
    annotation(Line(points = {{1325, -530}, {1325, -630}, {1155, -630}, {1155, -730}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_explicit_gain_scheduled_mpc_z_acceleration_squared.u2) 
    annotation(Line(points = {{1325, -530}, {1325, -630}, {1155, -630}, {1155, -730}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_position_error_squared.y, final_explicit_gain_scheduled_mpc_z_position_cost.u) 
    annotation(Line(points = {{1168, -630}, {1227, -630}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_velocity_error_squared.y, final_explicit_gain_scheduled_mpc_z_velocity_cost.u) 
    annotation(Line(points = {{1168, -685}, {1227, -685}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_acceleration_squared.y, final_explicit_gain_scheduled_mpc_z_control_cost.u) 
    annotation(Line(points = {{1168, -740}, {1227, -740}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_position_cost.y, final_explicit_gain_scheduled_mpc_z_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, -630}, {1299.5, -630}, {1299.5, -707}, {1346, -707}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_velocity_cost.y, final_explicit_gain_scheduled_mpc_z_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, -685}, {1299.5, -685}, {1299.5, -707}, {1346, -707}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_stage_cost_stage1.y, final_explicit_gain_scheduled_mpc_z_stage_cost.u1) 
    annotation(Line(points = {{1372, -707}, {1376, -707}, {1376, -729}, {1380, -729}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_z_control_cost.y, final_explicit_gain_scheduled_mpc_z_stage_cost.u2) 
    annotation(Line(points = {{1253, -740}, {1316.5, -740}, {1316.5, -729}, {1380, -729}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_x_stage_cost.y, solver_cost_sum_stage1.u1) 
    annotation(Line(points = {{1393, 121}, {1393, -410.5}, {1544, -410.5}, {1544, -942}}, color = {0, 0, 127}));
  connect(final_explicit_gain_scheduled_mpc_y_stage_cost.y, solver_cost_sum_stage1.u2) 
  ...
  connect(final_explicit_gain_scheduled_mpc_z_stage_cost.y, solver_cost_sum.u2) 
  ...
  connect(schedule_limit_x.y, auxiliary_x) 
    annotation(Line(points = {{-237, 490}, {680, 490}, {680, -270}, {1597, -270}}, color = {0, 0, 127}));
  connect(schedule_limit_y.y, auxiliary_y) 
    annotation(Line(points = {{-237, 60}, {680, 60}, {680, -375}, {1597, -375}}, color = {0, 0, 127}));
  connect(schedule_limit_z.y, auxiliary_z) 
    annotation(Line(points = {{-237, -370}, {680, -370}, {680, -480}, {1597, -480}}, color = {0, 0, 127}));
...
end ExplicitGainScheduledMpcCore;