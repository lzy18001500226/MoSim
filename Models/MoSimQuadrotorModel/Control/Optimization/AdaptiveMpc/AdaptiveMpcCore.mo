within MoSimQuadrotorModel.Control.Optimization.AdaptiveMpc;
model AdaptiveMpcCore "P4 native graphical fixed-budget MPC controller core: adaptive_mpc"
  ...
  SysplorerEmbeddedCoder.Discrete.UnitDelay adaptive_scale_state(initCond=1.0)
    "P4 distinguishing native graphical path for adaptive_mpc" annotation (Placement(transformation(origin = {-505, 575}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_position_error_x(inputs="+-") 
    annotation (Placement(transformation(origin = {-746, 598}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_velocity_error_x(inputs="+-") 
    annotation (Placement(transformation(origin = {-656, 598}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product adaptive_error_product_x(inputs="**") 
    annotation (Placement(transformation(origin = {-600, 620}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_position_error_y(inputs="+-") 
    annotation (Placement(transformation(origin = {-746, 553}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_velocity_error_y(inputs="+-") 
    annotation (Placement(transformation(origin = {-656, 553}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product adaptive_error_product_y(inputs="**") 
    annotation (Placement(transformation(origin = {-600, 575}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_position_error_z(inputs="+-") 
    annotation (Placement(transformation(origin = {-746, 508}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_velocity_error_z(inputs="+-") 
    annotation (Placement(transformation(origin = {-656, 508}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product adaptive_error_product_z(inputs="**") 
    annotation (Placement(transformation(origin = {-600, 530}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_signal_sum_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {-471, 508}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_signal_sum(inputs="++") 
    annotation (Placement(transformation(origin = {-437, 486}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain adaptive_scale_increment(k=0.0002666666666666667) 
    annotation (Placement(transformation(origin = {-420, 530}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum adaptive_scale_next_raw(inputs="++") 
    annotation (Placement(transformation(origin = {-301, 508}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.Discontinuities.Saturation adaptive_scale_limit(lowLimit=0.75,upLimit=1.25) 
    annotation (Placement(transformation(origin = {-250, 530}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Product adaptive_solution_x(inputs="**") 
    annotation (Placement(transformation(origin = {-80, 340}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_x_h_ev(k=0.25) 
    annotation (Placement(transformation(origin = {985, 240}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_x_half_h2_acc(k=0.03125) 
    annotation (Placement(transformation(origin = {985, 195}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_x_predicted_position_error_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1104, 208}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_x_predicted_position_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1138, 186}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_x_h_acc(k=0.25) 
    annotation (Placement(transformation(origin = {985, 140}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_x_predicted_velocity_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1104, 118}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_x_position_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, 230}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_x_velocity_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, 175}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_x_acceleration_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, 120}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_x_position_cost(k=1.0) 
    annotation (Placement(transformation(origin = {1240, 230}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_x_velocity_cost(k=0.08) 
    annotation (Placement(transformation(origin = {1240, 175}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_x_control_cost(k=0.002) 
    annotation (Placement(transformation(origin = {1240, 120}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_x_stage_cost_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1359, 153}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_x_stage_cost(inputs="++") 
  ...
  SysplorerEmbeddedCoder.MathOperation.Product adaptive_solution_y(inputs="**") 
    annotation (Placement(transformation(origin = {-80, -90}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_y_h_ev(k=0.25) 
    annotation (Placement(transformation(origin = {985, -190}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_y_half_h2_acc(k=0.03125) 
    annotation (Placement(transformation(origin = {985, -235}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_y_predicted_position_error_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1104, -222}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_y_predicted_position_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1138, -244}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_y_h_acc(k=0.25) 
    annotation (Placement(transformation(origin = {985, -290}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_y_predicted_velocity_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1104, -312}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_y_position_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -200}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_y_velocity_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -255}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_y_acceleration_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -310}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_y_position_cost(k=1.0) 
    annotation (Placement(transformation(origin = {1240, -200}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_y_velocity_cost(k=0.08) 
    annotation (Placement(transformation(origin = {1240, -255}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_y_control_cost(k=0.002) 
    annotation (Placement(transformation(origin = {1240, -310}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_y_stage_cost_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1359, -277}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_y_stage_cost(inputs="++") 
  ...
  SysplorerEmbeddedCoder.MathOperation.Product adaptive_solution_z(inputs="**") 
    annotation (Placement(transformation(origin = {-80, -520}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_z_h_ev(k=0.25) 
    annotation (Placement(transformation(origin = {985, -620}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_z_half_h2_acc(k=0.03125) 
    annotation (Placement(transformation(origin = {985, -665}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_z_predicted_position_error_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1104, -652}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_z_predicted_position_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1138, -674}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_z_h_acc(k=0.25) 
    annotation (Placement(transformation(origin = {985, -720}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_z_predicted_velocity_error(inputs="+-") 
    annotation (Placement(transformation(origin = {1104, -742}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_z_position_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -630}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_z_velocity_error_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -685}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Product final_adaptive_mpc_z_acceleration_squared(inputs="**") 
    annotation (Placement(transformation(origin = {1155, -740}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_z_position_cost(k=1.2) 
    annotation (Placement(transformation(origin = {1240, -630}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_z_velocity_cost(k=0.1) 
    annotation (Placement(transformation(origin = {1240, -685}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain final_adaptive_mpc_z_control_cost(k=0.003) 
    annotation (Placement(transformation(origin = {1240, -740}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_z_stage_cost_stage1(inputs="++") 
    annotation (Placement(transformation(origin = {1359, -707}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum final_adaptive_mpc_z_stage_cost(inputs="++") 
...
equation
  ...
  connect(reference_position_x.y, adaptive_position_error_x.u1) 
    annotation(Line(points = {{-937, 410}, {-848, 410}, {-848, 598}, {-759, 598}}, color = {0, 0, 127}));
  connect(position_x.y, adaptive_position_error_x.u2) 
    annotation(Line(points = {{-937, 520}, {-848, 520}, {-848, 598}, {-759, 598}}, color = {0, 0, 127}));
  connect(reference_velocity_x.y, adaptive_velocity_error_x.u1) 
    annotation(Line(points = {{-937, 355}, {-803, 355}, {-803, 598}, {-669, 598}}, color = {0, 0, 127}));
  connect(velocity_x.y, adaptive_velocity_error_x.u2) 
    annotation(Line(points = {{-937, 465}, {-803, 465}, {-803, 598}, {-669, 598}}, color = {0, 0, 127}));
  connect(adaptive_position_error_x.y, adaptive_error_product_x.u1) 
    annotation(Line(points = {{-733, 598}, {-673, 598}, {-673, 620}, {-613, 620}}, color = {0, 0, 127}));
  connect(adaptive_velocity_error_x.y, adaptive_error_product_x.u2) 
    annotation(Line(points = {{-643, 598}, {-628, 598}, {-628, 620}, {-613, 620}}, color = {0, 0, 127}));
  connect(reference_position_y.y, adaptive_position_error_y.u1) 
    annotation(Line(points = {{-882, 410}, {-820.5, 410}, {-820.5, 553}, {-759, 553}}, color = {0, 0, 127}));
  connect(position_y.y, adaptive_position_error_y.u2) 
    annotation(Line(points = {{-882, 520}, {-820.5, 520}, {-820.5, 553}, {-759, 553}}, color = {0, 0, 127}));
  connect(reference_velocity_y.y, adaptive_velocity_error_y.u1) 
    annotation(Line(points = {{-882, 355}, {-775.5, 355}, {-775.5, 553}, {-669, 553}}, color = {0, 0, 127}));
  connect(velocity_y.y, adaptive_velocity_error_y.u2) 
    annotation(Line(points = {{-882, 465}, {-775.5, 465}, {-775.5, 553}, {-669, 553}}, color = {0, 0, 127}));
  connect(adaptive_position_error_y.y, adaptive_error_product_y.u1) 
    annotation(Line(points = {{-733, 553}, {-673, 553}, {-673, 575}, {-613, 575}}, color = {0, 0, 127}));
  connect(adaptive_velocity_error_y.y, adaptive_error_product_y.u2) 
    annotation(Line(points = {{-643, 553}, {-628, 553}, {-628, 575}, {-613, 575}}, color = {0, 0, 127}));
  connect(reference_position_z.y, adaptive_position_error_z.u1) 
    annotation(Line(points = {{-840, 420}, {-840, 459}, {-746, 459}, {-746, 498}}, color = {0, 0, 127}));
  connect(position_z.y, adaptive_position_error_z.u2) 
    annotation(Line(points = {{-827, 520}, {-793, 520}, {-793, 508}, {-759, 508}}, color = {0, 0, 127}));
  connect(reference_velocity_z.y, adaptive_velocity_error_z.u1) 
    annotation(Line(points = {{-827, 355}, {-748, 355}, {-748, 508}, {-669, 508}}, color = {0, 0, 127}));
  connect(velocity_z.y, adaptive_velocity_error_z.u2) 
    annotation(Line(points = {{-827, 465}, {-748, 465}, {-748, 508}, {-669, 508}}, color = {0, 0, 127}));
  connect(adaptive_position_error_z.y, adaptive_error_product_z.u1) 
    annotation(Line(points = {{-733, 508}, {-673, 508}, {-673, 530}, {-613, 530}}, color = {0, 0, 127}));
  connect(adaptive_velocity_error_z.y, adaptive_error_product_z.u2) 
    annotation(Line(points = {{-643, 508}, {-628, 508}, {-628, 530}, {-613, 530}}, color = {0, 0, 127}));
  connect(adaptive_error_product_x.y, adaptive_signal_sum_stage1.u1) 
    annotation(Line(points = {{-587, 620}, {-535.5, 620}, {-535.5, 508}, {-484, 508}}, color = {0, 0, 127}));
  connect(adaptive_error_product_y.y, adaptive_signal_sum_stage1.u2) 
    annotation(Line(points = {{-587, 575}, {-535.5, 575}, {-535.5, 508}, {-484, 508}}, color = {0, 0, 127}));
  connect(adaptive_signal_sum_stage1.y, adaptive_signal_sum.u1) 
    annotation(Line(points = {{-458, 508}, {-454, 508}, {-454, 486}, {-450, 486}}, color = {0, 0, 127}));
  connect(adaptive_error_product_z.y, adaptive_signal_sum.u2) 
    annotation(Line(points = {{-587, 530}, {-518.5, 530}, {-518.5, 486}, {-450, 486}}, color = {0, 0, 127}));
  connect(adaptive_signal_sum.y, adaptive_scale_increment.u) 
    annotation(Line(points = {{-437, 496}, {-437, 508}, {-420, 508}, {-420, 520}}, color = {0, 0, 127}));
  connect(adaptive_scale_state.y, adaptive_scale_next_raw.u1) 
    annotation(Line(points = {{-492, 575}, {-403, 575}, {-403, 508}, {-314, 508}}, color = {0, 0, 127}));
  connect(adaptive_scale_increment.y, adaptive_scale_next_raw.u2) 
    annotation(Line(points = {{-407, 530}, {-360.5, 530}, {-360.5, 508}, {-314, 508}}, color = {0, 0, 127}));
  connect(adaptive_scale_next_raw.y, adaptive_scale_limit.u) 
    annotation(Line(points = {{-288, 508}, {-275.5, 508}, {-275.5, 530}, {-263, 530}}, color = {0, 0, 127}));
  connect(adaptive_scale_limit.y, adaptive_scale_state.u1) 
    annotation(Line(points = {{-263, 530}, {-377.5, 530}, {-377.5, 575}, {-492, 575}}, color = {0, 0, 127}));
  connect(linear_solution_x.y, adaptive_solution_x.u1) 
    annotation(Line(points = {{-519, 296}, {-306, 296}, {-306, 340}, {-93, 340}}, color = {0, 0, 127}));
  connect(adaptive_scale_limit.y, adaptive_solution_x.u2) 
    annotation(Line(points = {{-250, 520}, {-250, 435}, {-80, 435}, {-80, 350}}, color = {0, 0, 127}));
  connect(adaptive_solution_x.y, unconstrained_command_x.u1) 
    annotation(Line(points = {{-67, 340}, {469.5, 340}, {469.5, 318}, {1006, 318}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_x.y, final_adaptive_mpc_x_h_ev.u) 
    annotation(Line(points = {{-733, 263}, {119.5, 263}, {119.5, 240}, {972, 240}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_adaptive_mpc_x_half_h2_acc.u) 
    annotation(Line(points = {{1312, 340}, {1155, 340}, {1155, 195}, {998, 195}}, color = {0, 0, 127}));
  connect(position_error_x.y, final_adaptive_mpc_x_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, 373}, {179, 373}, {179, 208}, {1091, 208}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_h_ev.y, final_adaptive_mpc_x_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, 240}, {1044.5, 240}, {1044.5, 208}, {1091, 208}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_predicted_position_error_stage1.y, final_adaptive_mpc_x_predicted_position_error.u1) 
    annotation(Line(points = {{1117, 208}, {1121, 208}, {1121, 186}, {1125, 186}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_half_h2_acc.y, final_adaptive_mpc_x_predicted_position_error.u2) 
    annotation(Line(points = {{998, 195}, {1061.5, 195}, {1061.5, 186}, {1125, 186}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_adaptive_mpc_x_h_acc.u) 
    annotation(Line(points = {{1312, 340}, {1155, 340}, {1155, 140}, {998, 140}}, color = {0, 0, 127}));
  connect(velocity_error_x.y, final_adaptive_mpc_x_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, 263}, {179, 263}, {179, 118}, {1091, 118}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_h_acc.y, final_adaptive_mpc_x_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, 140}, {1044.5, 140}, {1044.5, 118}, {1091, 118}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_predicted_position_error.y, final_adaptive_mpc_x_position_error_squared.u1) 
    annotation(Line(points = {{1138, 196}, {1138, 208}, {1155, 208}, {1155, 220}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_predicted_position_error.y, final_adaptive_mpc_x_position_error_squared.u2) 
    annotation(Line(points = {{1138, 196}, {1138, 208}, {1155, 208}, {1155, 220}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_predicted_velocity_error.y, final_adaptive_mpc_x_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, 128}, {1104, 146.5}, {1155, 146.5}, {1155, 165}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_predicted_velocity_error.y, final_adaptive_mpc_x_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, 128}, {1104, 146.5}, {1155, 146.5}, {1155, 165}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_adaptive_mpc_x_acceleration_squared.u1) 
    annotation(Line(points = {{1325, 330}, {1325, 230}, {1155, 230}, {1155, 130}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_adaptive_mpc_x_acceleration_squared.u2) 
    annotation(Line(points = {{1325, 330}, {1325, 230}, {1155, 230}, {1155, 130}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_position_error_squared.y, final_adaptive_mpc_x_position_cost.u) 
    annotation(Line(points = {{1168, 230}, {1227, 230}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_velocity_error_squared.y, final_adaptive_mpc_x_velocity_cost.u) 
    annotation(Line(points = {{1168, 175}, {1227, 175}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_acceleration_squared.y, final_adaptive_mpc_x_control_cost.u) 
    annotation(Line(points = {{1168, 120}, {1227, 120}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_position_cost.y, final_adaptive_mpc_x_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, 230}, {1299.5, 230}, {1299.5, 153}, {1346, 153}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_velocity_cost.y, final_adaptive_mpc_x_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, 175}, {1299.5, 175}, {1299.5, 153}, {1346, 153}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_stage_cost_stage1.y, final_adaptive_mpc_x_stage_cost.u1) 
    annotation(Line(points = {{1372, 153}, {1376, 153}, {1376, 131}, {1380, 131}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_control_cost.y, final_adaptive_mpc_x_stage_cost.u2) 
  ...
  connect(linear_solution_y.y, adaptive_solution_y.u1) 
    annotation(Line(points = {{-519, -134}, {-306, -134}, {-306, -90}, {-93, -90}}, color = {0, 0, 127}));
  connect(adaptive_scale_limit.y, adaptive_solution_y.u2) 
    annotation(Line(points = {{-250, 520}, {-250, 220}, {-80, 220}, {-80, -80}}, color = {0, 0, 127}));
  connect(adaptive_solution_y.y, unconstrained_command_y.u1) 
    annotation(Line(points = {{-67, -90}, {469.5, -90}, {469.5, -112}, {1006, -112}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_y.y, final_adaptive_mpc_y_h_ev.u) 
    annotation(Line(points = {{-733, -167}, {119.5, -167}, {119.5, -190}, {972, -190}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_adaptive_mpc_y_half_h2_acc.u) 
    annotation(Line(points = {{1312, -90}, {1155, -90}, {1155, -235}, {998, -235}}, color = {0, 0, 127}));
  connect(position_error_y.y, final_adaptive_mpc_y_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, -57}, {179, -57}, {179, -222}, {1091, -222}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_h_ev.y, final_adaptive_mpc_y_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, -190}, {1044.5, -190}, {1044.5, -222}, {1091, -222}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_predicted_position_error_stage1.y, final_adaptive_mpc_y_predicted_position_error.u1) 
    annotation(Line(points = {{1117, -222}, {1121, -222}, {1121, -244}, {1125, -244}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_half_h2_acc.y, final_adaptive_mpc_y_predicted_position_error.u2) 
    annotation(Line(points = {{998, -235}, {1061.5, -235}, {1061.5, -244}, {1125, -244}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_adaptive_mpc_y_h_acc.u) 
    annotation(Line(points = {{1312, -90}, {1155, -90}, {1155, -290}, {998, -290}}, color = {0, 0, 127}));
  connect(velocity_error_y.y, final_adaptive_mpc_y_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, -167}, {179, -167}, {179, -312}, {1091, -312}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_h_acc.y, final_adaptive_mpc_y_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, -290}, {1044.5, -290}, {1044.5, -312}, {1091, -312}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_predicted_position_error.y, final_adaptive_mpc_y_position_error_squared.u1) 
    annotation(Line(points = {{1138, -234}, {1138, -222}, {1155, -222}, {1155, -210}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_predicted_position_error.y, final_adaptive_mpc_y_position_error_squared.u2) 
    annotation(Line(points = {{1138, -234}, {1138, -222}, {1155, -222}, {1155, -210}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_predicted_velocity_error.y, final_adaptive_mpc_y_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, -302}, {1104, -283.5}, {1155, -283.5}, {1155, -265}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_predicted_velocity_error.y, final_adaptive_mpc_y_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, -302}, {1104, -283.5}, {1155, -283.5}, {1155, -265}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_adaptive_mpc_y_acceleration_squared.u1) 
    annotation(Line(points = {{1325, -100}, {1325, -200}, {1155, -200}, {1155, -300}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_adaptive_mpc_y_acceleration_squared.u2) 
    annotation(Line(points = {{1325, -100}, {1325, -200}, {1155, -200}, {1155, -300}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_position_error_squared.y, final_adaptive_mpc_y_position_cost.u) 
    annotation(Line(points = {{1168, -200}, {1227, -200}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_velocity_error_squared.y, final_adaptive_mpc_y_velocity_cost.u) 
    annotation(Line(points = {{1168, -255}, {1227, -255}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_acceleration_squared.y, final_adaptive_mpc_y_control_cost.u) 
    annotation(Line(points = {{1168, -310}, {1227, -310}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_position_cost.y, final_adaptive_mpc_y_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, -200}, {1299.5, -200}, {1299.5, -277}, {1346, -277}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_velocity_cost.y, final_adaptive_mpc_y_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, -255}, {1299.5, -255}, {1299.5, -277}, {1346, -277}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_stage_cost_stage1.y, final_adaptive_mpc_y_stage_cost.u1) 
    annotation(Line(points = {{1372, -277}, {1376, -277}, {1376, -299}, {1380, -299}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_control_cost.y, final_adaptive_mpc_y_stage_cost.u2) 
  ...
  connect(linear_solution_z.y, adaptive_solution_z.u1) 
    annotation(Line(points = {{-519, -564}, {-306, -564}, {-306, -520}, {-93, -520}}, color = {0, 0, 127}));
  connect(adaptive_scale_limit.y, adaptive_solution_z.u2) 
    annotation(Line(points = {{-250, 520}, {-250, 5}, {-80, 5}, {-80, -510}}, color = {0, 0, 127}));
  connect(adaptive_solution_z.y, unconstrained_command_z.u1) 
    annotation(Line(points = {{-67, -520}, {469.5, -520}, {469.5, -542}, {1006, -542}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_z.y, final_adaptive_mpc_z_h_ev.u) 
    annotation(Line(points = {{-733, -597}, {119.5, -597}, {119.5, -620}, {972, -620}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_adaptive_mpc_z_half_h2_acc.u) 
    annotation(Line(points = {{1312, -520}, {1155, -520}, {1155, -665}, {998, -665}}, color = {0, 0, 127}));
  connect(position_error_z.y, final_adaptive_mpc_z_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, -487}, {179, -487}, {179, -652}, {1091, -652}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_h_ev.y, final_adaptive_mpc_z_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, -620}, {1044.5, -620}, {1044.5, -652}, {1091, -652}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_predicted_position_error_stage1.y, final_adaptive_mpc_z_predicted_position_error.u1) 
    annotation(Line(points = {{1117, -652}, {1121, -652}, {1121, -674}, {1125, -674}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_half_h2_acc.y, final_adaptive_mpc_z_predicted_position_error.u2) 
    annotation(Line(points = {{998, -665}, {1061.5, -665}, {1061.5, -674}, {1125, -674}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_adaptive_mpc_z_h_acc.u) 
    annotation(Line(points = {{1312, -520}, {1155, -520}, {1155, -720}, {998, -720}}, color = {0, 0, 127}));
  connect(velocity_error_z.y, final_adaptive_mpc_z_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, -597}, {179, -597}, {179, -742}, {1091, -742}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_h_acc.y, final_adaptive_mpc_z_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, -720}, {1044.5, -720}, {1044.5, -742}, {1091, -742}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_predicted_position_error.y, final_adaptive_mpc_z_position_error_squared.u1) 
    annotation(Line(points = {{1138, -664}, {1138, -652}, {1155, -652}, {1155, -640}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_predicted_position_error.y, final_adaptive_mpc_z_position_error_squared.u2) 
    annotation(Line(points = {{1138, -664}, {1138, -652}, {1155, -652}, {1155, -640}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_predicted_velocity_error.y, final_adaptive_mpc_z_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, -732}, {1104, -713.5}, {1155, -713.5}, {1155, -695}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_predicted_velocity_error.y, final_adaptive_mpc_z_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, -732}, {1104, -713.5}, {1155, -713.5}, {1155, -695}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_adaptive_mpc_z_acceleration_squared.u1) 
    annotation(Line(points = {{1325, -530}, {1325, -630}, {1155, -630}, {1155, -730}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_adaptive_mpc_z_acceleration_squared.u2) 
    annotation(Line(points = {{1325, -530}, {1325, -630}, {1155, -630}, {1155, -730}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_position_error_squared.y, final_adaptive_mpc_z_position_cost.u) 
    annotation(Line(points = {{1168, -630}, {1227, -630}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_velocity_error_squared.y, final_adaptive_mpc_z_velocity_cost.u) 
    annotation(Line(points = {{1168, -685}, {1227, -685}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_acceleration_squared.y, final_adaptive_mpc_z_control_cost.u) 
    annotation(Line(points = {{1168, -740}, {1227, -740}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_position_cost.y, final_adaptive_mpc_z_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, -630}, {1299.5, -630}, {1299.5, -707}, {1346, -707}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_velocity_cost.y, final_adaptive_mpc_z_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, -685}, {1299.5, -685}, {1299.5, -707}, {1346, -707}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_stage_cost_stage1.y, final_adaptive_mpc_z_stage_cost.u1) 
    annotation(Line(points = {{1372, -707}, {1376, -707}, {1376, -729}, {1380, -729}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_z_control_cost.y, final_adaptive_mpc_z_stage_cost.u2) 
    annotation(Line(points = {{1253, -740}, {1316.5, -740}, {1316.5, -729}, {1380, -729}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_x_stage_cost.y, solver_cost_sum_stage1.u1) 
    annotation(Line(points = {{1393, 121}, {1393, -410.5}, {1544, -410.5}, {1544, -942}}, color = {0, 0, 127}));
  connect(final_adaptive_mpc_y_stage_cost.y, solver_cost_sum_stage1.u2) 
  ...
  connect(final_adaptive_mpc_z_stage_cost.y, solver_cost_sum.u2) 
  ...
  connect(adaptive_scale_limit.y, auxiliary_x) 
    annotation(Line(points = {{-237, 530}, {680, 530}, {680, -270}, {1597, -270}}, color = {0, 0, 127}));
  connect(adaptive_scale_limit.y, auxiliary_y) 
    annotation(Line(points = {{-237, 530}, {680, 530}, {680, -375}, {1597, -375}}, color = {0, 0, 127}));
  connect(adaptive_scale_limit.y, auxiliary_z) 
    annotation(Line(points = {{-237, 530}, {680, 530}, {680, -480}, {1597, -480}}, color = {0, 0, 127}));
