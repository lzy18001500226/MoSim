within MoSimQuadrotorModel.Control.Optimization.TubeMpc;
model TubeMpcCore "P4 native graphical fixed-budget MPC controller core: tube_mpc"
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain tube_position_term_x(k=0.35) 
    annotation (Placement(transformation(origin = {-335, 480}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain tube_velocity_term_x(k=0.18) 
    annotation (Placement(transformation(origin = {-335, 435}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum tube_feedback_x(inputs="++") 
    annotation (Placement(transformation(origin = {-216, 433}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum tube_solution_x(inputs="++") 
    annotation (Placement(transformation(origin = {-46, 318}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.Sources.Constant tube_tightened_limit_x(k=3.75)
    "P4 distinguishing native graphical path for tube_mpc" annotation (Placement(transformation(origin = {-80, 510}, extent = {{-13, -10}, {13, 10}})));
  ...
  SysplorerEmbeddedCoder.Discontinuities.Saturation absolute_acceleration_limit_x(lowLimit=-3.75,upLimit=3.75) 
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain tube_position_term_y(k=0.35) 
    annotation (Placement(transformation(origin = {-335, 50}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain tube_velocity_term_y(k=0.18) 
    annotation (Placement(transformation(origin = {-335, 5}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum tube_feedback_y(inputs="++") 
    annotation (Placement(transformation(origin = {-216, 3}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum tube_solution_y(inputs="++") 
    annotation (Placement(transformation(origin = {-46, -112}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.Sources.Constant tube_tightened_limit_y(k=3.75) 
  ...
  SysplorerEmbeddedCoder.Discontinuities.Saturation absolute_acceleration_limit_y(lowLimit=-3.75,upLimit=3.75) 
  ...
  SysplorerEmbeddedCoder.MathOperation.Gain tube_position_term_z(k=0.45) 
    annotation (Placement(transformation(origin = {-335, -380}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Gain tube_velocity_term_z(k=0.25) 
    annotation (Placement(transformation(origin = {-335, -425}, extent = {{-13, -10}, {13, 10}})));
  SysplorerEmbeddedCoder.MathOperation.Sum tube_feedback_z(inputs="++") 
    annotation (Placement(transformation(origin = {-216, -427}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.MathOperation.Sum tube_solution_z(inputs="++") 
    annotation (Placement(transformation(origin = {-46, -542}, extent = {{-13, -10}, {13, 10}})),__MWORKS(BlockSystem(Instance(u(u1,u2)))));
  SysplorerEmbeddedCoder.Sources.Constant tube_tightened_limit_z(k=2.3) 
  ...
  SysplorerEmbeddedCoder.Discontinuities.Saturation absolute_acceleration_limit_z(lowLimit=-2.3,upLimit=2.3) 
...
equation
  ...
  connect(position_error_x.y, tube_position_term_x.u) 
    annotation(Line(points = {{-733, 373}, {-540.5, 373}, {-540.5, 480}, {-348, 480}}, color = {0, 0, 127}));
  connect(velocity_error_x.y, tube_velocity_term_x.u) 
    annotation(Line(points = {{-733, 263}, {-540.5, 263}, {-540.5, 435}, {-348, 435}}, color = {0, 0, 127}));
  connect(tube_position_term_x.y, tube_feedback_x.u1) 
    annotation(Line(points = {{-322, 480}, {-275.5, 480}, {-275.5, 433}, {-229, 433}}, color = {0, 0, 127}));
  connect(tube_velocity_term_x.y, tube_feedback_x.u2) 
    annotation(Line(points = {{-322, 435}, {-275.5, 435}, {-275.5, 433}, {-229, 433}}, color = {0, 0, 127}));
  connect(linear_solution_x.y, tube_solution_x.u1) 
    annotation(Line(points = {{-519, 296}, {-289, 296}, {-289, 318}, {-59, 318}}, color = {0, 0, 127}));
  connect(tube_feedback_x.y, tube_solution_x.u2) 
    annotation(Line(points = {{-203, 433}, {-131, 433}, {-131, 318}, {-59, 318}}, color = {0, 0, 127}));
  connect(tube_solution_x.y, unconstrained_command_x.u1) 
    annotation(Line(points = {{-33, 318}, {1006, 318}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_x.y, final_tube_mpc_x_h_ev.u) 
    annotation(Line(points = {{-733, 263}, {119.5, 263}, {119.5, 240}, {972, 240}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_tube_mpc_x_half_h2_acc.u) 
    annotation(Line(points = {{1312, 340}, {1155, 340}, {1155, 195}, {998, 195}}, color = {0, 0, 127}));
  connect(position_error_x.y, final_tube_mpc_x_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, 373}, {179, 373}, {179, 208}, {1091, 208}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_h_ev.y, final_tube_mpc_x_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, 240}, {1044.5, 240}, {1044.5, 208}, {1091, 208}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_predicted_position_error_stage1.y, final_tube_mpc_x_predicted_position_error.u1) 
    annotation(Line(points = {{1117, 208}, {1121, 208}, {1121, 186}, {1125, 186}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_half_h2_acc.y, final_tube_mpc_x_predicted_position_error.u2) 
    annotation(Line(points = {{998, 195}, {1061.5, 195}, {1061.5, 186}, {1125, 186}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_tube_mpc_x_h_acc.u) 
    annotation(Line(points = {{1312, 340}, {1155, 340}, {1155, 140}, {998, 140}}, color = {0, 0, 127}));
  connect(velocity_error_x.y, final_tube_mpc_x_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, 263}, {179, 263}, {179, 118}, {1091, 118}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_h_acc.y, final_tube_mpc_x_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, 140}, {1044.5, 140}, {1044.5, 118}, {1091, 118}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_predicted_position_error.y, final_tube_mpc_x_position_error_squared.u1) 
    annotation(Line(points = {{1138, 196}, {1138, 208}, {1155, 208}, {1155, 220}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_predicted_position_error.y, final_tube_mpc_x_position_error_squared.u2) 
    annotation(Line(points = {{1138, 196}, {1138, 208}, {1155, 208}, {1155, 220}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_predicted_velocity_error.y, final_tube_mpc_x_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, 128}, {1104, 146.5}, {1155, 146.5}, {1155, 165}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_predicted_velocity_error.y, final_tube_mpc_x_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, 128}, {1104, 146.5}, {1155, 146.5}, {1155, 165}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_tube_mpc_x_acceleration_squared.u1) 
    annotation(Line(points = {{1325, 330}, {1325, 230}, {1155, 230}, {1155, 130}}, color = {0, 0, 127}));
  connect(increment_upper_clip_x.y, final_tube_mpc_x_acceleration_squared.u2) 
    annotation(Line(points = {{1325, 330}, {1325, 230}, {1155, 230}, {1155, 130}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_position_error_squared.y, final_tube_mpc_x_position_cost.u) 
    annotation(Line(points = {{1168, 230}, {1227, 230}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_velocity_error_squared.y, final_tube_mpc_x_velocity_cost.u) 
    annotation(Line(points = {{1168, 175}, {1227, 175}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_acceleration_squared.y, final_tube_mpc_x_control_cost.u) 
    annotation(Line(points = {{1168, 120}, {1227, 120}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_position_cost.y, final_tube_mpc_x_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, 230}, {1299.5, 230}, {1299.5, 153}, {1346, 153}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_velocity_cost.y, final_tube_mpc_x_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, 175}, {1299.5, 175}, {1299.5, 153}, {1346, 153}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_stage_cost_stage1.y, final_tube_mpc_x_stage_cost.u1) 
    annotation(Line(points = {{1372, 153}, {1376, 153}, {1376, 131}, {1380, 131}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_control_cost.y, final_tube_mpc_x_stage_cost.u2) 
  ...
  connect(position_error_y.y, tube_position_term_y.u) 
    annotation(Line(points = {{-733, -57}, {-540.5, -57}, {-540.5, 50}, {-348, 50}}, color = {0, 0, 127}));
  connect(velocity_error_y.y, tube_velocity_term_y.u) 
    annotation(Line(points = {{-733, -167}, {-540.5, -167}, {-540.5, 5}, {-348, 5}}, color = {0, 0, 127}));
  connect(tube_position_term_y.y, tube_feedback_y.u1) 
    annotation(Line(points = {{-322, 50}, {-275.5, 50}, {-275.5, 3}, {-229, 3}}, color = {0, 0, 127}));
  connect(tube_velocity_term_y.y, tube_feedback_y.u2) 
    annotation(Line(points = {{-322, 5}, {-275.5, 5}, {-275.5, 3}, {-229, 3}}, color = {0, 0, 127}));
  connect(linear_solution_y.y, tube_solution_y.u1) 
    annotation(Line(points = {{-519, -134}, {-289, -134}, {-289, -112}, {-59, -112}}, color = {0, 0, 127}));
  connect(tube_feedback_y.y, tube_solution_y.u2) 
    annotation(Line(points = {{-203, 3}, {-131, 3}, {-131, -112}, {-59, -112}}, color = {0, 0, 127}));
  connect(tube_solution_y.y, unconstrained_command_y.u1) 
    annotation(Line(points = {{-33, -112}, {1006, -112}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_y.y, final_tube_mpc_y_h_ev.u) 
    annotation(Line(points = {{-733, -167}, {119.5, -167}, {119.5, -190}, {972, -190}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_tube_mpc_y_half_h2_acc.u) 
    annotation(Line(points = {{1312, -90}, {1155, -90}, {1155, -235}, {998, -235}}, color = {0, 0, 127}));
  connect(position_error_y.y, final_tube_mpc_y_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, -57}, {179, -57}, {179, -222}, {1091, -222}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_h_ev.y, final_tube_mpc_y_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, -190}, {1044.5, -190}, {1044.5, -222}, {1091, -222}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_predicted_position_error_stage1.y, final_tube_mpc_y_predicted_position_error.u1) 
    annotation(Line(points = {{1117, -222}, {1121, -222}, {1121, -244}, {1125, -244}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_half_h2_acc.y, final_tube_mpc_y_predicted_position_error.u2) 
    annotation(Line(points = {{998, -235}, {1061.5, -235}, {1061.5, -244}, {1125, -244}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_tube_mpc_y_h_acc.u) 
    annotation(Line(points = {{1312, -90}, {1155, -90}, {1155, -290}, {998, -290}}, color = {0, 0, 127}));
  connect(velocity_error_y.y, final_tube_mpc_y_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, -167}, {179, -167}, {179, -312}, {1091, -312}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_h_acc.y, final_tube_mpc_y_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, -290}, {1044.5, -290}, {1044.5, -312}, {1091, -312}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_predicted_position_error.y, final_tube_mpc_y_position_error_squared.u1) 
    annotation(Line(points = {{1138, -234}, {1138, -222}, {1155, -222}, {1155, -210}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_predicted_position_error.y, final_tube_mpc_y_position_error_squared.u2) 
    annotation(Line(points = {{1138, -234}, {1138, -222}, {1155, -222}, {1155, -210}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_predicted_velocity_error.y, final_tube_mpc_y_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, -302}, {1104, -283.5}, {1155, -283.5}, {1155, -265}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_predicted_velocity_error.y, final_tube_mpc_y_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, -302}, {1104, -283.5}, {1155, -283.5}, {1155, -265}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_tube_mpc_y_acceleration_squared.u1) 
    annotation(Line(points = {{1325, -100}, {1325, -200}, {1155, -200}, {1155, -300}}, color = {0, 0, 127}));
  connect(increment_upper_clip_y.y, final_tube_mpc_y_acceleration_squared.u2) 
    annotation(Line(points = {{1325, -100}, {1325, -200}, {1155, -200}, {1155, -300}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_position_error_squared.y, final_tube_mpc_y_position_cost.u) 
    annotation(Line(points = {{1168, -200}, {1227, -200}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_velocity_error_squared.y, final_tube_mpc_y_velocity_cost.u) 
    annotation(Line(points = {{1168, -255}, {1227, -255}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_acceleration_squared.y, final_tube_mpc_y_control_cost.u) 
    annotation(Line(points = {{1168, -310}, {1227, -310}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_position_cost.y, final_tube_mpc_y_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, -200}, {1299.5, -200}, {1299.5, -277}, {1346, -277}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_velocity_cost.y, final_tube_mpc_y_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, -255}, {1299.5, -255}, {1299.5, -277}, {1346, -277}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_stage_cost_stage1.y, final_tube_mpc_y_stage_cost.u1) 
    annotation(Line(points = {{1372, -277}, {1376, -277}, {1376, -299}, {1380, -299}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_control_cost.y, final_tube_mpc_y_stage_cost.u2) 
  ...
  connect(position_error_z.y, tube_position_term_z.u) 
    annotation(Line(points = {{-733, -487}, {-540.5, -487}, {-540.5, -380}, {-348, -380}}, color = {0, 0, 127}));
  connect(velocity_error_z.y, tube_velocity_term_z.u) 
    annotation(Line(points = {{-733, -597}, {-540.5, -597}, {-540.5, -425}, {-348, -425}}, color = {0, 0, 127}));
  connect(tube_position_term_z.y, tube_feedback_z.u1) 
    annotation(Line(points = {{-322, -380}, {-275.5, -380}, {-275.5, -427}, {-229, -427}}, color = {0, 0, 127}));
  connect(tube_velocity_term_z.y, tube_feedback_z.u2) 
    annotation(Line(points = {{-322, -425}, {-275.5, -425}, {-275.5, -427}, {-229, -427}}, color = {0, 0, 127}));
  connect(linear_solution_z.y, tube_solution_z.u1) 
    annotation(Line(points = {{-519, -564}, {-289, -564}, {-289, -542}, {-59, -542}}, color = {0, 0, 127}));
  connect(tube_feedback_z.y, tube_solution_z.u2) 
    annotation(Line(points = {{-203, -427}, {-131, -427}, {-131, -542}, {-59, -542}}, color = {0, 0, 127}));
  connect(tube_solution_z.y, unconstrained_command_z.u1) 
    annotation(Line(points = {{-33, -542}, {1006, -542}}, color = {0, 0, 127}));
  ...
  connect(velocity_error_z.y, final_tube_mpc_z_h_ev.u) 
    annotation(Line(points = {{-733, -597}, {119.5, -597}, {119.5, -620}, {972, -620}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_tube_mpc_z_half_h2_acc.u) 
    annotation(Line(points = {{1312, -520}, {1155, -520}, {1155, -665}, {998, -665}}, color = {0, 0, 127}));
  connect(position_error_z.y, final_tube_mpc_z_predicted_position_error_stage1.u1) 
    annotation(Line(points = {{-733, -487}, {179, -487}, {179, -652}, {1091, -652}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_h_ev.y, final_tube_mpc_z_predicted_position_error_stage1.u2) 
    annotation(Line(points = {{998, -620}, {1044.5, -620}, {1044.5, -652}, {1091, -652}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_predicted_position_error_stage1.y, final_tube_mpc_z_predicted_position_error.u1) 
    annotation(Line(points = {{1117, -652}, {1121, -652}, {1121, -674}, {1125, -674}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_half_h2_acc.y, final_tube_mpc_z_predicted_position_error.u2) 
    annotation(Line(points = {{998, -665}, {1061.5, -665}, {1061.5, -674}, {1125, -674}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_tube_mpc_z_h_acc.u) 
    annotation(Line(points = {{1312, -520}, {1155, -520}, {1155, -720}, {998, -720}}, color = {0, 0, 127}));
  connect(velocity_error_z.y, final_tube_mpc_z_predicted_velocity_error.u1) 
    annotation(Line(points = {{-733, -597}, {179, -597}, {179, -742}, {1091, -742}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_h_acc.y, final_tube_mpc_z_predicted_velocity_error.u2) 
    annotation(Line(points = {{998, -720}, {1044.5, -720}, {1044.5, -742}, {1091, -742}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_predicted_position_error.y, final_tube_mpc_z_position_error_squared.u1) 
    annotation(Line(points = {{1138, -664}, {1138, -652}, {1155, -652}, {1155, -640}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_predicted_position_error.y, final_tube_mpc_z_position_error_squared.u2) 
    annotation(Line(points = {{1138, -664}, {1138, -652}, {1155, -652}, {1155, -640}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_predicted_velocity_error.y, final_tube_mpc_z_velocity_error_squared.u1) 
    annotation(Line(points = {{1104, -732}, {1104, -713.5}, {1155, -713.5}, {1155, -695}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_predicted_velocity_error.y, final_tube_mpc_z_velocity_error_squared.u2) 
    annotation(Line(points = {{1104, -732}, {1104, -713.5}, {1155, -713.5}, {1155, -695}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_tube_mpc_z_acceleration_squared.u1) 
    annotation(Line(points = {{1325, -530}, {1325, -630}, {1155, -630}, {1155, -730}}, color = {0, 0, 127}));
  connect(increment_upper_clip_z.y, final_tube_mpc_z_acceleration_squared.u2) 
    annotation(Line(points = {{1325, -530}, {1325, -630}, {1155, -630}, {1155, -730}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_position_error_squared.y, final_tube_mpc_z_position_cost.u) 
    annotation(Line(points = {{1168, -630}, {1227, -630}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_velocity_error_squared.y, final_tube_mpc_z_velocity_cost.u) 
    annotation(Line(points = {{1168, -685}, {1227, -685}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_acceleration_squared.y, final_tube_mpc_z_control_cost.u) 
    annotation(Line(points = {{1168, -740}, {1227, -740}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_position_cost.y, final_tube_mpc_z_stage_cost_stage1.u1) 
    annotation(Line(points = {{1253, -630}, {1299.5, -630}, {1299.5, -707}, {1346, -707}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_velocity_cost.y, final_tube_mpc_z_stage_cost_stage1.u2) 
    annotation(Line(points = {{1253, -685}, {1299.5, -685}, {1299.5, -707}, {1346, -707}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_stage_cost_stage1.y, final_tube_mpc_z_stage_cost.u1) 
    annotation(Line(points = {{1372, -707}, {1376, -707}, {1376, -729}, {1380, -729}}, color = {0, 0, 127}));
  connect(final_tube_mpc_z_control_cost.y, final_tube_mpc_z_stage_cost.u2) 
    annotation(Line(points = {{1253, -740}, {1316.5, -740}, {1316.5, -729}, {1380, -729}}, color = {0, 0, 127}));
  connect(final_tube_mpc_x_stage_cost.y, solver_cost_sum_stage1.u1) 
    annotation(Line(points = {{1393, 121}, {1393, -410.5}, {1544, -410.5}, {1544, -942}}, color = {0, 0, 127}));
  connect(final_tube_mpc_y_stage_cost.y, solver_cost_sum_stage1.u2) 
  ...
  connect(final_tube_mpc_z_stage_cost.y, solver_cost_sum.u2) 
  ...
  connect(tube_tightened_limit_x.y, auxiliary_x) 
    annotation(Line(points = {{-67, 510}, {765, 510}, {765, -270}, {1597, -270}}, color = {0, 0, 127}));
  connect(tube_tightened_limit_y.y, auxiliary_y) 
    annotation(Line(points = {{-67, 80}, {765, 80}, {765, -375}, {1597, -375}}, color = {0, 0, 127}));
  connect(tube_tightened_limit_z.y, auxiliary_z) 
    annotation(Line(points = {{-67, -350}, {765, -350}, {765, -480}, {1597, -480}}, color = {0, 0, 127}));
