...
model IntegralSmcAttitudeThrustAdapter
  "Graphical integral SMC outer-loop law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.IntegralSmcEquationBridge core(sample_time_s = sample_time_s);
equation
...
end IntegralSmcAttitudeThrustAdapter;