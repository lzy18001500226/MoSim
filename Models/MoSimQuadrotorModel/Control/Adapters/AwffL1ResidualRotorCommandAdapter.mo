...
model AwffL1ResidualRotorCommandAdapter
  "Adapter for AWFF+L1 residual Sysblock controller outputting ROTOR_COMMAND boundary"
  extends MoSimQuadrotorModel.Control.Adapters.Base.RotorCommandAdapterBase;

  MoSimQuadrotorModel.Control.Implementations.Graphical.AWFF.AwffL1ResidualControllerCoreSysblock controller_core;
...
end AwffL1ResidualRotorCommandAdapter;