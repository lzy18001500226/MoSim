...
model FeedbackLinearizationAttitudeThrustAdapter
  "Feedback-linearization graphical law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.FeedbackLinearizationEquationBridge core;
equation
...
end FeedbackLinearizationAttitudeThrustAdapter;
