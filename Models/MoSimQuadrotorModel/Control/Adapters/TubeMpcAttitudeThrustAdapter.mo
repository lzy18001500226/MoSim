...
model TubeMpcAttitudeThrustAdapter
  "Tube MPC graphical core adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.TubeMpcEquationBridge core(
...
end TubeMpcAttitudeThrustAdapter;
