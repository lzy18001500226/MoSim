...
model TerminalSmcAttitudeThrustAdapter
  "Graphical terminal SMC outer-loop law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.TerminalSmcEquationBridge core;
equation
...
end TerminalSmcAttitudeThrustAdapter;
