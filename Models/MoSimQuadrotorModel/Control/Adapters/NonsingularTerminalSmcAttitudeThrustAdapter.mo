...
model NonsingularTerminalSmcAttitudeThrustAdapter
  "Graphical nonsingular terminal SMC outer-loop law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.NonsingularTerminalSmcEquationBridge core;
equation
...
end NonsingularTerminalSmcAttitudeThrustAdapter;