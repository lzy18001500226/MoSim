...
model DfbcBasicAttitudeThrustAdapter
  "Basic DFBC graphical core adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.DfbcBasicEquationBridge core(
...
end DfbcBasicAttitudeThrustAdapter;
