...
model PassivityBasedControlAttitudeThrustAdapter
  "Passivity-based graphical law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.PassivityBasedControlEquationBridge core;
equation
...
end PassivityBasedControlAttitudeThrustAdapter;