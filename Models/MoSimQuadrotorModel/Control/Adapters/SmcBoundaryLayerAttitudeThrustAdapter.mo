...
model SmcBoundaryLayerAttitudeThrustAdapter
  "External-input graphical SMC boundary-layer law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.SmcBoundaryLayerEquationBridge core;
equation
...
end SmcBoundaryLayerAttitudeThrustAdapter;
