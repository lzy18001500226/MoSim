...
model AdaptiveSmcAttitudeThrustAdapter
  "Graphical adaptive SMC outer-loop law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.AdaptiveSmcEquationBridge core(sample_time_s = sample_time_s);
equation
...
end AdaptiveSmcAttitudeThrustAdapter;
