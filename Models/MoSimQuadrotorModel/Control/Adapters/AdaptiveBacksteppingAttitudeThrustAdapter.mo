...
model AdaptiveBacksteppingAttitudeThrustAdapter
  "Adaptive-backstepping graphical law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.AdaptiveBacksteppingEquationBridge core(
...
end AdaptiveBacksteppingAttitudeThrustAdapter;