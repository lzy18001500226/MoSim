...
model MppiAttitudeThrustAdapter
  "Seven-sample MPPI graphical core adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.MppiEquationBridge core(
