...
model BacksteppingBaselineAttitudeThrustAdapter
  "Backstepping graphical outer-loop law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.BacksteppingBaselineEquationBridge core;
equation
...
end BacksteppingBaselineAttitudeThrustAdapter;