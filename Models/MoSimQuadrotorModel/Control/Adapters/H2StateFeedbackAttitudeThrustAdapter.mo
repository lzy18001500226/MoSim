...
model H2StateFeedbackAttitudeThrustAdapter
  "H2 state-feedback CFunction law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.H2StateFeedbackEquationBridge core;
...
end H2StateFeedbackAttitudeThrustAdapter;