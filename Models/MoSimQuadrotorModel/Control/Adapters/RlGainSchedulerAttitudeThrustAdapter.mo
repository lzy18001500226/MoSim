...
model RlGainSchedulerAttitudeThrustAdapter
  "Frozen bounded RL gain scheduler adapted to the shared ATTITUDE_THRUST boundary"
  ...
  MoSimQuadrotorModel.Control.Bridges.RlGainSchedulerEquationBridge core;
...
equation
  ...
  // Keep the existing frozen-learning core convention for this independent route.
...
end RlGainSchedulerAttitudeThrustAdapter;
