...
model NdiAttitudeThrustAdapter
  "Nonlinear dynamic inversion CFunction law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.NdiEquationBridge core;
