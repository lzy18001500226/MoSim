...
model LqgAttitudeThrustAdapter
  "LQG graphical observer/controller law adapted to ATTITUDE_THRUST"
  ...
  parameter Real normalized_to_physical_collective_thrust_n =
    mass_kg * gravity_mps2 / profile.mworks_controller_hover_percentage;
  parameter Real max_collective_thrust_delta_n = 30.0 * collective_thrust_slope;

  MoSimQuadrotorModel.Control.Bridges.LqgEquationBridge core(
