...
model QpNmpcL1IndiCbfRotorCommandAdapter
  "Adapter for QP NMPC+L1+INDI+CBF Sysblock controller outputting ROTOR_COMMAND boundary"
  extends MoSimQuadrotorModel.Control.Adapters.Base.RotorCommandAdapterBase;
  MoSimQuadrotorModel.Control.Implementations.Graphical.QPNMPC.QpNmpcL1IndiCbfControllerCoreSysblock controller_core;
...
end QpNmpcL1IndiCbfRotorCommandAdapter;