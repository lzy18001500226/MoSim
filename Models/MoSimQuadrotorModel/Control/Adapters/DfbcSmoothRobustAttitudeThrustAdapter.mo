...
model DfbcSmoothRobustAttitudeThrustAdapter
  "Smooth-robust DFBC graphical core adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.DfbcSmoothRobustAttitudeEquationBridge core(
...
end DfbcSmoothRobustAttitudeThrustAdapter;
