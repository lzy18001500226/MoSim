...
model ExplicitGainScheduledMpcAttitudeThrustAdapter
  "Explicit gain-scheduled MPC graphical core adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.ExplicitGainScheduledMpcEquationBridge core(
...
end ExplicitGainScheduledMpcAttitudeThrustAdapter;
