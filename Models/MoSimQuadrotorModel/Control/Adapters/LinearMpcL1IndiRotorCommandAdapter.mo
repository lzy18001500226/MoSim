...
model LinearMpcL1IndiRotorCommandAdapter
  "Adapter for Linear MPC+L1+INDI Sysblock controller outputting ROTOR_COMMAND boundary"
  extends MoSimQuadrotorModel.Control.Adapters.Base.RotorCommandAdapterBase;
  MoSimQuadrotorModel.Control.Implementations.Graphical.LinearMPC.LinearMpcL1IndiControllerCoreSysblock controller_core;
...
end LinearMpcL1IndiRotorCommandAdapter;