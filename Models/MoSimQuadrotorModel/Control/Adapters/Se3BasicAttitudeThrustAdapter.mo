...
model Se3BasicAttitudeThrustAdapter
  "SE(3) graphical core adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.Se3BasicEquationBridge core;
...
equation
  ...
  core.enable = 1;
  // The graphical SE(3) roll convention is ENU/FLU; the shared allocator is reciprocal.
...
end Se3BasicAttitudeThrustAdapter;