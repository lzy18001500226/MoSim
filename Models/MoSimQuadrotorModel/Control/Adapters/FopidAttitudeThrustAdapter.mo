...
model FopidAttitudeThrustAdapter
  "Fixed-memory FOPID CFunction law adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.FopidEquationBridge core;
...
end FopidAttitudeThrustAdapter;
