...
model Px4CtrlAttitudeThrustAdapter
  "px4ctrl equation bridge adapted to the shared ATTITUDE_THRUST boundary"
...
equation
  ...
  core.qy = q_y;
  core.qz = q_z;
  // The formal MWORKS plant exposes one common attitude source for odometry
  // and IMU, so both px4ctrl quaternion inputs intentionally share it.
  core.imu_qw = q_w;
  core.imu_qx = q_x;
  core.imu_qy = q_y;
  core.imu_qz = q_z;
...
end Px4CtrlAttitudeThrustAdapter;
