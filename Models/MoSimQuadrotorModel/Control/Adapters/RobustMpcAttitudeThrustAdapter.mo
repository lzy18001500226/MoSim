...
model RobustMpcAttitudeThrustAdapter
  "Robust MPC graphical core adapted to ATTITUDE_THRUST"
  ...
  MoSimQuadrotorModel.Control.Bridges.RobustMpcEquationBridge core(
...
equation
  ...
  core.enable = 1;
  // P4 emits ENU/FLU roll; the shared MWORKS allocator uses opposite roll sense.
...
end RobustMpcAttitudeThrustAdapter;