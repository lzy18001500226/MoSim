...
model AwffL1IndiGraphicalController "AWFF L1 INDI controller - standalone graphical Sysblock"
  ...
  AwffL1IndiOuterLoopGraphical position_loop annotation(Placement(transformation(origin={-145,85},extent={{-45,-45},{45,45}})));
  AwffL1IndiAttitudeGraphical attitude_loop annotation(Placement(transformation(origin={5,-35},extent={{-45,-45},{45,45}})));
  AwffL1IndiMotorMixerGraphical motor_mixer annotation(Placement(transformation(origin={155,-35},extent={{-45,-45},{45,45}})));
...
end AwffL1IndiGraphicalController;