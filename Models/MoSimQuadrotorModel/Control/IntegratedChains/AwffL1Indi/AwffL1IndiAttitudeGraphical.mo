...
model AwffL1IndiAttitudeGraphical
...
equation
  ...
  connect(roll_error_sum.y,roll_kp_gain.u) annotation(Line(points={{-123,110},{-100,110},{-100,130},{-82,130}},color={0,0,0}));
  connect(roll_error_sum.y,roll_kd_over_rate_gain.u) annotation(Line(points={{-123,110},{-100,110},{-100,90},{-82,90}},color={0,0,0}));
  ...
  connect(roll_raw_sum.y,roll_feedback_gain.u) annotation(Line(points={{7,110},{24,110},{24,125},{38,125}},color={0,0,0}));
  connect(roll_raw_sum.y,roll_indi_gain_block.u) annotation(Line(points={{7,110},{24,110},{24,95},{38,95}},color={0,0,0}));
  ...
  connect(pitch_error_sum.y,pitch_kp_gain.u) annotation(Line(points={{-123,20},{-100,20},{-100,40},{-82,40}},color={0,0,0}));
  connect(pitch_error_sum.y,pitch_kd_over_rate_gain.u) annotation(Line(points={{-123,20},{-100,20},{-100,0},{-82,0}},color={0,0,0}));
  ...
  connect(pitch_raw_sum.y,pitch_feedback_gain.u) annotation(Line(points={{7,20},{24,20},{24,35},{38,35}},color={0,0,0}));
  connect(pitch_raw_sum.y,pitch_indi_gain_block.u) annotation(Line(points={{7,20},{24,20},{24,5},{38,5}},color={0,0,0}));
  ...
  connect(yaw_kp_gain.y,yaw_feedback_gain.u) annotation(Line(points={{-58,-100},{-30,-100},{-30,-85},{-7,-85}},color={0,0,0}));
  connect(yaw_kp_gain.y,yaw_indi_gain_block.u) annotation(Line(points={{-58,-100},{-30,-100},{-30,-115},{-7,-115}},color={0,0,0}));
...
end AwffL1IndiAttitudeGraphical;