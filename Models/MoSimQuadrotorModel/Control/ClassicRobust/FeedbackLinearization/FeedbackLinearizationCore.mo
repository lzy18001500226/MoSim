within MoSimQuadrotorModel.Control.ClassicRobust.FeedbackLinearization;
model FeedbackLinearizationCore "P2 fixed-input graphical controller core for feedback_linearization"
...
points={{-594.2,330},{-464,330},{-464,259.5},{-405.8,259.5}},
color={0,0,127}));
  ...
  connect(velocity_x.y, velocity_error_x.u2) 
    annotation(Line(origin={0,0},
points={{-594.2,268},{-470,268},{-470,189.5},{-405.8,189.5}},
color={0,0,127}));
  ...
  connect(velocity_y.y, velocity_error_y.u2) 
    annotation(Line(origin={0,0},
points={{-539.2,268},{-468,268},{-468,116.5},{-409.6,116.5},{-409.6,-40.5},{-405.8,-40.5}},
color={0,0,127}));
