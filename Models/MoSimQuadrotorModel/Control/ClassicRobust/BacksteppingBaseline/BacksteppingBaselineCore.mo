within MoSimQuadrotorModel.Control.ClassicRobust.BacksteppingBaseline;
model BacksteppingBaselineCore "Backstepping outer-loop direct graphical core"
...
equation
  ...
  connect(position_error_x.y, backstep_k1_ep_x.u) 
    annotation(Line(points = {{-496, 297}, {-455, 297}, {-455, 310}, {-414, 310}}, color = {0, 0, 127}));
  connect(velocity_error_x.y, virtual_velocity_error_x.u1) 
    annotation(Line(points = {{-496, 213}, {-417.5, 213}, {-417.5, 280}, {-339, 280}}, color = {0, 0, 127}));
  connect(backstep_k1_ep_x.y, virtual_velocity_error_x.u2) 
    annotation(Line(points = {{-386, 310}, {-362.5, 310}, {-362.5, 280}, {-339, 280}}, color = {0, 0, 127}));
  connect(velocity_error_x.y, backstep_k1_ev_x.u) 
    annotation(Line(points = {{-496, 213}, {-455, 213}, {-455, 200}, {-414, 200}}, color = {0, 0, 127}));
  connect(virtual_velocity_error_x.y, backstep_k2_virtual_x.u) 
    annotation(Line(points = {{-311, 280}, {-259, 280}}, color = {0, 0, 127}));
  connect(backstep_k1_ev_x.y, backstep_feedback_x.u1) 
    annotation(Line(points = {{-386, 200}, {-282.5, 200}, {-282.5, 255}, {-179, 255}}, color = {0, 0, 127}));
  connect(backstep_k2_virtual_x.y, backstep_feedback_x.u2) 
    annotation(Line(points = {{-231, 280}, {-205, 280}, {-205, 255}, {-179, 255}}, color = {0, 0, 127}));
  ...
  connect(backstep_feedback_x.y, desired_acceleration_pre_gravity_x.u2) 
    annotation(Line(points = {{-151, 255}, {21, 255}}, color = {0, 0, 127}));
  ...
  connect(position_error_y.y, backstep_k1_ep_y.u) 
    annotation(Line(points = {{-496, 87}, {-455, 87}, {-455, 100}, {-414, 100}}, color = {0, 0, 127}));
  connect(velocity_error_y.y, virtual_velocity_error_y.u1) 
    annotation(Line(points = {{-496, 3}, {-417.5, 3}, {-417.5, 70}, {-339, 70}}, color = {0, 0, 127}));
  connect(backstep_k1_ep_y.y, virtual_velocity_error_y.u2) 
    annotation(Line(points = {{-386, 100}, {-362.5, 100}, {-362.5, 70}, {-339, 70}}, color = {0, 0, 127}));
  connect(velocity_error_y.y, backstep_k1_ev_y.u) 
    annotation(Line(points = {{-496, 3}, {-455, 3}, {-455, -10}, {-414, -10}}, color = {0, 0, 127}));
  connect(virtual_velocity_error_y.y, backstep_k2_virtual_y.u) 
    annotation(Line(points = {{-311, 70}, {-259, 70}}, color = {0, 0, 127}));
  connect(backstep_k1_ev_y.y, backstep_feedback_y.u1) 
    annotation(Line(points = {{-386, -10}, {-282.5, -10}, {-282.5, 45}, {-179, 45}}, color = {0, 0, 127}));
  connect(backstep_k2_virtual_y.y, backstep_feedback_y.u2) 
    annotation(Line(points = {{-231, 70}, {-205, 70}, {-205, 45}, {-179, 45}}, color = {0, 0, 127}));
  ...
  connect(backstep_feedback_y.y, desired_acceleration_pre_gravity_y.u2) 
    annotation(Line(points = {{-151, 45}, {21, 45}}, color = {0, 0, 127}));
  ...
  connect(position_error_z.y, backstep_k1_ep_z.u) 
    annotation(Line(points = {{-496, -123}, {-455, -123}, {-455, -110}, {-414, -110}}, color = {0, 0, 127}));
  connect(velocity_error_z.y, virtual_velocity_error_z.u1) 
    annotation(Line(points = {{-496, -207}, {-417.5, -207}, {-417.5, -140}, {-339, -140}}, color = {0, 0, 127}));
  connect(backstep_k1_ep_z.y, virtual_velocity_error_z.u2) 
    annotation(Line(points = {{-386, -110}, {-362.5, -110}, {-362.5, -140}, {-339, -140}}, color = {0, 0, 127}));
  connect(velocity_error_z.y, backstep_k1_ev_z.u) 
    annotation(Line(points = {{-496, -207}, {-455, -207}, {-455, -220}, {-414, -220}}, color = {0, 0, 127}));
  connect(virtual_velocity_error_z.y, backstep_k2_virtual_z.u) 
    annotation(Line(points = {{-311, -140}, {-259, -140}}, color = {0, 0, 127}));
  connect(backstep_k1_ev_z.y, backstep_feedback_z.u1) 
    annotation(Line(points = {{-386, -220}, {-282.5, -220}, {-282.5, -165}, {-179, -165}}, color = {0, 0, 127}));
  connect(backstep_k2_virtual_z.y, backstep_feedback_z.u2) 
    annotation(Line(points = {{-231, -140}, {-205, -140}, {-205, -165}, {-179, -165}}, color = {0, 0, 127}));
  ...
  connect(backstep_feedback_z.y, desired_acceleration_pre_gravity_z.u2) 
    annotation(Line(points = {{-151, -165}, {21, -165}}, color = {0, 0, 127}));
  ...
  connect(virtual_velocity_error_x.y, enable_virtual_velocity_error_x.u1) 
    annotation(Line(points = {{-311, 280}, {100, 280}, {100, -12}, {511, -12}}, color = {0, 0, 127}));
  ...
  connect(virtual_velocity_error_y.y, enable_virtual_velocity_error_y.u1) 
    annotation(Line(points = {{-311, 70}, {100, 70}, {100, -50}, {511, -50}}, color = {0, 0, 127}));
  ...
  connect(virtual_velocity_error_z.y, enable_virtual_velocity_error_z.u1) 
    annotation(Line(points = {{-311, -140}, {100, -140}, {100, -88}, {511, -88}}, color = {0, 0, 127}));
