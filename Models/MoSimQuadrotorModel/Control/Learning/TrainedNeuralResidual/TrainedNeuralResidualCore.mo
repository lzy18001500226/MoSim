within MoSimQuadrotorModel.Control.Learning.TrainedNeuralResidual;
model TrainedNeuralResidualCore "P9 trained neural residual learning-control signal chain"
