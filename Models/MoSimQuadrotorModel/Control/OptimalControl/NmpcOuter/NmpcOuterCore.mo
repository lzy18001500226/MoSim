within MoSimQuadrotorModel.Control.OptimalControl.NmpcOuter;
model NmpcOuterCore "NMPC_OUTER readable algorithm topology"
...
equation
  ...
  connect(velocity_error_in, velocity_prediction.u) 
    annotation(Line(points = {{-466, 0}, {-242, 0}}, color = {0, 0, 127}));
end NmpcOuterCore;