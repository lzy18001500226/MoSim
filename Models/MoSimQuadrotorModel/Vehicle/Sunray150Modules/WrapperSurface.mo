...
model WrapperSurface
  ...
  MoSimQuadrotorModel.Vehicle.Sunray150Modules.RotorActuatorCore dynamics(profile = profile) 
  ...
  annotation(
    Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}), graphics = {
      ...
      Text(origin = {0, 18}, extent = {{-88, 32}, {88, -32}},
        textString = "Rotor", textColor = {130, 0, 130},
        textStyle = {TextStyle.Bold}),
      Text(origin = {0, -22}, extent = {{-88, 28}, {88, -28}},
        textString = "Actuation", textColor = {130, 0, 130},
        textStyle = {TextStyle.Bold}),
      Text(origin = {0, -74}, extent = {{-92, 16}, {92, -16}},
        textString = "4 IN | dynamics", textColor = {160, 40, 160})}),
