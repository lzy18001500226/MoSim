within MoSimQuadrotorModel.Formation.Scenarios;
model FormationTriangleFigure8LinearMPCSysblockClosedLoop
  ...
  MoSimQuadrotorModel.Controllers.Sysblocks.AWFF_LinearMPCOuterLoopControllerEquation_Sysblock controller3_2(
    mpc_acc_limit_xy = 2.7,
    mpc_terminal_gain_xy = 0.12);
  MoSimQuadrotorModel.Controllers.Sysblocks.AWFF_LinearMPCOuterLoopControllerEquation_Sysblock follower1Controller(
    mpc_acc_limit_xy = 2.7,
    mpc_terminal_gain_xy = 0.12);
  MoSimQuadrotorModel.Controllers.Sysblocks.AWFF_LinearMPCOuterLoopControllerEquation_Sysblock follower2Controller(
    mpc_acc_limit_xy = 2.7,
    mpc_terminal_gain_xy = 0.12);
