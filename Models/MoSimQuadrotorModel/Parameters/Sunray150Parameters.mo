...
record Sunray150Parameters
  ...
  parameter Boolean enable_angular_damping_default = false
    "Keep optional body-rate damping disabled until a Sunray150 identification bundle is available";
  parameter Real angular_damping_coefficient_seed[3](each unit = "N.m.s/rad") = {0, 0, 0}
    "Linear body-rate damping seed; zero means no identified damping is claimed";
