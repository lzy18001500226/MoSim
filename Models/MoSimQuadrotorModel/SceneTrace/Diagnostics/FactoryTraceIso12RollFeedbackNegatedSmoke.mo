...
model FactoryTraceIso12RollFeedbackNegatedSmoke
  "Attitude feedback isolation 12: position feedback plus negated roll attitude feedback, pitch/yaw open"
  ...
  Modelica.Blocks.Math.Gain roll_sensor_sign(k = -1.0);
...
equation
  ...
  connect(sensors1_1.AngleMea[1], roll_sensor_sign.u);
  connect(roll_sensor_sign.y, controller3_2.roll_mea);
