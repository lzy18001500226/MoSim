...
model FactoryTraceIso13PitchFeedbackNegatedSmoke
  "Attitude feedback isolation 13: position feedback plus negated pitch attitude feedback, roll/yaw open"
  ...
  Modelica.Blocks.Math.Gain pitch_sensor_sign(k = -1.0);
...
equation
  ...
  connect(sensors1_1.AngleMea[2], pitch_sensor_sign.u);
  connect(pitch_sensor_sign.y, controller3_2.pitch_mea);
