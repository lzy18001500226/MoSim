...
model FactoryTraceIso17SampleHoldAngleSmoke
  "Attitude decoupling 17: sampled/held AngleMea[1] before roll input"
  ...
  Modelica.Blocks.Discrete.Sampler roll_angle_sampler(samplePeriod = 0.01, startTime = 0.0);
  Modelica.Blocks.Discrete.ZeroOrderHold roll_angle_hold(samplePeriod = 0.01, startTime = 0.0);
...
equation
  ...
  connect(sensors1_1.AngleMea[1], roll_angle_sampler.u);
  connect(roll_angle_sampler.y, roll_angle_hold.u);
  connect(roll_angle_hold.y, controller3_2.roll_mea);
