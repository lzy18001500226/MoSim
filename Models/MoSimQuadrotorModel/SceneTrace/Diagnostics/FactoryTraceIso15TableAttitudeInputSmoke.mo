...
model FactoryTraceIso15TableAttitudeInputSmoke
  "Attitude intermediary 15: position feedback plus table-driven roll attitude input, no AngleMea dependency"
  ...
  Modelica.Blocks.Sources.CombiTimeTable roll_table(
    table = [0, 0.00; 0.5, 0.03; 1.0, -0.02; 1.5, 0.04; 2.0, 0.00],
    columns = {2},
...
equation
  ...
  connect(roll_table.y[1], controller3_2.roll_mea);
