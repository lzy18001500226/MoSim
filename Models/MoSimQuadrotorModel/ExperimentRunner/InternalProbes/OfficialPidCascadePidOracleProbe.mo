...
model OfficialPidCascadePidOracleProbe
  ...
  MoSimQuadrotorModel.ExperimentRunner.Adapters.OfficialPIDRotorAdapter official_pid
    annotation(Placement(transformation(origin = {-90, 35}, extent = {{-32, -26}, {32, 26}})));
  MoSimQuadrotorModel.ExperimentRunner.Adapters.CascadePidAttitudeThrustAdapter cascade_pid
    annotation(Placement(transformation(origin = {-90, -40}, extent = {{-32, -26}, {32, 26}})));
  MoSimQuadrotorModel.ExperimentRunner.Adapters.OfflineAttitudeRateAllocator cascade_allocator
