...
model CascadePidFullFeedbackSampledSmoke
  ...
  MoSimQuadrotorModel.ExperimentRunner.Adapters.CascadePidAttitudeThrustAdapter controller annotation(Placement(transformation(extent={{-63,6},{-33,46}})));
  MoSimQuadrotorModel.ExperimentRunner.Adapters.OfflineAttitudeRateAllocator allocator annotation(Placement(transformation(extent={{-15,-20},{15,20}})));
  MoSimQuadrotorModel.ExperimentRunner.Plant.SingleUavPlantAnimation plant annotation(Placement(transformation(extent={{33,-20},{63,20}})));
