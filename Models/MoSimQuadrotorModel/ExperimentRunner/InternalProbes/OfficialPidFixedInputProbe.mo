...
model OfficialPidFixedInputProbe "G6 fixed-input probe for the graphical Official PID core"
  ...
  annotation(
    ...
    experiment(Algorithm=Euler,Interval=0.01,IntegratorStep=0.01,StartTime=0,StopTime=0.2,StoreEventValue=0),
  ...
  MoSimQuadrotorModel.Controllers.GraphicalMIL.PidFamily.AWFF_PID_Sysblock_Demo official_pid
