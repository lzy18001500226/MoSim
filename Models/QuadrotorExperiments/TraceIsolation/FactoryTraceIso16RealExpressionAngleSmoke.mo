...
model FactoryTraceIso16RealExpressionAngleSmoke
  "Attitude intermediary 16: position feedback plus RealExpression bridge from AngleMea[1] to roll input"
  ...
  Modelica.Blocks.Sources.RealExpression roll_angle_expr(y = sensors1_1.AngleMea[1]);
...
equation
  ...
  connect(roll_angle_expr.y, controller3_2.roll_mea);
