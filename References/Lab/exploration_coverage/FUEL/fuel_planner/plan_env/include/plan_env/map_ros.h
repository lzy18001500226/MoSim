...
private:
  ...
  string frame_id_;
  // msg publication
  double esdf_slice_height_, all_map_publish_period_;
  double visualization_truncate_height_, visualization_truncate_low_;
  bool show_esdf_time_, show_occ_time_;
  bool show_all_map_;
  bool publish_local_map_;
  bool cloud_free_space_rays_enable_;
  int cloud_free_space_ray_count_;
  double cloud_free_space_ray_length_margin_;
