...
class YaraDynamicAnalyzer(BaseSubprocessAnalyzer):
    ...
    def _postprocess_findings(self, findings):
        # findings is the list of matches; map raw $strings to rule definitions in place
    ...
    def _build_envelope(self, findings, returncode, stderr, stdout, target):
        return {
            ...
            'scan_info': {
                ...
                'rules_file': self.config['analysis']['dynamic']['yara']['rules_path'],
            },
            'matches': findings,
