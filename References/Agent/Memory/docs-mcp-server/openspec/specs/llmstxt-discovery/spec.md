# llmstxt-discovery Specification

## Purpose
Defines automatic llms.txt discovery, crawl seeding, Markdown content negotiation, and Markdown URL preference behavior for web scraping.
