# scraper-isolation Specification

## Purpose
Defines how scraper strategy instances are isolated per scrape operation to prevent shared state corruption during parallel scraping.
