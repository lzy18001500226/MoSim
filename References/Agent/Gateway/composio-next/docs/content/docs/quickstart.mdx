...
<Cards>
  ...
  <Card icon={<BookOpen />} title="What is a session?" href="/docs/how-composio-works" description="Understand what happens under the hood: sessions, meta tools, and the tool execution lifecycle" />
