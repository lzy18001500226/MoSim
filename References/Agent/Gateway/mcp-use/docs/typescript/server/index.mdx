...
- **MCP Apps support**: UI widgets are compatible with MCP Apps for all compatible clients (ChatGPT, Claude, etc.). [UI Widgets](/typescript/server/mcp-apps).
- **Edge runtime support**: Built-in Edge runtime support
- **Built-in Inspector**: A built-in MCP inspector launches automatically so you can test your server immediately. See [MCP Inspector](/inspector) for more details.
...
- [UI Widgets](/typescript/server/mcp-apps): Expose UI components to chat clients compatible with ChatGPT Apps SDK and MCP-UI.
...
**Learn more**: [UI Widgets Guide →](/typescript/server/mcp-apps)
...
<CardGroup cols={3}>
  ...
  <Card title="UI Widgets" icon="palette" href="/typescript/server/mcp-apps">
