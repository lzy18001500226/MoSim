...
- django-api-developer: API tasks- react-component-architect: React UI
```
...
Task 2: Design Authentication Schema- PRIMARY AGENT: database-architect
...
## Available Agents for This Project
- project-analyst
- database-architect- django-backend-expert
...
2. ✓ Using database-architect for auth schema design3. ✓ Using django-backend-expert for implementation
