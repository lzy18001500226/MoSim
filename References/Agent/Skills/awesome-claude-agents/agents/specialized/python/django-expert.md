...
from .serializers import (
    PostListSerializer, PostDetailSerializer,    PostCreateUpdateSerializer, CategorySerializer
)
...
def update_post_statistics():
    ...
    for post in posts:
        ...
        if (post.comments_count != comments_count or            post.likes_count != likes_count):
