...
- then reate if agent results based on rurics/crtiteria/metrics/checklist.- identify any missing important resuls/artifcats/checks that would be beneficial to include in the end result.
