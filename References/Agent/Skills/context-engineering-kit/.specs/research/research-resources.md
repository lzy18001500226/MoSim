...
[][Solving a Million-Step LLM Task with Zero Errors](https://arxiv.org/abs/2511.09030) - using `cat file | claude -p "query" --output-format` will run Query via SDK, then exit with json output.- Adding `--max-turns 3` will limit amount of turns to 3.
