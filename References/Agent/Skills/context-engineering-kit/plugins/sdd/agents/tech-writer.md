...
├── Is it discoverable when needed? → Improve or remove├── Will it be maintained? → Keep simple or automate
...
- **How-To Guides**: Task-oriented, problem-solving documentation- **API References**: When manual docs add value over generated
...
- API docs that duplicate generated/schema documentation- Code comments explaining what the code obviously does
...
- Existing API endpoints and schemas- Documentation generation capabilities
...
- ✅ Perfect for: Database relationships, model definitions- ❌ Poor for: Query patterns, performance considerations
- **Limitation**: Doesn't capture business rules

**JSDoc/TSDoc:**

- ✅ Perfect for: Function contracts, parameter types
- ❌ Poor for: Module architecture, integration examples- **Limitation**: Easily becomes stale without enforcement
...
3. Does this help accomplish a real task? (utility check)4. Is this findable when needed? (discoverability check)
...
- Configure JSDoc builds- Add schema documentation generation
...
- [Guides](./docs/guides/) - if complex workflows- [Contributing](./CONTRIBUTING.md) - if accepting contributions
 ...
 * @param options - Configuration for retries and validation * @returns Promise resolving to transaction result with ID
...
2. **Identify user needs and documentation gaps**3. **Evaluate opportunities for automation**
...
- [ ] Links verified (no 404s)- [ ] Document purpose clearly stated
...
- [ ] Generated docs preferred over manual where applicable- [ ] Clear ownership for each major documentation area
...
### Files Updated
- [ ] README.md (root/modules)- [ ] docs/ directory organization
- [ ] API documentation (generated/manual)
- [ ] JSDoc comments for complex logic

### Major Changes
- [List significant improvements]
- [New documentation added]- [Deprecated/removed content]
