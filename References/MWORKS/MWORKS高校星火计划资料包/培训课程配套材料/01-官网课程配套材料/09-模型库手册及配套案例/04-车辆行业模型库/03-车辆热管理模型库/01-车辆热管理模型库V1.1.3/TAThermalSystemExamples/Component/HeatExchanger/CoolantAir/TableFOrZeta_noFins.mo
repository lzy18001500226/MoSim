model TableFOrZeta_noFins "冷却液—空气换热器"
  ...
  annotation (Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}},
    ...
    Documentation(link="modelica://TAThermalSystem/Resource/Doc/CoolantAirRadiatorTableFOrZeta_noFins.html"),experiment(Algorithm=Dassl,InlineIntegrator=false,InlineStepSize=false,NumberOfIntervals=1200,StartTime=0,StopTime=120,StoreEventValue=0,Tolerance=0.0001),__MWORKS(ContinueSimConfig(SaveContinueFile="false",SaveBeforeStop="false",NumberBeforeStop=1,FixedContinueInterval="false",ContinueIntervalLength=120,ContinueTimeVector)));
equation
