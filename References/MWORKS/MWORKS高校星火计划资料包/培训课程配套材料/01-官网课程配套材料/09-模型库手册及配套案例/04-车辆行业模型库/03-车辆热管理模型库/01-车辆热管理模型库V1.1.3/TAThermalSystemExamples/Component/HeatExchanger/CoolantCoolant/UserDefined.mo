model UserDefined "冷却液—冷却液换热器"
  ...
  parameter Modelica.Units.SI.Temperature T_heatin(displayUnit = "degC") = 363.15 "热端温度";
  TAThermalSystem.HeatExchangers.CoolingRadiatorNTU.Water_WaterHXNTU water_WaterHXNTU_(redeclare model Friction_ab = TYBase.Thermal.FluidHeatFlow.PressureLoss.HXPressureDrop.UserDefined, ConsiderationFins_cd = false, ConsiderationFins_ab = false, heattransferType_2 = TAThermalSystem.HeatExchangers.CoolingRadiatorNTU.Water_WaterHXNTU.HeatTransferType.Nusseltnumber, redeclare model Friction_cd = TYBase.Thermal.FluidHeatFlow.PressureLoss.HXPressureDrop.UserDefined, heattransferType_1 = TAThermalSystem.HeatExchangers.CoolingRadiatorNTU.Water_WaterHXNTU.HeatTransferType.Nusseltnumber) annotation(Placement(transformation(origin = {-2.7944489097334695, 0.0677945917309537},
  ...
  annotation(Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}},
    ...
    Documentation(link="modelica://TAThermalSystem/Resource/Doc/coolantCoolantRadiatorUserDefined.html"
),__MWORKS(ResultViewerManager(resultViewers={
ResultViewer(name="1", executeTrigger=executeTrigger.SimulationStarted, commands={
CreatePlot(id=1, x_display_unit="s", legend_layout=7, left_title_type=2, left_title="[bar]", bottom_title_type=2, right_title_type=2, fix_time_range_value=0, zoom_x=(0, 120), zoom_y_l=(0.005792, 0.0058)),
Plot(y=["water_WaterHXNTU_.hXSummary.dp_ab"], thicknesses=[2], colors=["4278190335"]),
CreatePlot(id=-1, x_display_unit="s", legend_layout=7, left_title_type=2, left_title="[W]", bottom_title_type=2, right_title_type=2, fix_time_range_value=0, sub_plot=(2, 1), zoom_x=(0, 120), zoom_y_l=(-168.01, -167.94)),
...
equation
  ...
  connect(Coolant_pT1.port_a, water_WaterHXNTU_.d) 
    ...
    points = {{-0.5668215488316903, -12.698138816631747}, {31.46403385049365, -12.698138816631747}, {31.46403385049365, 12.062455372564477}, {32.242930592216105, 12.062455372564477}},
    color = {0, 0, 128},
    thickness = 1.0));
  connect(water_WaterHXNTU_.c, Coolant_mT1.port_b) 
    annotation(Line(origin = {30.029160316860825, -17.8833587325567},
    points = {{-22.741444551674306, 12.0327144738184}, {-22.741444551674306, -14.0}, {-5.8021296568626894, -14.0}, {-5.8021296568626894, -13.653618893357404}},
    color = {0, 0, 128},
    thickness = 1.0));
