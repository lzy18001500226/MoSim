...
typedef mpl::copy<
    ...
    mpl::inserter<
        ...
        mpl::insert_range<
            mpl::_1,
            mpl::end<mpl::_1>,
            vector_steppers<mpl::_2>>>>::type all_stepper_methods;
...
typedef mpl::copy<
    ...
    mpl::inserter<
        ...
        mpl::insert_range<
            mpl::_1,
            mpl::end<mpl::_1>,
            const_range<num_steppers, mpl::_2>>>>::type all_multiplicities;
...
typedef complete_steppers<coor_type, mom_type, double,
                          ...
                          fusion_algebra, default_operations, initially_resizer>
    boost_unit_steppers;
