...
void OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_init_function(
...
void OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_fini_function(void * message_memory)
{
  ue_msgs__msg__OverlapEvent__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_member_array[7] = {
  {
    "begin",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_members = {
  "ue_msgs__msg",  // message namespace
  "OverlapEvent",  // message name
  7,  // number of fields
  sizeof(ue_msgs__msg__OverlapEvent),
  OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_member_array,  // message members
  OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_init_function,  // function to initialize message memory (memory has to be allocated)
  OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_type_support_handle = {
  0,
  &OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue_msgs, msg, OverlapEvent)() {
  OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_member_array[6].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue_msgs, msg, HitResult)();
  if (!OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_type_support_handle.typesupport_identifier) {
    OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &OverlapEvent__rosidl_typesupport_introspection_c__OverlapEvent_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
