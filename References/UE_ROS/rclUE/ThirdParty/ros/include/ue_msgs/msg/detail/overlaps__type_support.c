...
void Overlaps__rosidl_typesupport_introspection_c__Overlaps_init_function(
...
size_t Overlaps__rosidl_typesupport_introspection_c__size_function__OverlappingObjects__overlaps(
...
void * Overlaps__rosidl_typesupport_introspection_c__get_function__OverlappingObjects__overlaps(
...
bool Overlaps__rosidl_typesupport_introspection_c__resize_function__OverlappingObjects__overlaps(
...
static rosidl_typesupport_introspection_c__MessageMember Overlaps__rosidl_typesupport_introspection_c__Overlaps_message_member_array[2] = {
  {
    "targets",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers Overlaps__rosidl_typesupport_introspection_c__Overlaps_message_members = {
