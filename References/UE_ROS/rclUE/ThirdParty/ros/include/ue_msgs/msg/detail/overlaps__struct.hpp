...
struct Overlaps_
{
  ...
  using _overlaps_type =
    std::vector<ue_msgs::msg::OverlappingObjects_<ContainerAllocator>, typename ContainerAllocator::template rebind<ue_msgs::msg::OverlappingObjects_<ContainerAllocator>>::other>;
  ...
  Type & set__overlaps(
    const std::vector<ue_msgs::msg::OverlappingObjects_<ContainerAllocator>, typename ContainerAllocator::template rebind<ue_msgs::msg::OverlappingObjects_<ContainerAllocator>>::other> & _arg)
  {
    this->overlaps = _arg;
    return *this;
  }
