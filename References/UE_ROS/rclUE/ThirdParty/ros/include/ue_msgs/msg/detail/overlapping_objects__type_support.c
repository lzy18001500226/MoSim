...
static rosidl_typesupport_introspection_c__MessageMember OverlappingObjects__rosidl_typesupport_introspection_c__OverlappingObjects_message_member_array[2] = {
  {
    "actors",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers OverlappingObjects__rosidl_typesupport_introspection_c__OverlappingObjects_message_members = {
...
static rosidl_message_type_support_t OverlappingObjects__rosidl_typesupport_introspection_c__OverlappingObjects_message_type_support_handle = {
  0,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ue_msgs, msg, OverlappingObjects)() {
  if (!OverlappingObjects__rosidl_typesupport_introspection_c__OverlappingObjects_message_type_support_handle.typesupport_identifier) {
    OverlappingObjects__rosidl_typesupport_introspection_c__OverlappingObjects_message_type_support_handle.typesupport_identifier =
