...
Instructions for setting up a websocket server and gzweb visualization can
be found in the
[gz-sim websocket server tutorial](https://gazebosim.org/api/sim/10/websocket_server.html).
