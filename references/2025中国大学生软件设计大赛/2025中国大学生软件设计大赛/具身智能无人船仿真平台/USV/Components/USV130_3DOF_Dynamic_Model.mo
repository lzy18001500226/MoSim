model USV130_3DOF_Dynamic_Model "无人船三自由度动力学模型"
  ...
  Modelica.Blocks.Interfaces.RealInput surge 
    "推杆" annotation(Placement(transformation(origin = {-120, 50}, 
    extent = {{-20, -20}, {20, 20}}), 
    iconTransformation(origin = {0, 0})));
  Modelica.Blocks.Interfaces.RealInput yaw 
    "偏航" annotation(Placement(transformation(origin = {-120, -50}, 
    extent = {{-20, -20}, {20, 20}}), 
    iconTransformation(origin = {0, 0})));
...
extent={{-4,-4},{4,4}})));
  Modelica.Blocks.Sources.RealExpression realExpression11(y=disturbY) 
    annotation (Placement(transformation(origin={40,50}, 
extent={{-10,-10},{10,10}})));
  Modelica.Blocks.Sources.RealExpression realExpression12(y=disturbX) 
...
color={255,0,255}));
  ...
  color={0,0,127}));
  connect(realExpression12.y, caculate1.disturbX) 
  annotation(Line(origin={58,22}, 
  points={{-7,14},{-2,14},{-2,-13.9235},{6.9204,-13.9235}}, 
  color={0,0,127}));
  connect(realExpression11.y, caculate1.disturbY) 
  annotation(Line(origin={58,37}, 
  points={{-7,13},{-2,13},{-2,-13},{6.8937,-13}}, 
  color={0,0,127}));

end USV130_3DOF_Dynamic_Model;