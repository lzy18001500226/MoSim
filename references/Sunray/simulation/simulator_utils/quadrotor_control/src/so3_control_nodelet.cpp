...
void QuadrotorControlNodelet::publishSO3Command(void)
{
...
void QuadrotorControlNodelet::position_cmd_callback(
    const quadrotor_msgs::PositionCommand::ConstPtr &cmd)
{
...
void QuadrotorControlNodelet::odom_callback(const nav_msgs::Odometry::ConstPtr &odom)
{
...
void QuadrotorControlNodelet::enable_motors_callback(const std_msgs::Bool::ConstPtr &msg)
{
  if (msg->data)
...
void QuadrotorControlNodelet::corrections_callback(
...
void QuadrotorControlNodelet::imu_callback(const sensor_msgs::Imu &imu)
{
...
void QuadrotorControlNodelet::onInit(void)
{
