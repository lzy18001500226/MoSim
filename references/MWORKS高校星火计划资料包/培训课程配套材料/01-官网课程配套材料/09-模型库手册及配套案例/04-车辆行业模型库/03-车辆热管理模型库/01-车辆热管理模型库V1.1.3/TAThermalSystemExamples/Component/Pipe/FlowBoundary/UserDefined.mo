model UserDefined "用户定义dm=f(dp)或dm=f(dp,T)压降方式"
  ...
  TAThermalSystem.Pipes.LiquidCoolingPipe.CoolingPipe coolingPipeBase2(
    useHeatTransfer = true, redeclare model Friction = TAThermalSystem.Utilities.PressureDrop.UserDefined, redeclare Integer calType = 2, h_conv_set = 75, 
    CF_PressureLoss = 1, 
  ...
  annotation (Icon(coordinateSystem(extent = {{-100.0, -100.0}, {100.0, 100.0}}, 
    ...
    Documentation(link = "modelica://TAThermalSystem/Resource/Doc/FlowBoundaryUserDefined.html"
),__MWORKS(ResultViewerManager(resultViewers={
ResultViewer(name="1", executeTrigger=executeTrigger.SimulationStarted, commands={
CreatePlot(id=1, x_display_unit="s", legend_layout=7, left_title="[bar]", fix_time_range_value=0, zoom_x=(0, 100), zoom_y_l=(4.995, 5.02)), 
