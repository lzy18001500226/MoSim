...
struct AutoTakeoffLand_t
{
	...
	ros::Time last_auto_arm_retry_time;
	int auto_arm_retry_count{0};
	bool auto_arm_retry_exhausted_reported{false};
	...
	static constexpr double AUTO_ARM_RETRY_INTERVAL = 1.0;
	static constexpr int AUTO_ARM_RETRY_MAX = 30;
};
