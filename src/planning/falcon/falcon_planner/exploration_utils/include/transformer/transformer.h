...
public:
  ...
  std::string getWorldFrame() { return world_frame_; }
  void getWorldFrame(std::string &world_frame) { world_frame = world_frame_; }
  std::string getSensorFrame() { return sensor_frame_; }
  void getSensorFrame(std::string &sensor_frame) { sensor_frame = sensor_frame_; }

  void setWorldFrame(const std::string &world_frame) { world_frame_ = world_frame; }
  void setSensorFrame(const std::string &sensor_frame) { sensor_frame_ = sensor_frame; }
