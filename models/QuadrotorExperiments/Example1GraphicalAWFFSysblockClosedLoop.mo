model Example1GraphicalAWFFSysblockClosedLoop
  "Example1 plant with graphical project AWFF Sysblock controller"
...
end Example1GraphicalAWFFSysblockClosedLoop;
