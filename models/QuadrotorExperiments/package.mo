...
package QuadrotorExperiments
  ...
  model Example1ImprovedPID
    "Example1 with project improved PID parameter set"
    extends QuadrotorModel.Examples.Example1(
      controller3_2.PID3(KP = 1.5, KI = 0, KD = 1.0),
      controller3_2.PID4(KP = 1.5, KI = 0, KD = 1.0),
      controller3_2.PID5(KP = 14.142, KI = 0, KD = 1.65),
      controller3_2.PID6(KP = 14.142, KI = 0, KD = 1.65),
  ...
  model Example3ImprovedPID
    "Example3 with project improved PID parameter set"
