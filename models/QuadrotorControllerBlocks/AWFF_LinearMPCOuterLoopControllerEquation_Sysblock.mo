model AWFF_LinearMPCOuterLoopControllerEquation_Sysblock
  ...
  parameter Real mpc_kp_xy = 1.45;
  parameter Real mpc_kd_xy = 0.90;
  parameter Real mpc_terminal_gain_xy = 0.10;
  parameter Real mpc_kp_z = 8.0;
  parameter Real mpc_ki_z = 5.4;
  parameter Real mpc_kd_z = 3.6;
  parameter Real mpc_terminal_gain_z = 0.08;
  ...
  parameter Real indi_roll_gain = 0.012;
  parameter Real indi_pitch_gain = 0.012;
  parameter Real indi_yaw_gain = 0.004;
  parameter Real indi_increment_limit = 0.12;
...
equation
  ...
  acc_x_raw = mpc_kp_xy * x_error + mpc_kd_xy * x_error_rate + mpc_terminal_gain_xy * x_terminal_error;
  acc_y_raw = mpc_kp_xy * y_error + mpc_kd_xy * y_error_rate + mpc_terminal_gain_xy * y_terminal_error;
  ...
  thrust_ref_raw = mpc_kp_z * z_error + mpc_ki_z * z_integral + mpc_kd_z * z_error_rate + mpc_terminal_gain_z * z_terminal_error + kff_z * z_ref_rate;
