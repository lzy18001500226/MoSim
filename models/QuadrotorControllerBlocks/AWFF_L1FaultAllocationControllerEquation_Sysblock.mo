model AWFF_L1FaultAllocationControllerEquation_Sysblock
  "AWFF L1 residual controller with known rotor-1 efficiency allocation compensation"
...
equation
  ...
  rotor1_eff_safe = if rotor1_efficiency < min_rotor_efficiency then min_rotor_efficiency else rotor1_efficiency;
