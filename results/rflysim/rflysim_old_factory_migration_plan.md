# RflySim Scene Migration Plan: rflysim_old_factory

- Priority: `P0`
- Purpose: industrial patrol, wall occlusion, and obstacle navigation
- Source map: `OldFactory/Maps/OldFactory.umap`
- Source engine: `4.27`
- Target engine: `5.7`
...
- `/Game/OldFactory` -> `/mnt/d/PX4PSP/RflySim3D/RflySim3D/Content/OldFactory`
- `/Game/ModularNeighborhood` -> `/mnt/d/PX4PSP/RflySim3D/RflySim3D/Content/ModularNeighborhood`
