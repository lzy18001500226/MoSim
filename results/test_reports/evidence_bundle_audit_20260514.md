...
| `scenarios/robustness/example1_rotor1_loss15_improved_pid.yaml` | quality_status is needs_iteration; usable only as boundary/ablation evidence, not as completed controller claim |
...
| `scenarios/robustness/example1_rotor1_loss15_wind_gust_awff_sysblock.yaml` | quality_status is needs_iteration; usable only as boundary/ablation evidence, not as completed controller claim |
...
| `scenarios/robustness/example1_rotor2_loss15_wind_gust_awff_sysblock.yaml` | quality_status is needs_iteration; usable only as boundary/ablation evidence, not as completed controller claim |
...
| `scenarios/robustness/example1_rotor3_loss15_wind_gust_awff_sysblock.yaml` | quality_status is needs_iteration; usable only as boundary/ablation evidence, not as completed controller claim |
...
| `scenarios/robustness/example1_rotor4_loss15_wind_gust_awff_sysblock.yaml` | quality_status is needs_iteration; usable only as boundary/ablation evidence, not as completed controller claim |
